...
-- Généré le :  Mar 30 Mai 2017 à 18:11
...
--
-- Structure de la table `mg_adminnotification_inbox`
--
...
) ENGINE=InnoDB AUTO_INCREMENT=109 DEFAULT CHARSET=utf8 COMMENT='Adminnotification Inbox';

--
-- Contenu de la table `mg_adminnotification_inbox`
--
...
(1, 4, '2008-11-08 03:46:42', 'Reminder: Change Magento`s default phone numbers and callouts before site launch', 'Before launching your Magento store, please remember to change Magento`s default phone numbers that appear in email templates, callouts, templates, etc.', '', 0, 0),
(2, 3, '2008-11-20 05:31:12', 'Magento version 1.1.7 Now Available', 'Magento version 1.1.7 Now Available.\n\nThis version includes over 350 issue resolutions for Magento 1.1.x that are listed in the release notes section, and new functionality that includes:\n\n-Google Website Optimizer integration\n-Google Base integration\n-Scheduled DB logs cleaning option', 'http://www.magentocommerce.com/blog/comments/magento-version-117-now-available/', 0, 0),
(3, 3, '2008-11-27 01:24:50', 'Magento Version 1.1.8 Now Available', 'Magento version 1.1.8 now available.\n\nThis version includes some issue resolutions for Magento 1.1.x that are listed in the release notes section.', 'http://www.magentocommerce.com/blog/comments/magento-version-118-now-available/', 0, 0),
(4, 3, '2008-12-30 11:45:59', 'Magento version 1.2.0 is now available for download and upgrade', 'We are extremely happy to announce the availability of Magento version 1.2.0 for download and upgrade.\n\nThis version includes numerous issue resolutions for Magento version 1.1.x and some highly requested new features such as:\n\n    * Support for Downloadable/Digital Products. \n    * Added Layered Navigation to site search result page.\n    * Improved site search to utilize MySQL fulltext search\n    * Added support for fixed-taxes on product level.\n    * Upgraded Zend Framework to the latest stable version 1.7.2', 'http://www.magentocommerce.com/blog/comments/magento-version-120-is-now-available/', 0, 0),
(5, 2, '2008-12-31 01:59:22', 'Magento version 1.2.0.1 now available', 'Magento version 1.2.0.1 now available.This version includes some issue resolutions for Magento 1.2.x that are listed in the release notes section.', 'http://www.magentocommerce.com/blog/comments/magento-version-1201-available/', 0, 0),
(6, 2, '2009-01-13 00:41:49', 'Magento version 1.2.0.2 now available', 'Magento version 1.2.0.2 is now available for download and upgrade. This version includes an issue resolutions for Magento version 1.2.0.x as listed in the release notes.', 'http://www.magentocommerce.com/blog/comments/magento-version-1202-now-available/', 0, 0),
(7, 3, '2009-01-24 04:25:56', 'Magento version 1.2.0.3 now available', 'Magento version 1.2.0.3 is now available for download and upgrade. This version includes issue resolutions for Magento version 1.2.0.x as listed in the release notes.', 'http://www.magentocommerce.com/blog/comments/magento-version-1203-now-available/', 0, 0),
(8, 3, '2009-02-03 01:57:00', 'Magento version 1.2.1 is now available for download and upgrade', 'We are happy to announce the availability of Magento version 1.2.1 for download and upgrade.\n\nThis version includes some issue resolutions for Magento version 1.2.x. A full list of items included in this release can be found on the release notes page.', 'http://www.magentocommerce.com/blog/comments/magento-version-121-now-available/', 0, 0),
(9, 3, '2009-02-24 04:45:47', 'Magento version 1.2.1.1 now available', 'Magento version 1.2.1.1 now available.This version includes some issue resolutions for Magento 1.2.x that are listed in the release notes section.', 'http://www.magentocommerce.com/blog/comments/magento-version-1211-now-available/', 0, 0),
(10, 3, '2009-02-27 05:39:24', 'CSRF Attack Prevention', 'We have just posted a blog entry about a hypothetical CSRF attack on a Magento admin panel. Please read the post to find out if your Magento installation is at risk at http://www.magentocommerce.com/blog/comments/csrf-vulnerabilities-in-web-application-and-how-to-avoid-them-in-magento/', 'http://www.magentocommerce.com/blog/comments/csrf-vulnerabilities-in-web-application-and-how-to-avoid-them-in-magento/', 0, 0),
(11, 2, '2009-03-04 03:03:58', 'Magento version 1.2.1.2 now available', 'Magento version 1.2.1.2 is now available for download and upgrade.\nThis version includes some updates to improve admin security as described in the release notes page.', 'http://www.magentocommerce.com/blog/comments/magento-version-1212-now-available/', 0, 0),
(12, 3, '2009-03-31 04:22:40', 'Magento version 1.3.0 now available', 'Magento version 1.3.0 is now available for download and upgrade. This version includes numerous issue resolutions for Magento version 1.2.x and new features as described on the release notes page.', 'http://www.magentocommerce.com/blog/comments/magento-version-130-is-now-available/', 0, 0),
(13, 3, '2009-04-18 06:06:02', 'Magento version 1.3.1 now available', 'Magento version 1.3.1 is now available for download and upgrade. This version includes some issue resolutions for Magento version 1.3.x and new features such as Checkout By Amazon and Amazon Flexible Payment. To see a full list of updates please check the release notes page.', 'http://www.magentocommerce.com/blog/comments/magento-version-131-now-available/', 0, 0),
(14, 3, '2009-05-20 00:31:21', 'Magento version 1.3.1.1 now available', 'Magento version 1.3.1.1 is now available for download and upgrade. This version includes some issue resolutions for Magento version 1.3.x and a security update for Magento installations that run on multiple domains or sub-domains. If you are running Magento with multiple domains or sub-domains we highly recommend upgrading to this version.', 'http://www.magentocommerce.com/blog/comments/magento-version-1311-now-available/', 0, 0),
(15, 3, '2009-05-30 00:54:06', 'Magento version 1.3.2 now available', 'This version includes some improvements and issue resolutions for version 1.3.x that are listed on the release notes page. also included is a Beta version of the Compile module.', 'http://www.magentocommerce.com/blog/comments/magento-version-132-now-available/', 0, 0),
(16, 3, '2009-06-01 21:32:52', 'Magento version 1.3.2.1 now available', 'Magento version 1.3.2.1 now available for download and upgrade.\n\nThis release solves an issue for users running Magento with PHP 5.2.0, and changes to index.php to support the new Compiler Module.', 'http://www.magentocommerce.com/blog/comments/magento-version-1321-now-available/', 0, 0),
(17, 3, '2009-07-02 03:21:44', 'Magento version 1.3.2.2 now available', 'Magento version 1.3.2.2 is now available for download and upgrade.\n\nThis release includes issue resolution for Magento version 1.3.x. To see a full list of changes please visit the release notes page http://www.magentocommerce.com/download/release_notes.', 'http://www.magentocommerce.com/blog/comments/magento-version-1322-now-available/', 0, 0),
(18, 3, '2009-07-23 08:48:54', 'Magento version 1.3.2.3 now available', 'Magento version 1.3.2.3 is now available for download and upgrade.\n\nThis release includes issue resolution for Magento version 1.3.x. We recommend to upgrade to this version if PayPal payment modules are in use. To see a full list of changes please visit the release notes page http://www.magentocommerce.com/download/release_notes.', 'http://www.magentocommerce.com/blog/comments/magento-version-1323-now-available/', 0, 0),
(19, 4, '2009-08-28 20:26:28', 'PayPal is updating Payflow Pro and Website Payments Pro (Payflow Edition) UK.', 'If you are using Payflow Pro and/or Website Payments Pro (Payflow Edition) UK.  payment methods, you will need to update the URLâ€˜s in your Magento Administrator Panel in order to process transactions after September 1, 2009. Full details are available here: http://www.magentocommerce.com/wiki/paypal_payflow_changes', 'http://www.magentocommerce.com/wiki/paypal_payflow_changes', 0, 0),
(20, 2, '2009-09-23 22:16:49', 'Magento Version 1.3.2.4 Security Update', 'Magento Version 1.3.2.4 is now available. This version includes a security updates for Magento 1.3.x that solves possible XSS vulnerability issue on customer registration page and is available through SVN, Download Page and through the Magento Connect Manager.', 'http://www.magentocommerce.com/blog/comments/magento-version-1324-security-update/', 0, 0),
(21, 4, '2009-09-25 16:57:54', 'Magento Preview Version 1.4.0.0-alpha2 is now available', 'We are happy to announce the availability of Magento Preview Version 1.4.0.0-alpha2 for download.\nAs this is a preview version it is NOT recommended in any way to be used in a production environment.', 'http://www.magentocommerce.com/blog/comments/magento-preview-version-1400-alpha2-now-available/', 0, 0),
(22, 4, '2009-10-07 02:55:40', 'Magento Preview Version 1.4.0.0-alpha3 is now available', 'We are happy to announce the availability of Magento Preview Version 1.4.0.0-alpha3 for download.\nAs this is a preview version it is NOT recommended in any way to be used in a production environment.', 'http://www.magentocommerce.com/blog/comments/magento-preview-version-1400-alpha3-now-available/', 0, 0),
(23, 4, '2009-12-09 03:30:36', 'Magento Preview Version 1.4.0.0-beta1 is now available', 'We are happy to announce the availability of Magento Preview Version 1.4.0.0-beta1 for download.\nAs this is a preview version it is NOT recommended in any way to be used in a production environment.', 'http://www.magentocommerce.com/blog/comments/magento-preview-version-1400-beta1-now-available/', 0, 0),
(24, 4, '2009-12-31 13:22:12', 'Magento Preview Version 1.4.0.0-rc1 is now available', 'We are happy to announce the availability of Magento Preview Version 1.4.0.0-rc1 for download.\nAs this is a preview version it is NOT recommended in any way to be used in a production environment.', 'http://www.magentocommerce.com/blog/comments/magento-preview-version-1400-rc1-now-available/', 0, 0),
(25, 4, '2010-02-13 07:39:53', 'Magento CE Version 1.4.0.0 Stable is now available', 'We are excited to announce the availability of Magento CE Version 1.4.0.0 Stable for upgrade and download.', 'http://bit.ly/c53rpK', 0, 0),
(26, 3, '2010-02-20 06:39:36', 'Magento CE Version 1.4.0.1 Stable is now available', 'Magento CE 1.4.0.1 Stable is now available for upgrade and download.', 'http://www.magentocommerce.com/blog/comments/magento-ce-version-1401-stable-now-available/', 0, 0),
(27, 4, '2010-04-23 22:09:03', 'Magento Version CE 1.3.3.0 Stable - Now Available With Support for 3-D Secure', 'Based on community requests, we are excited to announce the release of Magento CE 1.3.3.0-Stable with support for 3-D Secure. This release is intended for Magento merchants using version 1.3.x, who want to add support for 3-D Secure.', 'http://www.magentocommerce.com/blog/comments/magento-version-ce-1330-stable-now-available-with-support-for-3-d-secure/', 0, 0),
(28, 4, '2010-05-31 19:20:21', 'Announcing the Launch of Magento Mobile', 'The Magento team is pleased to announce the launch of Magento mobile, a new product that will allow Magento merchants to easily create branded, native mobile storefront applications that are deeply integrated with Magentoâ€™s market-leading eCommerce platform. The product includes a new administrative manager, a native iPhone app that is fully customizable, and a service where Magento manages the submission and maintenance process for the iTunes App Store.\n\nLearn more by visiting the Magento mobile product page and sign-up to be the first to launch a native mobile commerce app, fully integrated with Magento.', 'http://www.magentocommerce.com/product/mobile', 0, 0),
(29, 4, '2010-06-10 22:08:08', 'Magento CE Version 1.4.1.0 Stable is now available', 'We are excited to announce the availability of Magento CE Version 1.4.1.0 Stable for upgrade and download. Some of the highlights of this release include: Enhanced PayPal integration (more info to follow), Change of Database structure of the Sales module to no longer use EAV, and much more.', 'http://www.magentocommerce.com/blog/comments/magento-ce-version-1410-stable-now-available/', 0, 0),
(30, 4, '2010-07-26 23:37:34', 'Magento CE Version 1.4.1.1 Stable is now available', 'We are excited to announce the availability of Magento CE Version 1.4.1.1 Stable for download and upgrade.', 'http://www.magentocommerce.com/blog/comments/magento-ce-version-1411-stable-now-available/', 0, 0),
(31, 4, '2010-07-28 07:12:12', 'Magento CE Version 1.4.2.0-beta1 Preview Release Now Available', 'This release gives a preview of the new Magento Connect Manager.', 'http://www.magentocommerce.com/blog/comments/magento-preview-version-1420-beta1-now-available/', 0, 0),
(32, 4, '2010-07-28 22:15:01', 'Magento CE Version 1.4.1.1 Patch Available', 'As some users experienced issues with upgrading to CE 1.4.1.1 through PEAR channels we provided a patch for it that is available on our blog http://www.magentocommerce.com/blog/comments/magento-ce-version-1411-stable-patch/', 'http://www.magentocommerce.com/blog/comments/magento-ce-version-1411-stable-patch/', 0, 0),
(33, 4, '2010-10-12 02:13:25', 'Magento Mobile is now live!', 'Magento Mobile is now live! Signup today to have your own native iPhone mobile-shopping app in iTunes for the holiday season! Learn more at http://www.magentomobile.com/', 'http://www.magentomobile.com/', 0, 0),
(34, 4, '2010-11-09 01:52:06', 'Magento CE Version 1.4.2.0-RC1 Preview Release Now Available', 'We are happy to announce the availability of Magento Preview Version 1.4.2.0-RC1 for download.', 'http://www.magentocommerce.com/blog/comments/magento-preview-version-1420-rc1-now-available/', 0, 0),
(35, 4, '2010-12-03 00:33:00', 'Magento CE Version 1.4.2.0-RC2 Preview Release Now Available', 'We are happy to announce the availability of Magento Preview Version 1.4.2.0-RC2 for download.', 'http://www.magentocommerce.com/blog/comments/magento-preview-version-1420-rc2-now-available/', 0, 0),
(36, 4, '2010-12-09 02:29:55', 'Magento CE Version 1.4.2.0 Stable is now available', 'We are excited to announce the availability of Magento CE Version 1.4.2.0 Stable for download and upgrade.', 'http://www.magentocommerce.com/blog/comments/magento-ce-version-1420-stable-now-available/', 0, 0),
(37, 4, '2010-12-18 03:23:55', 'Magento Preview Version CE 1.5.0.0-alpha1 is now available', 'We are happy to announce the availability of Magento Preview Version CE 1.5.0.0-alpha1 for download.\nAs this is a preview version it is NOT recommended in any way to be used in a production environment.', 'http://www.magentocommerce.com/blog/comments/magento-preview-version-ce-1500-alpha1-now-available/', 0, 0),
(38, 4, '2010-12-30 03:51:08', 'Magento Preview Version CE 1.5.0.0-alpha2 is now available', 'We are happy to announce the availability of Magento Preview Version CE 1.5.0.0-alpha2 for download.\nAs this is a preview version it is NOT recommended in any way to be used in a production environment.', 'http://www.magentocommerce.com/blog/comments/magento-preview-version-ce-1500-alpha2-now-available/', 0, 0),
(39, 4, '2011-01-14 04:35:36', 'Magento Preview Version CE 1.5.0.0-beta1 is now available', 'We are happy to announce the availability of Magento Preview Version CE 1.5.0.0-beta1 for download.\nAs this is a preview version it is NOT recommended in any way to be used in a production environment.', 'http://www.magentocommerce.com/blog/comments/magento-preview-version-ce-1500-beta1-now-available/', 0, 0),
(40, 4, '2011-01-22 01:19:09', 'Magento Preview Version CE 1.5.0.0-beta2 is now available', 'We are happy to announce the availability of Magento Preview Version CE 1.5.0.0-beta2 for download.\nAs this is a preview version it is NOT recommended in any way to be used in a production environment.', 'http://www.magentocommerce.com/blog/comments/magento-preview-version-ce-1500-beta2-now-available/', 0, 0),
(41, 4, '2011-01-28 01:27:57', 'Magento Preview Version CE 1.5.0.0-rc1 is now available', 'We are happy to announce the availability of Magento Preview Version CE 1.5.0.0-rc1 for download.\nAs this is a preview version it is NOT recommended in any way to be used in a production environment.', 'http://www.magentocommerce.com/blog/comments/magento-preview-version-ce-1500-rc1-now-available/', 0, 0),
(42, 4, '2011-02-04 01:56:33', 'Magento Preview Version CE 1.5.0.0-rc2 is now available', 'We are happy to announce the availability of Magento Preview Version CE 1.5.0.0-rc2 for download.\nAs this is a preview version it is NOT recommended in any way to be used in a production environment.', 'http://www.magentocommerce.com/blog/comments/magento-preview-version-ce-1500-rc2-now-available/', 0, 0),
(43, 4, '2011-02-08 23:43:23', 'Magento CE Version 1.5.0.0 Stable is now available', 'We are excited to announce the availability of Magento CE Version 1.5.0.0 Stable for download and upgrade.', 'http://www.magentocommerce.com/blog/comments/magento-community-professional-and-enterprise-editions-releases-now-availab/', 0, 0),
(44, 4, '2011-02-10 03:42:57', 'Magento CE 1.5.0.1 stable Now Available', 'We are excited to announce the availability of Magento CE Version 1.5.0.1 Stable for download and upgrade.', 'http://www.magentocommerce.com/blog/comments/magento-ce-1501-stable-now-available/', 0, 0),
(45, 4, '2011-03-18 23:15:45', 'Magento CE 1.5.1.0-beta1 Now Available', 'We are happy to announce the availability of Magento Preview Version CE 1.5.1.0-beta1 for download and upgrade.', 'http://www.magentocommerce.com/blog/comments/magento-preview-version-ce-1510-beta1-now-available/', 0, 0),
(46, 4, '2011-03-31 20:43:02', 'Magento CE 1.5.1.0-rc1 Now Available', 'We are happy to announce the availability of Magento Preview Version CE 1.5.1.0-rc1 for download and upgrade.', 'http://www.magentocommerce.com/blog/comments/magento-preview-version-ce-1510-rc1-now-available/', 0, 0),
(47, 4, '2011-04-26 21:21:07', 'Magento CE 1.5.1.0-stable Now Available', 'We are excited to announce the availability of Magento CE Version 1.5.1.0 Stable for download and upgrade.', 'http://www.magentocommerce.com/blog/comments/magento-ce-version-1510-stable-now-available/', 0, 0),
(48, 4, '2011-05-26 21:33:23', 'Magento Preview Version CE 1.6.0.0-alpha1 is now available', 'We are happy to announce the availability of Magento Preview Version CE 1.6.0.0-alpha1 for download.\nAs this is a preview version it is NOT recommended in any way to be used in a production environment.', 'http://www.magentocommerce.com/blog/comments/magento-preview-version-ce-1600-alpha1-now-available/', 0, 0),
(49, 4, '2011-06-15 20:12:08', 'Magento Preview Version CE 1.6.0.0-beta1 is now available', 'We are happy to announce the availability of Magento Preview Version CE 1.6.0.0-beta1for download.\nAs this is a preview version it is NOT recommended in any way to be used in a production environment.', 'http://www.magentocommerce.com/blog/comments/magento-preview-version-ce-1600-beta1-now-available/', 0, 0),
(50, 4, '2011-06-30 21:03:58', 'Magento Preview Version CE 1.6.0.0-rc1 is now available', 'We are happy to announce the availability of Magento Preview Version CE 1.6.0.0-rc1 for download.\nAs this is a preview version it is NOT recommended in any way to be used in a production environment.', 'http://www.magentocommerce.com/blog/comments/magento-preview-version-ce-1600-rc1-now-available/', 0, 0),
(51, 4, '2011-07-11 21:07:39', 'Magento Preview Version CE 1.6.0.0-rc2 is now available', 'We are happy to announce the availability of Magento Preview Version CE 1.6.0.0-rc2 for download.\nAs this is a preview version it is NOT recommended in any way to be used in a production environment.', 'http://www.magentocommerce.com/blog/comments/magento-preview-version-ce-1600-rc2-now-available/', 0, 0),
(52, 4, '2011-08-19 19:58:31', 'Magento CE 1.6.0.0-stable Now Available', 'We are excited to announce the availability of Magento CE Version 1.6.0.0 Stable for download and upgrade.', 'http://www.magentocommerce.com/blog/comments/magento-ce-version-1600-stable-now-available/', 0, 0),
(53, 4, '2011-09-17 03:31:26', 'Magento Preview Version CE 1.6.1.0-beta1 is now available', 'We are happy to announce the availability of Magento Preview Version CE 1.6.1.0-beta1 for download.\nAs this is a preview version it is NOT recommended in any way to be used in a production environment.', 'http://www.magentocommerce.com/blog/comments/magento-preview-version-ce-1610-beta1-now-available/', 0, 0),
(54, 4, '2011-09-29 17:44:10', 'Magento Preview Version CE 1.6.1.0-rc1 is now available', 'We are happy to announce the availability of Magento Preview Version CE 1.6.1.0-rc1 for download.\nAs this is a preview version it is NOT recommended in any way to be used in a production environment.', 'http://www.magentocommerce.com/blog/comments/magento-preview-version-ce-1610-rc1-now-available/', 0, 0),
(55, 4, '2011-10-19 19:50:05', 'Magento CE 1.6.1.0-stable Now Available', 'We are excited to announce the availability of Magento CE Version 1.6.1.0 Stable for download and upgrade.', 'http://www.magentocommerce.com/blog/comments/magento-ce-version-1610-stable-now-available/', 0, 0),
(56, 4, '2011-12-30 21:39:35', 'Magento Preview Version CE 1.7.0.0-alpha1 is now available', 'We are happy to announce the availability of Magento Preview Version CE 1.7.0.0-alpha1 for download.\nAs this is a preview version it is NOT recommended in any way to be used in a production environment.', 'http://www.magentocommerce.com/blog/comments/magento-preview-version-ce-1700-alpha1-now-available/', 0, 0),
(57, 4, '2012-01-11 21:24:20', 'Magento CE 1.6.2.0-stable Now Available', 'We are excited to announce the availability of Magento CE Version 1.6.2.0 Stable for download and upgrade.', 'http://www.magentocommerce.com/blog/comments/magento-ce-version-1620-stable-now-available/', 0, 0),
(58, 4, '2012-03-02 23:54:12', 'Magento Preview Version CE 1.7.0.0-beta1 is now available', 'We are happy to announce the availability of Magento Preview Version CE 1.7.0.0-beta1 for download.\nAs this is a preview version it is NOT recommended in any way to be used in a production environment.', 'http://www.magentocommerce.com/blog/comments/magento-preview-version-ce-1700-beta1-now-available/', 0, 0),
(59, 4, '2012-04-23 12:02:40', 'Magento Community Preview Version CE 1.7.0.0-RC1 has been released!', 'Learn more about the exciting new features and updates in this release and how you can take it for a test drive. As this is a preview version, we need to stress that it''s likely unstable and that we DON''T recommend that you use it in any production environment just yet.', 'http://www.magentocommerce.com/blog/comments/magento-preview-version-ce-1700-rc1-now-available/', 0, 0),
(60, 4, '2012-05-11 07:46:54', 'Magento Community 1.7 and Magento Enterprise 1.12 now available!', 'Learn more about the exciting new features and updates in these releases.', 'http://www.magentocommerce.com/blog/comments/magento-enterprise-112-and-community-17-now-available/', 0, 0),
(61, 4, '2012-06-20 16:54:07', 'Magento Community Edition 1.7.0.1 now available! ', 'We have just released an updated version of Magento Community Edition, version 1.7.0.1. This update delivers new, minor functionality and fixes for some potential security vulnerabilities.', 'http://www.magentocommerce.com/blog/comments/magento-community-edition-1701-released/', 0, 0),
(62, 4, '2012-07-05 17:21:43', 'Important Security Update - Zend Platform Vulnerability', 'We have recently learned of a serious vulnerability in the Zend platform on which Magento is built. Learn more and access a patch that addresses this issue. ', 'http://www.magentocommerce.com/blog/comments/important-security-update-zend-platform-vulnerability/', 0, 0),
(63, 4, '2012-11-19 19:27:42', 'Wrap up more holiday sales with financing', 'Give your customers up to 6 months financing. You get paid right away with Bill Me Later, a PayPal service. It’s a great way to extend financing in time for the holidays. Learn More.', 'http://www.magentocommerce.com/paypal/billmelater?utm_source=CEMessaging&utm_medium=copy&utm_content=sixmonths&utm_campaign=BML', 0, 0),
...
(65, 4, '2013-02-12 16:53:42', 'Get More eCommerce Power with Magento Enterprise', 'Limited time offer: Get a free, customized evaluation of your Community Edition site from a Magento Solution Partner. This evaluation gives you a clear look at the numerous benefits you can achieve by upgrading to Enterprise Edition. ', 'http://www.magentocommerce.com/community-to-enterprise?utm_source=CEMM&utm_medium=copy&utm_campaign=CE2EE', 0, 0),
(66, 2, '2013-09-27 15:28:13', 'Magento Community Edition 1.8.0.0 - now available for download!', 'Get tax, security, performance, and many other improvements. \n\nLearn more at http://www.magentocommerce.com/blog/comments/magento-community-edition-one-eight-now-available/ ', 'http://www.magentocommerce.com/blog/comments/magento-community-edition-one-eight-now-available/', 0, 0),
(67, 4, '2013-12-11 14:35:06', 'Magento Community Edition 1.8.1.0 is here!', 'This new version offers significant tax calculation, product quality, and security enhancements. Be sure to carefully review the upgrade instructions before starting. More information is available at http://www.magentocommerce.com/blog/comments/magento-community-edition-1810-is-here/', 'http://www.magentocommerce.com/blog/comments/magento-community-edition-1810-is-here/', 0, 0),
(68, 4, '2013-12-12 22:24:39', 'Important Magento Community Edition Patch', 'A security patch is available for Magento Community Edition 1.4.0.0 through 1.7.0.2; the issue has been fixed in Magento Community Edition 1.8.0.0 and later. It resolves a vulnerability discovered through our quarterly penetration testing process and has not been reported by merchants. We encourage all merchants to apply the patch in their next regularly scheduled maintenance cycle. The patch is available at http://www.magentocommerce.com/download in the Magento Community Edition Patches section.', 'http://www.magentocommerce.com/download', 0, 0),
(69, 4, '2014-01-21 17:34:48', 'PHP 5.4 Patch Now Available', 'Magento is advancing its platform and making development more efficient by adding support for PHP 5.4. Patches are available for download at www.magentocommerce.com/download and you can learn more about this update in our blog post at http://www.magentocommerce.com/blog/comments/magento-now-supports-php-54 .', 'http://www.magentocommerce.com/blog/comments/magento-now-supports-php-54', 0, 0),
(70, 4, '2014-02-20 16:51:46', 'Discover Card Validation Patch Available', 'A patch that resolves an issue with validating Discover credit cards is now available for download at http://www.magentocommerce.com/download. More information on the patch is available in the Magento Knowledge Base at http://www.magentocommerce.com/knowledge-base/entry/discover-card-validation', 'http://www.magentocommerce.com/knowledge-base/entry/discover-card-validation ', 0, 0),
(71, 4, '2014-03-04 14:12:26', 'Learn How to Quickly Increase Sales on Your Site', 'Adding the PayPal Express Checkout button to your checkout page can help increase sales 18% on average. It’s fast and easy and you can do it right now to boost sales. Express Checkout is already seamlessly integrated into Community Edition.', 'http://magento.com/paypal/CE_Express_Checkout_NA?utm_source=messagemodule&utm_medium=message&utm_campaign=Ceexpresscheckout', 0, 0),
(72, 4, '2014-05-13 14:46:11', 'Magento Community Edition 1.9 is now available!', 'It accelerates your entry into the mobile commerce space by slashing the time and cost of getting a mobile device-friendly responsive site.  And a new Bill Me Later payment option helps boost your sales. Visit http://magento.com/blog/magento-news/magento-enables-responsive-sites-half-time to learn more.', 'http://magento.com/blog/magento-news/magento-enables-responsive-sites-half-time', 0, 0),
...
--
-- Structure de la table `mg_admin_assert`
--
...
--
-- Structure de la table `mg_admin_role`
--
...
--
-- Contenu de la table `mg_admin_role`
--
...
--
-- Structure de la table `mg_admin_rule`
--
...
--
-- Contenu de la table `mg_admin_rule`
--
...
--
-- Structure de la table `mg_admin_user`
--
...
--
-- Contenu de la table `mg_admin_user`
--
...
(1, 'Fabien', 'Sebban', 'fa.sebban@gmail.com', 'fabiensebban', '4d0e06ac710059e4ad80eda8f2272aa5:ef23i2Ulb04JGBlGkANO306kg6rmh69F', '2017-05-29 07:14:51', '2017-05-30 10:53:32', '2017-05-30 11:08:01', 7, 0, 1, 'a:1:{s:11:"configState";a:32:{s:15:"payment_account";s:1:"1";s:32:"payment_paypal_payment_solutions";s:1:"1";s:36:"payment_payments_pro_hosted_solution";s:1:"0";s:30:"payment_pphs_required_settings";s:1:"1";s:35:"payment_pphs_required_settings_pphs";s:1:"1";s:21:"payment_pphs_settings";s:1:"1";s:30:"payment_pphs_settings_advanced";s:1:"0";s:30:"payment_pphs_settlement_report";s:1:"0";s:19:"payment_wps_express";s:1:"0";s:37:"payment_wps_express_checkout_required";s:1:"1";s:54:"payment_wps_express_checkout_required_express_checkout";s:1:"1";s:28:"payment_settings_wps_express";s:1:"1";s:37:"payment_settings_wps_express_advanced";s:1:"1";s:37:"payment_wps_express_billing_agreement";s:1:"1";s:37:"payment_wps_express_settlement_report";s:1:"1";s:28:"payment_wps_express_frontend";s:1:"1";s:24:"payment_express_checkout";s:1:"1";s:33:"payment_express_checkout_required";s:1:"1";s:50:"payment_express_checkout_required_express_checkout";s:1:"1";s:19:"payment_settings_ec";s:1:"1";s:28:"payment_settings_ec_advanced";s:1:"1";s:42:"payment_express_checkout_billing_agreement";s:1:"1";s:42:"payment_express_checkout_settlement_report";s:1:"0";s:33:"payment_express_checkout_frontend";s:1:"0";s:14:"payment_ccsave";s:1:"0";s:15:"payment_checkmo";s:1:"0";s:12:"payment_free";s:1:"0";s:20:"payment_banktransfer";s:1:"0";s:22:"payment_cashondelivery";s:1:"0";s:21:"payment_purchaseorder";s:1:"0";s:20:"payment_authorizenet";s:1:"0";s:31:"payment_authorizenet_directpost";s:1:"0";}}', NULL, NULL);

-- --------------------------------------------------------

--
-- Structure de la table `mg_api2_acl_attribute`
--
...
--
-- Structure de la table `mg_api2_acl_role`
--
...
--
-- Contenu de la table `mg_api2_acl_role`
--

INSERT INTO `mg_api2_acl_role` (`entity_id`, `created_at`, `updated_at`, `role_name`) VALUES
(1, '2017-05-29 09:14:12', NULL, 'Guest'),
(2, '2017-05-29 09:14:12', NULL, 'Customer');

-- --------------------------------------------------------

--
-- Structure de la table `mg_api2_acl_rule`
--
...
--
-- Structure de la table `mg_api2_acl_user`
--
...
--
-- Structure de la table `mg_api_assert`
--
...
--
-- Structure de la table `mg_api_role`
--
...
--
-- Structure de la table `mg_api_rule`
--
...
--
-- Structure de la table `mg_api_session`
--
...
--
-- Structure de la table `mg_api_user`
--
...
--
-- Structure de la table `mg_captcha_log`
--
...
--
-- Structure de la table `mg_cataloginventory_stock`
--
...
--
-- Contenu de la table `mg_cataloginventory_stock`
--
...
--
-- Structure de la table `mg_cataloginventory_stock_item`
--
...
--
-- Contenu de la table `mg_cataloginventory_stock_item`
--
...
(1, 1, 1, '9.0000', '0.0000', 1, 0, 0, 1, '1.0000', 1, '0.0000', 1, 1, NULL, NULL, 1, 0, 1, 0, 1, '0.0000', 1, 0, 0);

-- --------------------------------------------------------

--
-- Structure de la table `mg_cataloginventory_stock_status`
--
...
--
-- Contenu de la table `mg_cataloginventory_stock_status`
--
...
--
-- Structure de la table `mg_cataloginventory_stock_status_idx`
--
...
--
-- Structure de la table `mg_cataloginventory_stock_status_tmp`
--
...
--
-- Structure de la table `mg_catalogrule`
--
...
--
-- Structure de la table `mg_catalogrule_affected_product`
--
...
--
-- Structure de la table `mg_catalogrule_customer_group`
--
...
--
-- Structure de la table `mg_catalogrule_group_website`
--
...
--
-- Structure de la table `mg_catalogrule_product`
--
...
--
-- Structure de la table `mg_catalogrule_product_price`
--
...
--
-- Structure de la table `mg_catalogrule_website`
--
...
--
-- Structure de la table `mg_catalogsearch_fulltext`
--
...
--
-- Contenu de la table `mg_catalogsearch_fulltext`
--

INSERT INTO `mg_catalogsearch_fulltext` (`fulltext_id`, `product_id`, `store_id`, `data_index`) VALUES
(1, 1, 1, 'sku|None|Chocolat|description|short description|3.9|1');

-- --------------------------------------------------------

--
-- Structure de la table `mg_catalogsearch_query`
--
...
--
-- Contenu de la table `mg_catalogsearch_query`
--
...
(1, 'test', 0, 2, NULL, NULL, 1, 1, 1, 0, '2017-05-30 12:33:01');

-- --------------------------------------------------------

--
-- Structure de la table `mg_catalogsearch_result`
--
...
--
-- Structure de la table `mg_catalog_category_anc_categs_index_idx`
--
...
--
-- Structure de la table `mg_catalog_category_anc_categs_index_tmp`
--
...
--
-- Structure de la table `mg_catalog_category_anc_products_index_idx`
--
...
--
-- Structure de la table `mg_catalog_category_anc_products_index_tmp`
--
...
--
-- Structure de la table `mg_catalog_category_entity`
--
...
--
-- Contenu de la table `mg_catalog_category_entity`
--
...
(1, 3, 0, 0, '2017-05-29 07:14:18', '2017-05-29 07:14:18', '1', 0, 0, 2),
(2, 3, 3, 1, '2017-05-29 07:14:18', '2017-05-29 07:14:18', '1/2', 1, 1, 1),
(3, 3, 3, 2, '2017-05-30 12:30:17', '2017-05-30 12:30:17', '1/2/3', 1, 2, 0);

-- --------------------------------------------------------

--
-- Structure de la table `mg_catalog_category_entity_datetime`
--
...
--
-- Contenu de la table `mg_catalog_category_entity_datetime`
--
...
--
-- Structure de la table `mg_catalog_category_entity_decimal`
--
...
--
-- Contenu de la table `mg_catalog_category_entity_decimal`
--
...
--
-- Structure de la table `mg_catalog_category_entity_int`
--
...
--
-- Contenu de la table `mg_catalog_category_entity_int`
--
...
--
-- Structure de la table `mg_catalog_category_entity_text`
--
...
--
-- Contenu de la table `mg_catalog_category_entity_text`
--
...
--
-- Structure de la table `mg_catalog_category_entity_varchar`
--
...
--
-- Contenu de la table `mg_catalog_category_entity_varchar`
--
...
(12, 3, 61, 0, 3, NULL),
(13, 3, 43, 0, 3, 'cattest'),
(14, 3, 57, 1, 3, 'cattest.html'),
(15, 3, 57, 0, 3, 'cattest.html');

-- --------------------------------------------------------

--
-- Structure de la table `mg_catalog_category_product`
--
...
--
-- Contenu de la table `mg_catalog_category_product`
--
...
--
-- Structure de la table `mg_catalog_category_product_index`
--
...
--
-- Contenu de la table `mg_catalog_category_product_index`
--
...
--
-- Structure de la table `mg_catalog_category_product_index_enbl_idx`
--
...
--
-- Structure de la table `mg_catalog_category_product_index_enbl_tmp`
--
...
--
-- Structure de la table `mg_catalog_category_product_index_idx`
--
...
--
-- Structure de la table `mg_catalog_category_product_index_tmp`
--
...
--
-- Structure de la table `mg_catalog_compare_item`
--
...
--
-- Structure de la table `mg_catalog_eav_attribute`
--
...
--
-- Contenu de la table `mg_catalog_eav_attribute`
--
...
--
-- Structure de la table `mg_catalog_product_bundle_option`
--
...
--
-- Structure de la table `mg_catalog_product_bundle_option_value`
--
...
--
-- Structure de la table `mg_catalog_product_bundle_price_index`
--
...
--
-- Structure de la table `mg_catalog_product_bundle_selection`
--
...
--
-- Structure de la table `mg_catalog_product_bundle_selection_price`
--
...
--
-- Structure de la table `mg_catalog_product_bundle_stock_index`
--
...
--
-- Structure de la table `mg_catalog_product_enabled_index`
--
...
--
-- Structure de la table `mg_catalog_product_entity`
--
...
--
-- Contenu de la table `mg_catalog_product_entity`
--
...
(1, 4, 4, 'simple', 'sku', 0, 0, '2017-05-30 12:29:00', '2017-05-30 12:35:28');

-- --------------------------------------------------------

--
-- Structure de la table `mg_catalog_product_entity_datetime`
--
...
--
-- Contenu de la table `mg_catalog_product_entity_datetime`
--
...
--
-- Structure de la table `mg_catalog_product_entity_decimal`
--
...
--
-- Contenu de la table `mg_catalog_product_entity_decimal`
--
...
--
-- Structure de la table `mg_catalog_product_entity_gallery`
--
...
--
-- Structure de la table `mg_catalog_product_entity_group_price`
--
...
--
-- Structure de la table `mg_catalog_product_entity_int`
--
...
--
-- Contenu de la table `mg_catalog_product_entity_int`
--
...
--
-- Structure de la table `mg_catalog_product_entity_media_gallery`
--
...
--
-- Structure de la table `mg_catalog_product_entity_media_gallery_value`
--
...
--
-- Structure de la table `mg_catalog_product_entity_text`
--
...
--
-- Structure de la table `mg_catalog_product_entity_tier_price`
--
...
--
-- Structure de la table `mg_catalog_product_entity_varchar`
--
...
CREATE TABLE `mg_catalog_product_entity_varchar` (
  ...
  `entity_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Entity ID',
  `value` varchar(255) DEFAULT NULL COMMENT 'Value'
) ENGINE=InnoDB AUTO_INCREMENT=37 DEFAULT CHARSET=utf8 COMMENT='Catalog Product Varchar Attribute Backend Table';

--
-- Contenu de la table `mg_catalog_product_entity_varchar`
--
...
(14, 4, 122, 0, 1, NULL),
(15, 4, 98, 1, 1, 'chocolat.html'),
(16, 4, 98, 0, 1, 'chocolat.html');

-- --------------------------------------------------------

--
-- Structure de la table `mg_catalog_product_index_eav`
--
...
--
-- Contenu de la table `mg_catalog_product_index_eav`
--
...
--
-- Structure de la table `mg_catalog_product_index_eav_decimal`
--
...
--
-- Structure de la table `mg_catalog_product_index_eav_decimal_idx`
--
...
--
-- Structure de la table `mg_catalog_product_index_eav_decimal_tmp`
--
...
--
-- Structure de la table `mg_catalog_product_index_eav_idx`
--
...
--
-- Structure de la table `mg_catalog_product_index_eav_tmp`
--
...
--
-- Contenu de la table `mg_catalog_product_index_eav_tmp`
--

INSERT INTO `mg_catalog_product_index_eav_tmp` (`entity_id`, `attribute_id`, `store_id`, `value`) VALUES
(1, 121, 1, 0);

-- --------------------------------------------------------

--
-- Structure de la table `mg_catalog_product_index_group_price`
--
...
--
-- Structure de la table `mg_catalog_product_index_price`
--
...
--
-- Contenu de la table `mg_catalog_product_index_price`
--
...
(1, 0, 1, 0, '3.9000', '3.9000', '3.9000', '3.9000', NULL, NULL),
(1, 1, 1, 0, '3.9000', '3.9000', '3.9000', '3.9000', NULL, NULL),
(1, 2, 1, 0, '3.9000', '3.9000', '3.9000', '3.9000', NULL, NULL),
(1, 3, 1, 0, '3.9000', '3.9000', '3.9000', '3.9000', NULL, NULL);

-- --------------------------------------------------------

--
-- Structure de la table `mg_catalog_product_index_price_bundle_idx`
--
...
--
-- Structure de la table `mg_catalog_product_index_price_bundle_opt_idx`
--
...
--
-- Structure de la table `mg_catalog_product_index_price_bundle_opt_tmp`
--
...
--
-- Structure de la table `mg_catalog_product_index_price_bundle_sel_idx`
--
...
--
-- Structure de la table `mg_catalog_product_index_price_bundle_sel_tmp`
--
...
--
-- Structure de la table `mg_catalog_product_index_price_bundle_tmp`
--
...
--
-- Structure de la table `mg_catalog_product_index_price_cfg_opt_agr_idx`
--
...
--
-- Structure de la table `mg_catalog_product_index_price_cfg_opt_agr_tmp`
--
...
--
-- Structure de la table `mg_catalog_product_index_price_cfg_opt_idx`
--
...
--
-- Structure de la table `mg_catalog_product_index_price_cfg_opt_tmp`
--
...
--
-- Structure de la table `mg_catalog_product_index_price_downlod_idx`
--
...
--
-- Structure de la table `mg_catalog_product_index_price_downlod_tmp`
--
...
--
-- Structure de la table `mg_catalog_product_index_price_final_idx`
--
...
--
-- Structure de la table `mg_catalog_product_index_price_final_tmp`
--
...
--
-- Structure de la table `mg_catalog_product_index_price_idx`
--
...
--
-- Structure de la table `mg_catalog_product_index_price_opt_agr_idx`
--
...
--
-- Structure de la table `mg_catalog_product_index_price_opt_agr_tmp`
--
...
--
-- Structure de la table `mg_catalog_product_index_price_opt_idx`
--
...
--
-- Structure de la table `mg_catalog_product_index_price_opt_tmp`
--
...
--
-- Structure de la table `mg_catalog_product_index_price_tmp`
--
...
--
-- Contenu de la table `mg_catalog_product_index_price_tmp`
--

INSERT INTO `mg_catalog_product_index_price_tmp` (`entity_id`, `customer_group_id`, `website_id`, `tax_class_id`, `price`, `final_price`, `min_price`, `max_price`, `tier_price`, `group_price`) VALUES
(1, 0, 1, 0, '3.9000', '3.9000', '3.9000', '3.9000', NULL, NULL),
(1, 1, 1, 0, '3.9000', '3.9000', '3.9000', '3.9000', NULL, NULL),
(1, 2, 1, 0, '3.9000', '3.9000', '3.9000', '3.9000', NULL, NULL),
(1, 3, 1, 0, '3.9000', '3.9000', '3.9000', '3.9000', NULL, NULL);
...
--
-- Structure de la table `mg_catalog_product_index_tier_price`
--
...
--
-- Structure de la table `mg_catalog_product_index_website`
--
...
--
-- Contenu de la table `mg_catalog_product_index_website`
--
...
--
-- Structure de la table `mg_catalog_product_link`
--
...
--
-- Structure de la table `mg_catalog_product_link_attribute`
--
...
--
-- Contenu de la table `mg_catalog_product_link_attribute`
--
...
--
-- Structure de la table `mg_catalog_product_link_attribute_decimal`
--
...
--
-- Structure de la table `mg_catalog_product_link_attribute_int`
--
...
--
-- Structure de la table `mg_catalog_product_link_attribute_varchar`
--
...
--
-- Structure de la table `mg_catalog_product_link_type`
--
...
--
-- Contenu de la table `mg_catalog_product_link_type`
--
...
--
-- Structure de la table `mg_catalog_product_option`
--
...
--
-- Structure de la table `mg_catalog_product_option_price`
--
...
--
-- Structure de la table `mg_catalog_product_option_title`
--
...
--
-- Structure de la table `mg_catalog_product_option_type_price`
--
...
--
-- Structure de la table `mg_catalog_product_option_type_title`
--
...
--
-- Structure de la table `mg_catalog_product_option_type_value`
--
...
--
-- Structure de la table `mg_catalog_product_relation`
--
...
--
-- Structure de la table `mg_catalog_product_super_attribute`
--
...
--
-- Structure de la table `mg_catalog_product_super_attribute_label`
--
...
--
-- Structure de la table `mg_catalog_product_super_attribute_pricing`
--
...
--
-- Structure de la table `mg_catalog_product_super_link`
--
...
--
-- Structure de la table `mg_catalog_product_website`
--
...
--
-- Contenu de la table `mg_catalog_product_website`
--
...
--
-- Structure de la table `mg_checkout_agreement`
--
...
--
-- Structure de la table `mg_checkout_agreement_store`
--
...
--
-- Structure de la table `mg_cms_block`
--
...
--
-- Contenu de la table `mg_cms_block_store`
--
...
--
-- Structure de la table `mg_cms_page`
--
...
--
-- Contenu de la table `mg_cms_page`
--
...
--
-- Contenu de la table `mg_cms_page_store`
--
...
--
-- Structure de la table `mg_core_cache`
--
...
--
-- Structure de la table `mg_core_cache_option`
--
...
--
-- Contenu de la table `mg_core_cache_option`
--
...
--
-- Structure de la table `mg_core_cache_tag`
--
...
--
-- Structure de la table `mg_core_config_data`
--
...
--
-- Contenu de la table `mg_core_config_data`
--
...
(9, 'default', 0, 'web/unsecure/base_url', 'http://magento.dev/'),
(10, 'default', 0, 'web/secure/base_url', 'http://magento.dev/'),
(11, 'default', 0, 'general/locale/code', 'fr_FR'),
(12, 'default', 0, 'general/locale/timezone', 'Europe/Paris'),
(13, 'default', 0, 'currency/options/base', 'EUR'),
(14, 'default', 0, 'currency/options/default', 'EUR'),
(15, 'default', 0, 'currency/options/allow', 'EUR'),
(16, 'default', 0, 'paypal/general/merchant_country', 'FR'),
(17, 'default', 0, 'paypal/general/business_account', 'scarpa.zend-facilitator@gmail.com'),
(18, 'default', 0, 'paypal/wpp/api_authentication', '0'),
(19, 'default', 0, 'paypal/wpp/api_username', 'XgETmOmr8XV5hF/fTyIfdmLCv2A7ZUKAvHM4IpiXjMh+VyM0qydggg=='),
(20, 'default', 0, 'paypal/wpp/api_password', 'tZEa/V4iuYd/DX2zUZ3dHw=='),
(21, 'default', 0, 'paypal/wpp/api_signature', 'Y1hYlyS25C5J8CT0zl87f2dkLMgCevvvE/XN0BotqvgQqgBLWIPVyZ86/bcBLazbhIFf1poFFX0='),
(22, 'default', 0, 'paypal/wpp/sandbox_flag', '1'),
(23, 'default', 0, 'paypal/wpp/use_proxy', '0'),
(24, 'default', 0, 'payment/hosted_pro/active', '0'),
(25, 'default', 0, 'payment/hosted_pro/title', 'Payment by cards or by PayPal account'),
(26, 'default', 0, 'payment/hosted_pro/sort_order', NULL),
(27, 'default', 0, 'payment/hosted_pro/payment_action', 'Authorization'),
(28, 'default', 0, 'payment/hosted_pro/display_ec', '0'),
(29, 'default', 0, 'payment/hosted_pro/allowspecific', '0'),
(30, 'default', 0, 'payment/hosted_pro/debug', '0'),
(31, 'default', 0, 'payment/hosted_pro/verify_peer', '1'),
(32, 'default', 0, 'paypal/fetch_reports/ftp_login', NULL),
(33, 'default', 0, 'paypal/fetch_reports/ftp_password', NULL),
(34, 'default', 0, 'paypal/fetch_reports/ftp_sandbox', '0'),
(35, 'default', 0, 'paypal/fetch_reports/ftp_ip', NULL),
(36, 'default', 0, 'paypal/fetch_reports/ftp_path', NULL),
(37, 'default', 0, 'paypal/fetch_reports/active', '0'),
(38, 'default', 0, 'paypal/fetch_reports/schedule', '1'),
(39, 'default', 0, 'paypal/fetch_reports/time', '00,00,00'),
(40, 'default', 0, 'payment/paypal_wps_express/active', '0'),
(41, 'default', 0, 'payment/paypal_express/title', 'PayPal Express Checkout'),
(42, 'default', 0, 'payment/paypal_express/sort_order', NULL),
(43, 'default', 0, 'payment/paypal_express/payment_action', 'Authorization'),
(44, 'default', 0, 'payment/paypal_express/visible_on_product', '1'),
(45, 'default', 0, 'payment/paypal_express/visible_on_cart', '1'),
(46, 'default', 0, 'payment/paypal_express/allowspecific', '0'),
(47, 'default', 0, 'payment/paypal_express/debug', '0'),
(48, 'default', 0, 'payment/paypal_express/verify_peer', '0'),
(49, 'default', 0, 'payment/paypal_express/line_items_enabled', '1'),
(50, 'default', 0, 'payment/paypal_express/transfer_shipping_options', '0'),
(51, 'default', 0, 'paypal/wpp/button_flavor', 'dynamic'),
(52, 'default', 0, 'payment/paypal_express/solution_type', 'Sole'),
(53, 'default', 0, 'payment/paypal_express/require_billing_address', '0'),
(54, 'default', 0, 'payment/paypal_express/allow_ba_signup', 'never'),
(55, 'default', 0, 'payment/paypal_billing_agreement/active', '1'),
(56, 'default', 0, 'payment/paypal_billing_agreement/title', 'PayPal Billing Agreement'),
(57, 'default', 0, 'payment/paypal_billing_agreement/sort_order', NULL),
(58, 'default', 0, 'payment/paypal_billing_agreement/payment_action', 'Authorization'),
(59, 'default', 0, 'payment/paypal_billing_agreement/allowspecific', '0'),
(60, 'default', 0, 'payment/paypal_billing_agreement/debug', '0'),
(61, 'default', 0, 'payment/paypal_billing_agreement/verify_peer', '0'),
(62, 'default', 0, 'payment/paypal_billing_agreement/line_items_enabled', '0'),
(63, 'default', 0, 'payment/paypal_billing_agreement/allow_billing_agreement_wizard', '1'),
(64, 'default', 0, 'paypal/style/logo', 'nowAccepting_150x60'),
(65, 'default', 0, 'paypal/style/page_style', NULL),
(66, 'default', 0, 'paypal/style/paypal_hdrimg', NULL),
(67, 'default', 0, 'paypal/style/paypal_hdrbackcolor', NULL),
(68, 'default', 0, 'paypal/style/paypal_hdrbordercolor', NULL),
(69, 'default', 0, 'paypal/style/paypal_payflowcolor', NULL),
(70, 'default', 0, 'payment/paypal_express/active', '1'),
(71, 'default', 0, 'payment/ccsave/active', '1'),
(72, 'default', 0, 'payment/ccsave/title', 'Credit Card (saved)'),
(73, 'default', 0, 'payment/ccsave/order_status', 'pending'),
(74, 'default', 0, 'payment/ccsave/cctypes', 'AE,VI,MC,DI'),
(75, 'default', 0, 'payment/ccsave/useccv', '0'),
(76, 'default', 0, 'payment/ccsave/centinel', '0'),
(77, 'default', 0, 'payment/ccsave/allowspecific', '0'),
(78, 'default', 0, 'payment/ccsave/min_order_total', NULL),
(79, 'default', 0, 'payment/ccsave/max_order_total', NULL),
(80, 'default', 0, 'payment/ccsave/sort_order', NULL),
(81, 'default', 0, 'payment/checkmo/active', '1'),
(82, 'default', 0, 'payment/checkmo/title', 'Check / Money order'),
(83, 'default', 0, 'payment/checkmo/order_status', 'pending'),
(84, 'default', 0, 'payment/checkmo/allowspecific', '0'),
(85, 'default', 0, 'payment/checkmo/payable_to', NULL),
(86, 'default', 0, 'payment/checkmo/mailing_address', NULL),
(87, 'default', 0, 'payment/checkmo/min_order_total', NULL),
(88, 'default', 0, 'payment/checkmo/max_order_total', NULL),
(89, 'default', 0, 'payment/checkmo/sort_order', NULL),
(90, 'default', 0, 'payment/free/active', '1'),
(91, 'default', 0, 'payment/free/title', 'No Payment Information Required'),
(92, 'default', 0, 'payment/free/order_status', 'pending'),
(93, 'default', 0, 'payment/free/allowspecific', '0'),
(94, 'default', 0, 'payment/free/sort_order', '1'),
(95, 'default', 0, 'payment/banktransfer/active', '0'),
(96, 'default', 0, 'payment/banktransfer/title', 'Bank Transfer Payment'),
(97, 'default', 0, 'payment/banktransfer/order_status', 'pending'),
(98, 'default', 0, 'payment/banktransfer/allowspecific', '0'),
(99, 'default', 0, 'payment/banktransfer/instructions', NULL),
(100, 'default', 0, 'payment/banktransfer/min_order_total', NULL),
(101, 'default', 0, 'payment/banktransfer/max_order_total', NULL),
(102, 'default', 0, 'payment/banktransfer/sort_order', NULL),
(103, 'default', 0, 'payment/cashondelivery/active', '0'),
(104, 'default', 0, 'payment/cashondelivery/title', 'Cash On Delivery'),
(105, 'default', 0, 'payment/cashondelivery/order_status', 'pending'),
(106, 'default', 0, 'payment/cashondelivery/allowspecific', '0'),
(107, 'default', 0, 'payment/cashondelivery/instructions', NULL),
(108, 'default', 0, 'payment/cashondelivery/min_order_total', NULL),
(109, 'default', 0, 'payment/cashondelivery/max_order_total', NULL),
(110, 'default', 0, 'payment/cashondelivery/sort_order', NULL),
(111, 'default', 0, 'payment/purchaseorder/active', '0'),
(112, 'default', 0, 'payment/purchaseorder/title', 'Purchase Order'),
(113, 'default', 0, 'payment/purchaseorder/order_status', 'pending'),
(114, 'default', 0, 'payment/purchaseorder/allowspecific', '0'),
(115, 'default', 0, 'payment/purchaseorder/min_order_total', NULL),
(116, 'default', 0, 'payment/purchaseorder/max_order_total', NULL),
(117, 'default', 0, 'payment/purchaseorder/sort_order', NULL),
(118, 'default', 0, 'payment/authorizenet/active', '0'),
(119, 'default', 0, 'payment/authorizenet/payment_action', 'authorize'),
(120, 'default', 0, 'payment/authorizenet/login', NULL),
(121, 'default', 0, 'payment/authorizenet/merchant_email', NULL),
(122, 'default', 0, 'payment/authorizenet/title', 'Credit Card (Authorize.net)'),
(123, 'default', 0, 'payment/authorizenet/trans_key', NULL),
(124, 'default', 0, 'payment/authorizenet/cgi_url', 'https://secure.authorize.net/gateway/transact.dll'),
(125, 'default', 0, 'payment/authorizenet/cgi_url_td', 'https://api.authorize.net/xml/v1/request.api'),
(126, 'default', 0, 'payment/authorizenet/order_status', 'processing'),
(127, 'default', 0, 'payment/authorizenet/test', '1'),
(128, 'default', 0, 'payment/authorizenet/debug', '0'),
(129, 'default', 0, 'payment/authorizenet/currency', 'USD'),
(130, 'default', 0, 'payment/authorizenet/email_customer', '0'),
(131, 'default', 0, 'payment/authorizenet/cctypes', 'AE,VI,MC,DI'),
(132, 'default', 0, 'payment/authorizenet/allowspecific', '0'),
(133, 'default', 0, 'payment/authorizenet/useccv', '0'),
(134, 'default', 0, 'payment/authorizenet/min_order_total', NULL),
(135, 'default', 0, 'payment/authorizenet/max_order_total', NULL),
(136, 'default', 0, 'payment/authorizenet/sort_order', NULL),
(137, 'default', 0, 'payment/authorizenet/allow_partial_authorization', '0'),
(138, 'default', 0, 'payment/authorizenet/centinel', '0'),
(139, 'default', 0, 'payment/authorizenet_directpost/active', '0'),
(140, 'default', 0, 'payment/authorizenet_directpost/payment_action', 'authorize'),
(141, 'default', 0, 'payment/authorizenet_directpost/title', 'Credit Card Direct Post (Authorize.net)'),
(142, 'default', 0, 'payment/authorizenet_directpost/login', NULL),
(143, 'default', 0, 'payment/authorizenet_directpost/trans_key', NULL),
(144, 'default', 0, 'payment/authorizenet_directpost/trans_md5', NULL),
(145, 'default', 0, 'payment/authorizenet_directpost/order_status', 'processing'),
(146, 'default', 0, 'payment/authorizenet_directpost/test', '1'),
(147, 'default', 0, 'payment/authorizenet_directpost/cgi_url', 'https://secure.authorize.net/gateway/transact.dll'),
(148, 'default', 0, 'payment/authorizenet_directpost/currency', 'USD'),
(149, 'default', 0, 'payment/authorizenet_directpost/debug', '0'),
(150, 'default', 0, 'payment/authorizenet_directpost/email_customer', '0'),
(151, 'default', 0, 'payment/authorizenet_directpost/merchant_email', NULL),
(152, 'default', 0, 'payment/authorizenet_directpost/cctypes', 'AE,VI,MC,DI'),
(153, 'default', 0, 'payment/authorizenet_directpost/useccv', '0'),
(154, 'default', 0, 'payment/authorizenet_directpost/allowspecific', '0'),
(155, 'default', 0, 'payment/authorizenet_directpost/min_order_total', NULL),
(156, 'default', 0, 'payment/authorizenet_directpost/max_order_total', NULL),
(157, 'default', 0, 'payment/authorizenet_directpost/sort_order', NULL);

-- --------------------------------------------------------

--
-- Structure de la table `mg_core_email_queue`
--

CREATE TABLE `mg_core_email_queue` (
...
--
-- Contenu de la table `mg_core_email_queue_recipients`
--

INSERT INTO `mg_core_email_queue_recipients` (`recipient_id`, `message_id`, `recipient_email`, `recipient_name`, `email_type`) VALUES
(1, 1, 'ghansumn@gmail.com', 'Nourdine Ghansum', 0);

-- --------------------------------------------------------

--
-- Structure de la table `mg_core_email_template`
--
...
--
-- Structure de la table `mg_core_flag`
--
...
--
-- Contenu de la table `mg_core_flag`
--

INSERT INTO `mg_core_flag` (`flag_id`, `flag_code`, `state`, `flag_data`, `last_update`) VALUES
(1, 'admin_notification_survey', 0, 'a:1:{s:13:"survey_viewed";b:1;}', '2017-05-29 07:14:52');

-- --------------------------------------------------------

--
-- Structure de la table `mg_core_layout_link`
--
...
--
-- Structure de la table `mg_core_layout_update`
--
...
--
-- Structure de la table `mg_core_resource`
--
...
--
-- Contenu de la table `mg_core_resource`
--
...
('learning_slider_setup', '0.1.0', '0.1.0'),
...
--
-- Structure de la table `mg_core_session`
--
...
--
-- Structure de la table `mg_core_store`
--
...
--
-- Contenu de la table `mg_core_store`
--
...
--
-- Structure de la table `mg_core_store_group`
--
...
--
-- Contenu de la table `mg_core_store_group`
--
...
--
-- Structure de la table `mg_core_translate`
--
...
--
-- Structure de la table `mg_core_url_rewrite`
--
...
--
-- Contenu de la table `mg_core_url_rewrite`
--
...
(1, 1, 'product/1', 'chocolat.html', 'catalog/product/view/id/1', 1, NULL, NULL, NULL, 1),
(4, 1, '07801200_1496154929', 'test.html', 'chocolat.html', 0, 'RP', NULL, NULL, 1),
(5, 1, 'category/3', 'cattest.html', 'catalog/category/view/id/3', 1, NULL, NULL, 3, NULL),
(7, 1, 'product/1/3', 'cattest/chocolat.html', 'catalog/product/view/id/1/category/3', 1, NULL, NULL, 3, 1);

-- --------------------------------------------------------

--
-- Structure de la table `mg_core_variable`
--
...
--
-- Structure de la table `mg_core_variable_value`
--
...
--
-- Structure de la table `mg_core_website`
--
...
--
-- Contenu de la table `mg_core_website`
--
...
--
-- Structure de la table `mg_coupon_aggregated`
--
...
--
-- Structure de la table `mg_coupon_aggregated_order`
--
...
--
-- Structure de la table `mg_coupon_aggregated_updated`
--
...
--
-- Structure de la table `mg_cron_schedule`
--
...
--
-- Structure de la table `mg_customer_address_entity`
--
...
--
-- Structure de la table `mg_customer_address_entity_datetime`
--
...
--
-- Structure de la table `mg_customer_address_entity_decimal`
--
...
--
-- Structure de la table `mg_customer_address_entity_int`
--
...
--
-- Structure de la table `mg_customer_address_entity_text`
--
...
--
-- Structure de la table `mg_customer_address_entity_varchar`
--
...
--
-- Structure de la table `mg_customer_eav_attribute`
--
...
--
-- Contenu de la table `mg_customer_eav_attribute`
--
...
--
-- Structure de la table `mg_customer_eav_attribute_website`
--
...
--
-- Structure de la table `mg_customer_entity`
--
...
--
-- Structure de la table `mg_customer_entity_datetime`
--
...
--
-- Structure de la table `mg_customer_entity_decimal`
--
...
--
-- Structure de la table `mg_customer_entity_int`
--
...
--
-- Structure de la table `mg_customer_entity_text`
--
...
--
-- Structure de la table `mg_customer_entity_varchar`
--
...
--
-- Structure de la table `mg_customer_flowpassword`
--

CREATE TABLE `mg_customer_flowpassword` (
...
--
-- Structure de la table `mg_customer_form_attribute`
--
...
--
-- Contenu de la table `mg_customer_form_attribute`
--
...
--
-- Structure de la table `mg_customer_group`
--
...
--
-- Contenu de la table `mg_customer_group`
--
...
--
-- Structure de la table `mg_dataflow_batch`
--
...
--
-- Structure de la table `mg_dataflow_batch_export`
--
...
--
-- Structure de la table `mg_dataflow_batch_import`
--
...
--
-- Structure de la table `mg_dataflow_import_data`
--
...
--
-- Structure de la table `mg_dataflow_profile`
--
...
--
-- Contenu de la table `mg_dataflow_profile`
--
...
--
-- Contenu de la table `mg_dataflow_profile_history`
--

INSERT INTO `mg_dataflow_profile_history` (`history_id`, `profile_id`, `action_code`, `user_id`, `performed_at`) VALUES
(1, 1, 'create', 0, '2017-05-29 07:14:15'),
(2, 2, 'create', 0, '2017-05-29 07:14:15'),
(3, 3, 'create', 0, '2017-05-29 07:14:15'),
(4, 4, 'create', 0, '2017-05-29 07:14:15'),
(5, 5, 'create', 0, '2017-05-29 07:14:15'),
(6, 6, 'create', 0, '2017-05-29 07:14:15');

-- --------------------------------------------------------

--
-- Structure de la table `mg_dataflow_session`
--
...
--
-- Structure de la table `mg_design_change`
--
...
--
-- Structure de la table `mg_directory_country`
--
...
--
-- Contenu de la table `mg_directory_country`
--
...
--
-- Structure de la table `mg_directory_country_format`
--
...
--
-- Structure de la table `mg_directory_country_region`
--
...
--
-- Contenu de la table `mg_directory_country_region`
--
...
--
-- Structure de la table `mg_directory_country_region_name`
--
...
--
-- Contenu de la table `mg_directory_country_region_name`
--
...
--
-- Structure de la table `mg_directory_currency_rate`
--
...
--
-- Contenu de la table `mg_directory_currency_rate`
--
...
--
-- Structure de la table `mg_downloadable_link`
--
...
--
-- Structure de la table `mg_downloadable_link_price`
--
...
--
-- Structure de la table `mg_downloadable_link_purchased`
--
...
--
-- Structure de la table `mg_downloadable_link_purchased_item`
--
...
--
-- Structure de la table `mg_downloadable_link_title`
--
...
--
-- Structure de la table `mg_downloadable_sample`
--
...
--
-- Structure de la table `mg_downloadable_sample_title`
--
...
--
-- Structure de la table `mg_eav_attribute`
--
...
--
-- Contenu de la table `mg_eav_attribute`
--
...
--
-- Structure de la table `mg_eav_attribute_group`
--
...
--
-- Contenu de la table `mg_eav_attribute_group`
--
...
--
-- Structure de la table `mg_eav_attribute_label`
--
...
--
-- Structure de la table `mg_eav_attribute_option`
--
...
--
-- Contenu de la table `mg_eav_attribute_option`
--
...
--
-- Structure de la table `mg_eav_attribute_option_value`
--
...
--
-- Contenu de la table `mg_eav_attribute_option_value`
--
...
--
-- Structure de la table `mg_eav_attribute_set`
--
...
--
-- Contenu de la table `mg_eav_attribute_set`
--
...
--
-- Structure de la table `mg_eav_entity`
--
...
--
-- Structure de la table `mg_eav_entity_attribute`
--
...
--
-- Contenu de la table `mg_eav_entity_attribute`
--
...
--
-- Structure de la table `mg_eav_entity_datetime`
--
...
--
-- Structure de la table `mg_eav_entity_decimal`
--
...
--
-- Structure de la table `mg_eav_entity_int`
--
...
--
-- Structure de la table `mg_eav_entity_store`
--
...
--
-- Contenu de la table `mg_eav_entity_store`
--

INSERT INTO `mg_eav_entity_store` (`entity_store_id`, `entity_type_id`, `store_id`, `increment_prefix`, `increment_last_id`) VALUES
(1, 5, 1, '1', '100000002');

-- --------------------------------------------------------

--
-- Structure de la table `mg_eav_entity_text`
--
...
--
-- Structure de la table `mg_eav_entity_type`
--
...
--
-- Contenu de la table `mg_eav_entity_type`
--
...
--
-- Structure de la table `mg_eav_entity_varchar`
--
...
--
-- Structure de la table `mg_eav_form_element`
--
...
--
-- Contenu de la table `mg_eav_form_element`
--
...
--
-- Structure de la table `mg_eav_form_fieldset`
--
...
--
-- Contenu de la table `mg_eav_form_fieldset`
--
...
--
-- Structure de la table `mg_eav_form_fieldset_label`
--
...
--
-- Contenu de la table `mg_eav_form_fieldset_label`
--
...
--
-- Structure de la table `mg_eav_form_type`
--
...
--
-- Contenu de la table `mg_eav_form_type`
--
...
--
-- Structure de la table `mg_eav_form_type_entity`
--
...
--
-- Contenu de la table `mg_eav_form_type_entity`
--
...
--
-- Structure de la table `mg_gift_message`
--
...
--
-- Structure de la table `mg_importexport_importdata`
--
...
--
-- Structure de la table `mg_index_event`
--
...
--
-- Contenu de la table `mg_index_event`
--

INSERT INTO `mg_index_event` (`event_id`, `type`, `entity`, `entity_pk`, `created_at`, `old_data`, `new_data`) VALUES
(1, 'save', 'catalog_category', 1, '2017-05-29 07:14:18', NULL, 'a:5:{s:35:"cataloginventory_stock_match_result";b:0;s:34:"catalog_product_price_match_result";b:0;s:24:"catalog_url_match_result";b:1;s:37:"catalog_category_product_match_result";b:1;s:35:"catalogsearch_fulltext_match_result";b:1;}'),
(2, 'save', 'catalog_category', 2, '2017-05-29 07:14:18', NULL, 'a:5:{s:35:"cataloginventory_stock_match_result";b:0;s:34:"catalog_product_price_match_result";b:0;s:24:"catalog_url_match_result";b:1;s:37:"catalog_category_product_match_result";b:1;s:35:"catalogsearch_fulltext_match_result";b:1;}'),
(3, 'save', 'cataloginventory_stock_item', 1, '2017-05-30 12:29:01', NULL, 'a:5:{s:35:"cataloginventory_stock_match_result";b:1;s:34:"catalog_product_price_match_result";b:0;s:24:"catalog_url_match_result";b:0;s:37:"catalog_category_product_match_result";b:0;s:35:"catalogsearch_fulltext_match_result";b:0;}'),
(4, 'catalog_reindex_price', 'catalog_product', 1, '2017-05-30 12:29:01', NULL, 'a:5:{s:35:"cataloginventory_stock_match_result";b:0;s:34:"catalog_product_price_match_result";b:1;s:24:"catalog_url_match_result";b:0;s:37:"catalog_category_product_match_result";b:0;s:35:"catalogsearch_fulltext_match_result";b:0;}'),
(5, 'save', 'catalog_product', 1, '2017-05-30 12:29:01', NULL, 'a:5:{s:35:"cataloginventory_stock_match_result";b:1;s:34:"catalog_product_price_match_result";b:1;s:24:"catalog_url_match_result";b:1;s:37:"catalog_category_product_match_result";b:1;s:35:"catalogsearch_fulltext_match_result";b:1;}'),
(6, 'save', 'catalog_category', 3, '2017-05-30 12:30:17', NULL, 'a:5:{s:35:"cataloginventory_stock_match_result";b:0;s:34:"catalog_product_price_match_result";b:0;s:24:"catalog_url_match_result";b:1;s:37:"catalog_category_product_match_result";b:1;s:35:"catalogsearch_fulltext_match_result";b:1;}');

-- --------------------------------------------------------

--
-- Structure de la table `mg_index_process`
--
...
--
-- Contenu de la table `mg_index_process`
--

INSERT INTO `mg_index_process` (`process_id`, `indexer_code`, `status`, `started_at`, `ended_at`, `mode`) VALUES
(1, 'catalog_product_attribute', 'require_reindex', '2017-05-30 12:35:29', '2017-05-30 12:35:29', 'real_time'),
(2, 'catalog_product_price', 'require_reindex', '2017-05-30 12:35:29', '2017-05-30 12:35:29', 'real_time'),
(3, 'catalog_url', 'require_reindex', '2017-05-30 12:35:48', '2017-05-30 12:35:48', 'real_time'),
(4, 'catalog_product_flat', 'require_reindex', NULL, NULL, 'real_time'),
(5, 'catalog_category_flat', 'require_reindex', NULL, NULL, 'real_time'),
(6, 'catalog_category_product', 'require_reindex', '2017-05-30 12:35:48', '2017-05-30 12:35:48', 'real_time'),
(7, 'catalogsearch_fulltext', 'require_reindex', '2017-05-30 12:35:48', '2017-05-30 12:35:48', 'real_time'),
(8, 'cataloginventory_stock', 'require_reindex', '2017-05-30 12:35:29', '2017-05-30 12:35:29', 'real_time'),
(9, 'tag_summary', 'require_reindex', '2017-05-30 12:35:29', '2017-05-30 12:35:29', 'real_time');

-- --------------------------------------------------------

--
-- Structure de la table `mg_index_process_event`
--
...
--
-- Structure de la table `mg_learning_slider_slide`
--

CREATE TABLE `mg_learning_slider_slide` (
  `entity_id` int(10) unsigned NOT NULL COMMENT 'Entity_id',
  `name` varchar(255) DEFAULT NULL COMMENT 'Name',
  `image_url` varchar(255) DEFAULT NULL COMMENT 'Image_url',
  `is_active` tinyint(1) DEFAULT NULL COMMENT 'Is_active',
  `position` int(11) DEFAULT NULL COMMENT 'Position'
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='mg_learning_slider_slide';

--
-- Contenu de la table `mg_learning_slider_slide`
--

INSERT INTO `mg_learning_slider_slide` (`entity_id`, `name`, `image_url`, `is_active`, `position`) VALUES
(1, 'name', 'img.png', 1, 12),
(2, 'name1', 'img.png', 1, 34),
(3, 'name1', 'Screen Shot 2017-05-30 at 10.51.09.png', 1, 45);

-- --------------------------------------------------------

--
-- Structure de la table `mg_log_customer`
--
...
--
-- Structure de la table `mg_log_quote`
--
...
--
-- Contenu de la table `mg_log_quote`
--

INSERT INTO `mg_log_quote` (`quote_id`, `visitor_id`, `created_at`, `deleted_at`) VALUES
(2, 6, '2017-05-30 12:39:55', NULL);

-- --------------------------------------------------------

--
-- Structure de la table `mg_log_summary`
--
...
--
-- Structure de la table `mg_log_summary_type`
--
...
--
-- Contenu de la table `mg_log_summary_type`
--
...
--
-- Structure de la table `mg_log_url`
--
...
--
-- Structure de la table `mg_log_url_info`
--
...
--
-- Structure de la table `mg_log_visitor`
--
...
--
-- Contenu de la table `mg_log_visitor`
--

INSERT INTO `mg_log_visitor` (`visitor_id`, `session_id`, `first_visit_at`, `last_visit_at`, `last_url_id`, `store_id`) VALUES
(1, '507446ed9d34a16d291f74fec064661b', '2017-05-29 07:15:47', '2017-05-29 08:10:07', 0, 1),
(2, 'ac0712029f9237957153adbce22d459a', '2017-05-29 10:13:17', '2017-05-29 11:23:47', 0, 1),
(3, '838af9c7e51cee9dba5d82bb73d0c1d8', '2017-05-29 13:03:44', '2017-05-29 13:04:05', 0, 1),
(4, '1bb8da04b02a65ea959a13e028b443a9', '2017-05-30 06:15:14', '2017-05-30 06:15:14', 0, 1),
(5, 'a806420effedba3a76d4dcfe79966472', '2017-05-30 08:19:12', '2017-05-30 08:34:01', 0, 1),
(6, '65b9594a73d78384959a09e0b5aefe2a', '2017-05-30 12:16:22', '2017-05-30 14:07:16', 0, 1);

-- --------------------------------------------------------

--
-- Structure de la table `mg_log_visitor_info`
--
...
--
-- Contenu de la table `mg_log_visitor_info`
--
...
(1, 'http://localhost/magento/index.php/install/wizard/end/', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/58.0.3029.110 Safari/537.36', NULL, 'fr,es;q=0.8,en;q=0.6,de;q=0.4', 0x7f000001, 0x7f000001),
(2, NULL, 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/58.0.3029.110 Safari/537.36', NULL, 'fr,es;q=0.8,en;q=0.6,de;q=0.4', 0x7f000001, 0x7f000001),
(3, 'http://magento.dev/index.php/admin/dashboard/index/key/b632b34b30d9610eb3e82e1590f213bb/', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/58.0.3029.110 Safari/537.36', NULL, 'fr,es;q=0.8,en;q=0.6,de;q=0.4', 0x7f000001, 0x7f000001),
(4, NULL, 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/58.0.3029.110 Safari/537.36', NULL, 'fr,es;q=0.8,en;q=0.6,de;q=0.4', 0x7f000001, 0x7f000001),
(5, NULL, 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/58.0.3029.110 Safari/537.36', NULL, 'fr,es;q=0.8,en;q=0.6,de;q=0.4', 0x7f000001, 0x7f000001),
(6, NULL, 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_12_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/58.0.3029.110 Safari/537.36', NULL, 'fr-FR,fr;q=0.8,en-US;q=0.6,en;q=0.4', 0x7f000001, 0x7f000001);

-- --------------------------------------------------------

--
-- Structure de la table `mg_log_visitor_online`
--
...
--
-- Structure de la table `mg_newsletter_problem`
--
...
--
-- Structure de la table `mg_newsletter_queue`
--
...
--
-- Structure de la table `mg_newsletter_queue_link`
--
...
--
-- Structure de la table `mg_newsletter_queue_store_link`
--
...
--
-- Structure de la table `mg_newsletter_subscriber`
--
...
--
-- Structure de la table `mg_newsletter_template`
--
...
--
-- Contenu de la table `mg_newsletter_template`
--
...
--
-- Structure de la table `mg_oauth_nonce`
--
...
--
-- Structure de la table `mg_oauth_token`
--
...
--
-- Structure de la table `mg_paypal_cert`
--
...
--
-- Structure de la table `mg_paypal_payment_transaction`
--
...
--
-- Structure de la table `mg_paypal_settlement_report`
--
...
--
-- Structure de la table `mg_paypal_settlement_report_row`
--
...
--
-- Structure de la table `mg_permission_block`
--

CREATE TABLE `mg_permission_block` (
...
--
-- Contenu de la table `mg_permission_block`
--
...
--
-- Structure de la table `mg_permission_variable`
--

CREATE TABLE `mg_permission_variable` (
  `variable_id` int(10) unsigned NOT NULL COMMENT 'Variable ID',
...
--
-- Contenu de la table `mg_permission_variable`
--
...
--
-- Structure de la table `mg_persistent_session`
--
...
--
-- Contenu de la table `mg_poll`
--

INSERT INTO `mg_poll` (`poll_id`, `poll_title`, `votes_count`, `store_id`, `date_posted`, `date_closed`, `active`, `closed`, `answers_display`) VALUES
(1, 'What is your favorite color', 8, 0, '2017-05-29 07:14:18', NULL, 1, 0, NULL);

-- --------------------------------------------------------

--
-- Structure de la table `mg_poll_answer`
--
...
--
-- Contenu de la table `mg_poll_answer`
--
...
--
-- Structure de la table `mg_poll_store`
--
...
--
-- Contenu de la table `mg_poll_store`
--
...
--
-- Structure de la table `mg_poll_vote`
--
...
--
-- Contenu de la table `mg_poll_vote`
--

INSERT INTO `mg_poll_vote` (`vote_id`, `poll_id`, `poll_answer_id`, `ip_address`, `customer_id`, `vote_time`) VALUES
(1, 1, 2, 0x7f000001, NULL, '2017-05-30 12:34:03');

-- --------------------------------------------------------

--
-- Structure de la table `mg_product_alert_price`
--
...
--
-- Structure de la table `mg_product_alert_stock`
--
...
--
-- Structure de la table `mg_rating`
--
...
--
-- Structure de la table `mg_rating_entity`
--
...
--
-- Contenu de la table `mg_rating_entity`
--
...
--
-- Structure de la table `mg_rating_option`
--
...
--
-- Contenu de la table `mg_rating_option`
--
...
--
-- Structure de la table `mg_rating_option_vote`
--
...
--
-- Structure de la table `mg_rating_option_vote_aggregated`
--
...
--
-- Structure de la table `mg_rating_store`
--
...
--
-- Structure de la table `mg_rating_title`
--
...
--
-- Structure de la table `mg_report_compared_product_index`
--
...
--
-- Structure de la table `mg_report_event`
--
...
--
-- Contenu de la table `mg_report_event`
--

INSERT INTO `mg_report_event` (`event_id`, `logged_at`, `event_type_id`, `object_id`, `subject_id`, `subtype`, `store_id`) VALUES
(1, '2017-05-30 12:36:01', 4, 1, 6, 1, 1),
(2, '2017-05-30 12:39:55', 4, 1, 6, 1, 1);

-- --------------------------------------------------------

--
-- Structure de la table `mg_report_event_types`
--
...
--
-- Contenu de la table `mg_report_event_types`
--
...
--
-- Structure de la table `mg_report_viewed_product_aggregated_daily`
--
...
--
-- Structure de la table `mg_report_viewed_product_aggregated_monthly`
--
...
--
-- Structure de la table `mg_report_viewed_product_aggregated_yearly`
--
...
--
-- Structure de la table `mg_report_viewed_product_index`
--
...
--
-- Structure de la table `mg_review`
--
...
--
-- Structure de la table `mg_review_detail`
--
...
--
-- Structure de la table `mg_review_entity`
--
...
--
-- Contenu de la table `mg_review_entity`
--
...
--
-- Structure de la table `mg_review_entity_summary`
--
...
--
-- Structure de la table `mg_review_status`
--
...
--
-- Contenu de la table `mg_review_status`
--
...
--
-- Structure de la table `mg_review_store`
--
...
--
-- Structure de la table `mg_salesrule`
--
...
--
-- Structure de la table `mg_salesrule_coupon`
--
...
--
-- Structure de la table `mg_salesrule_coupon_usage`
--
...
--
-- Structure de la table `mg_salesrule_customer`
--
...
--
-- Structure de la table `mg_salesrule_customer_group`
--
...
--
-- Structure de la table `mg_salesrule_label`
--
...
--
-- Structure de la table `mg_salesrule_product_attribute`
--
...
--
-- Structure de la table `mg_salesrule_website`
--
...
--
-- Structure de la table `mg_sales_bestsellers_aggregated_daily`
--
...
--
-- Structure de la table `mg_sales_bestsellers_aggregated_monthly`
--
...
--
-- Structure de la table `mg_sales_bestsellers_aggregated_yearly`
--
...
--
-- Structure de la table `mg_sales_billing_agreement`
--
...
--
-- Structure de la table `mg_sales_billing_agreement_order`
--
...
--
-- Structure de la table `mg_sales_flat_creditmemo`
--
...
--
-- Structure de la table `mg_sales_flat_creditmemo_comment`
--
...
--
-- Structure de la table `mg_sales_flat_creditmemo_grid`
--
...
--
-- Structure de la table `mg_sales_flat_creditmemo_item`
--
...
--
-- Structure de la table `mg_sales_flat_invoice`
--
...
--
-- Structure de la table `mg_sales_flat_invoice_comment`
--
...
--
-- Structure de la table `mg_sales_flat_invoice_grid`
--
...
--
-- Structure de la table `mg_sales_flat_invoice_item`
--
...
--
-- Structure de la table `mg_sales_flat_order`
--
...
--
-- Contenu de la table `mg_sales_flat_order`
--

INSERT INTO `mg_sales_flat_order` (`entity_id`, `state`, `status`, `coupon_code`, `protect_code`, `shipping_description`, `is_virtual`, `store_id`, `customer_id`, `base_discount_amount`, `base_discount_canceled`, `base_discount_invoiced`, `base_discount_refunded`, `base_grand_total`, `base_shipping_amount`, `base_shipping_canceled`, `base_shipping_invoiced`, `base_shipping_refunded`, `base_shipping_tax_amount`, `base_shipping_tax_refunded`, `base_subtotal`, `base_subtotal_canceled`, `base_subtotal_invoiced`, `base_subtotal_refunded`, `base_tax_amount`, `base_tax_canceled`, `base_tax_invoiced`, `base_tax_refunded`, `base_to_global_rate`, `base_to_order_rate`, `base_total_canceled`, `base_total_invoiced`, `base_total_invoiced_cost`, `base_total_offline_refunded`, `base_total_online_refunded`, `base_total_paid`, `base_total_qty_ordered`, `base_total_refunded`, `discount_amount`, `discount_canceled`, `discount_invoiced`, `discount_refunded`, `grand_total`, `shipping_amount`, `shipping_canceled`, `shipping_invoiced`, `shipping_refunded`, `shipping_tax_amount`, `shipping_tax_refunded`, `store_to_base_rate`, `store_to_order_rate`, `subtotal`, `subtotal_canceled`, `subtotal_invoiced`, `subtotal_refunded`, `tax_amount`, `tax_canceled`, `tax_invoiced`, `tax_refunded`, `total_canceled`, `total_invoiced`, `total_offline_refunded`, `total_online_refunded`, `total_paid`, `total_qty_ordered`, `total_refunded`, `can_ship_partially`, `can_ship_partially_item`, `customer_is_guest`, `customer_note_notify`, `billing_address_id`, `customer_group_id`, `edit_increment`, `email_sent`, `forced_shipment_with_invoice`, `payment_auth_expiration`, `quote_address_id`, `quote_id`, `shipping_address_id`, `adjustment_negative`, `adjustment_positive`, `base_adjustment_negative`, `base_adjustment_positive`, `base_shipping_discount_amount`, `base_subtotal_incl_tax`, `base_total_due`, `payment_authorization_amount`, `shipping_discount_amount`, `subtotal_incl_tax`, `total_due`, `weight`, `customer_dob`, `increment_id`, `applied_rule_ids`, `base_currency_code`, `customer_email`, `customer_firstname`, `customer_lastname`, `customer_middlename`, `customer_prefix`, `customer_suffix`, `customer_taxvat`, `discount_description`, `ext_customer_id`, `ext_order_id`, `global_currency_code`, `hold_before_state`, `hold_before_status`, `order_currency_code`, `original_increment_id`, `relation_child_id`, `relation_child_real_id`, `relation_parent_id`, `relation_parent_real_id`, `remote_ip`, `shipping_method`, `store_currency_code`, `store_name`, `x_forwarded_for`, `customer_note`, `created_at`, `updated_at`, `total_item_count`, `customer_gender`, `hidden_tax_amount`, `base_hidden_tax_amount`, `shipping_hidden_tax_amount`, `base_shipping_hidden_tax_amnt`, `hidden_tax_invoiced`, `base_hidden_tax_invoiced`, `hidden_tax_refunded`, `base_hidden_tax_refunded`, `shipping_incl_tax`, `base_shipping_incl_tax`, `coupon_rule_name`, `paypal_ipn_customer_notified`, `gift_message_id`) VALUES
(1, 'new', 'pending', NULL, '9b22be', 'Flat Rate - Fixed', 0, 1, NULL, '0.0000', NULL, NULL, NULL, '8.9000', '5.0000', NULL, NULL, NULL, '0.0000', NULL, '3.9000', NULL, NULL, NULL, '0.0000', NULL, NULL, NULL, '1.0000', '1.0000', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0.0000', NULL, NULL, NULL, '8.9000', '5.0000', NULL, NULL, NULL, '0.0000', NULL, '1.0000', '1.0000', '3.9000', NULL, NULL, NULL, '0.0000', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '1.0000', NULL, NULL, NULL, 1, 1, 1, 0, NULL, 1, NULL, NULL, NULL, 1, 2, NULL, NULL, NULL, NULL, '0.0000', '3.9000', NULL, NULL, '0.0000', '3.9000', NULL, '40.0000', NULL, '100000001', NULL, 'EUR', 'ghansumn@gmail.com', 'Nourdine', 'Ghansum', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'EUR', NULL, NULL, 'EUR', NULL, NULL, NULL, NULL, NULL, '127.0.0.1', 'flatrate_flatrate', 'EUR', 'Main Website\nMain Website Store\nDefault Store View', NULL, NULL, '2017-05-30 12:39:06', '2017-05-30 12:39:06', 1, NULL, '0.0000', '0.0000', '0.0000', '0.0000', NULL, NULL, NULL, NULL, '5.0000', '5.0000', NULL, 0, NULL);

-- --------------------------------------------------------

--
-- Structure de la table `mg_sales_flat_order_address`
--
...
--
-- Contenu de la table `mg_sales_flat_order_address`
--

INSERT INTO `mg_sales_flat_order_address` (`entity_id`, `parent_id`, `customer_address_id`, `quote_address_id`, `region_id`, `customer_id`, `fax`, `region`, `postcode`, `lastname`, `street`, `city`, `email`, `telephone`, `country_id`, `firstname`, `address_type`, `prefix`, `middlename`, `suffix`, `company`, `vat_id`, `vat_is_valid`, `vat_request_id`, `vat_request_date`, `vat_request_success`) VALUES
(1, 1, NULL, NULL, 274, NULL, '698338572', 'Hauts-de-Seine', '92000', 'Ghansum', 'Pablo Picasso\nPablo Picasso', 'Nanterre', 'ghansumn@gmail.com', '698338572', 'FR', 'Nourdine', 'billing', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(2, 1, NULL, NULL, 274, NULL, '698338572', 'Hauts-de-Seine', '92000', 'Ghansum', 'Pablo Picasso\nPablo Picasso', 'Nanterre', 'ghansumn@gmail.com', '698338572', 'FR', 'Nourdine', 'shipping', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);

-- --------------------------------------------------------

--
-- Structure de la table `mg_sales_flat_order_grid`
--
...
--
-- Contenu de la table `mg_sales_flat_order_grid`
--

INSERT INTO `mg_sales_flat_order_grid` (`entity_id`, `status`, `store_id`, `store_name`, `customer_id`, `base_grand_total`, `base_total_paid`, `grand_total`, `total_paid`, `increment_id`, `base_currency_code`, `order_currency_code`, `shipping_name`, `billing_name`, `created_at`, `updated_at`) VALUES
(1, 'pending', 1, 'Main Website\nMain Website Store\nDefault Store View', NULL, '8.9000', NULL, '8.9000', NULL, '100000001', 'EUR', 'EUR', 'Nourdine  Ghansum', 'Nourdine  Ghansum', '2017-05-30 12:39:06', '2017-05-30 12:39:06');

-- --------------------------------------------------------

--
-- Structure de la table `mg_sales_flat_order_item`
--
...
--
-- Contenu de la table `mg_sales_flat_order_status_history`
--

INSERT INTO `mg_sales_flat_order_status_history` (`entity_id`, `parent_id`, `is_customer_notified`, `is_visible_on_front`, `comment`, `status`, `created_at`, `entity_name`) VALUES
(1, 1, 1, 0, NULL, 'pending', '2017-05-30 12:39:06', 'order');

-- --------------------------------------------------------

--
-- Structure de la table `mg_sales_flat_quote`
--
...
--
-- Contenu de la table `mg_sales_flat_quote`
--
...
(1, 1, '2017-05-30 12:36:01', '2017-05-30 12:39:06', NULL, 0, 0, 0, 1, '1.0000', 0, '1.0000', '1.0000', 'EUR', 'EUR', 'EUR', '8.9000', '8.9000', 'guest', NULL, 3, 0, 'ghansumn@gmail.com', NULL, 'Nourdine', NULL, 'Ghansum', NULL, NULL, NULL, 1, 1, '127.0.0.1', NULL, '100000001', NULL, NULL, 'EUR', '1.0000', '1.0000', NULL, NULL, '3.9000', '3.9000', '3.9000', '3.9000', 1, 0, NULL, NULL, 0),
(2, 1, '2017-05-30 12:39:55', '2017-05-30 14:07:15', NULL, 1, 0, 0, 1, '1.0000', 0, '1.0000', '1.0000', 'EUR', 'EUR', 'EUR', '8.9000', '8.9000', NULL, NULL, 3, 0, 'ghansumn@gmail.com', NULL, 'Nourdine', NULL, 'Ghansum', NULL, NULL, NULL, 1, 0, '127.0.0.1', NULL, '100000002', 'wTkxUa8L4XI=', NULL, 'EUR', '1.0000', '1.0000', NULL, NULL, '3.9000', '3.9000', '3.9000', '3.9000', 1, 0, NULL, NULL, 0);

-- --------------------------------------------------------

--
-- Structure de la table `mg_sales_flat_quote_address`
--
...
--
-- Contenu de la table `mg_sales_flat_quote_address`
--
...
(1, 1, '2017-05-30 12:36:01', '2017-05-30 12:39:06', NULL, 1, NULL, 'billing', 'ghansumn@gmail.com', NULL, 'Nourdine', NULL, 'Ghansum', NULL, NULL, 'Pablo Picasso\nPablo Picasso', 'Nanterre', 'Hauts-de-Seine', 274, '92000', 'FR', '698338572', '698338572', 0, 0, 0, NULL, NULL, '0.0000', '0.0000', '0.0000', '0.0000', '0.0000', '0.0000', '0.0000', '0.0000', '0.0000', '0.0000', '0.0000', '0.0000', '0.0000', '0.0000', '0.0000', NULL, 'a:0:{}', NULL, NULL, NULL, '0.0000', NULL, NULL, NULL, NULL, NULL, '0.0000', '0.0000', NULL, NULL, NULL, NULL, NULL, NULL),
(2, 1, '2017-05-30 12:36:01', '2017-05-30 12:39:06', NULL, 0, NULL, 'shipping', 'ghansumn@gmail.com', NULL, 'Nourdine', NULL, 'Ghansum', NULL, NULL, 'Pablo Picasso\nPablo Picasso', 'Nanterre', 'Hauts-de-Seine', 274, '92000', 'FR', '698338572', '698338572', 1, 0, 0, 'flatrate_flatrate', 'Flat Rate - Fixed', '40.0000', '3.9000', '3.9000', '0.0000', '0.0000', '0.0000', '0.0000', '5.0000', '5.0000', '0.0000', '0.0000', '0.0000', '0.0000', '8.9000', '8.9000', NULL, 'a:0:{}', NULL, '0.0000', '0.0000', '3.9000', NULL, '0.0000', '0.0000', '0.0000', NULL, '5.0000', '5.0000', NULL, NULL, NULL, NULL, NULL, NULL),
(3, 2, '2017-05-30 12:39:55', '2017-05-30 14:07:15', NULL, 1, NULL, 'billing', 'ghansumn@gmail.com', NULL, 'Nourdine', NULL, 'Ghansum', NULL, NULL, 'Pablo Picasso\nPablo Picasso', 'Nanterre', 'Alpes-Maritimes', 187, '92000', 'FR', '698338572', '698338572', 0, 0, 0, NULL, NULL, '0.0000', '0.0000', '0.0000', '0.0000', '0.0000', '0.0000', '0.0000', '0.0000', '0.0000', '0.0000', '0.0000', '0.0000', '0.0000', '0.0000', '0.0000', NULL, 'a:0:{}', NULL, NULL, NULL, '0.0000', NULL, NULL, NULL, NULL, NULL, '0.0000', '0.0000', NULL, NULL, NULL, NULL, NULL, NULL),
(4, 2, '2017-05-30 12:39:55', '2017-05-30 14:07:15', NULL, 0, NULL, 'shipping', 'ghansumn@gmail.com', NULL, 'Nourdine', NULL, 'Ghansum', NULL, NULL, 'Pablo Picasso\nPablo Picasso', 'Nanterre', 'Alpes-Maritimes', 187, '92000', 'FR', '698338572', '698338572', 1, 0, 0, 'flatrate_flatrate', 'Flat Rate - Fixed', '40.0000', '3.9000', '3.9000', '0.0000', '0.0000', '0.0000', '0.0000', '5.0000', '5.0000', '0.0000', '0.0000', '0.0000', '0.0000', '8.9000', '8.9000', NULL, 'a:0:{}', NULL, '0.0000', '0.0000', '3.9000', NULL, '0.0000', '0.0000', '0.0000', NULL, '5.0000', '5.0000', NULL, NULL, NULL, NULL, NULL, NULL);

-- --------------------------------------------------------

--
-- Structure de la table `mg_sales_flat_quote_address_item`
--
...
--
-- Structure de la table `mg_sales_flat_quote_item`
--
...
--
-- Contenu de la table `mg_sales_flat_quote_item`
--
...
(1, 1, '2017-05-30 12:36:01', '2017-05-30 12:36:01', 1, 1, NULL, 0, 'sku', 'Chocolat', NULL, NULL, NULL, 0, 0, 0, '40.0000', '1.0000', '3.9000', '3.9000', NULL, '0.0000', '0.0000', '0.0000', '0.0000', '0.0000', '0.0000', '3.9000', '3.9000', '0.0000', '40.0000', 'simple', NULL, NULL, NULL, NULL, NULL, '3.9000', '3.9000', '3.9000', '3.9000', '0.0000', '0.0000', NULL, '0.0000', '0.0000', '0.0000', '0.0000', 'a:0:{}', '0.0000', '0.0000', '0.0000', NULL),
(2, 2, '2017-05-30 12:39:55', '2017-05-30 12:39:55', 1, 1, NULL, 0, 'sku', 'Chocolat', NULL, NULL, NULL, 0, 0, 0, '40.0000', '1.0000', '3.9000', '3.9000', NULL, '0.0000', '0.0000', '0.0000', '0.0000', '0.0000', '0.0000', '3.9000', '3.9000', '0.0000', '40.0000', 'simple', NULL, NULL, NULL, NULL, NULL, '3.9000', '3.9000', '3.9000', '3.9000', '0.0000', '0.0000', NULL, '0.0000', '0.0000', '0.0000', '0.0000', 'a:0:{}', '0.0000', '0.0000', '0.0000', NULL);

-- --------------------------------------------------------

--
-- Structure de la table `mg_sales_flat_quote_item_option`
--
...
--
-- Contenu de la table `mg_sales_flat_quote_item_option`
--

INSERT INTO `mg_sales_flat_quote_item_option` (`option_id`, `item_id`, `product_id`, `code`, `value`) VALUES
(1, 1, 1, 'info_buyRequest', 'a:4:{s:4:"uenc";s:56:"aHR0cDovL21hZ2VudG8uZGV2L2luZGV4LnBocC9jYXR0ZXN0Lmh0bWw,";s:7:"product";s:1:"1";s:8:"form_key";s:16:"koRtoMMft8xtxEwu";s:3:"qty";d:1;}'),
(2, 2, 1, 'info_buyRequest', 'a:4:{s:4:"uenc";s:56:"aHR0cDovL21hZ2VudG8uZGV2L2luZGV4LnBocC9jYXR0ZXN0Lmh0bWw,";s:7:"product";s:1:"1";s:8:"form_key";s:16:"koRtoMMft8xtxEwu";s:3:"qty";d:1;}');

-- --------------------------------------------------------

--
-- Structure de la table `mg_sales_flat_quote_payment`
--
...
--
-- Contenu de la table `mg_sales_flat_quote_payment`
--
...
(1, 1, '2017-05-30 12:36:14', '2017-05-30 12:39:06', 'checkmo', NULL, NULL, NULL, NULL, NULL, 0, 0, NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(2, 2, '2017-05-30 12:40:01', '2017-05-30 14:07:14', 'paypal_express', NULL, NULL, NULL, NULL, NULL, 0, 0, NULL, 0, 0, NULL, NULL, NULL, 'a:2:{s:42:"paypal_express_checkout_shipping_overriden";i:1;s:19:"paypal_ec_create_ba";N;}', NULL, NULL, NULL);

-- --------------------------------------------------------

--
-- Structure de la table `mg_sales_flat_quote_shipping_rate`
--
...
) ENGINE=InnoDB AUTO_INCREMENT=47 DEFAULT CHARSET=utf8 COMMENT='Sales Flat Quote Shipping Rate';

--
-- Contenu de la table `mg_sales_flat_quote_shipping_rate`
--

INSERT INTO `mg_sales_flat_quote_shipping_rate` (`rate_id`, `address_id`, `created_at`, `updated_at`, `carrier`, `carrier_title`, `code`, `method`, `method_description`, `price`, `error_message`, `method_title`) VALUES
(3, 2, '2017-05-30 12:38:58', '2017-05-30 12:39:06', 'flatrate', 'Flat Rate', 'flatrate_flatrate', 'flatrate', NULL, '5.0000', NULL, 'Fixed'),
(46, 4, '2017-05-30 14:07:15', '2017-05-30 14:07:15', 'flatrate', 'Flat Rate', 'flatrate_flatrate', 'flatrate', NULL, '5.0000', NULL, 'Fixed');

-- --------------------------------------------------------

--
-- Structure de la table `mg_sales_flat_shipment`
--
...
--
-- Structure de la table `mg_sales_flat_shipment_comment`
--
...
--
-- Structure de la table `mg_sales_flat_shipment_grid`
--
...
--
-- Structure de la table `mg_sales_flat_shipment_item`
--
...
--
-- Structure de la table `mg_sales_flat_shipment_track`
--
...
--
-- Structure de la table `mg_sales_invoiced_aggregated`
--
...
--
-- Structure de la table `mg_sales_invoiced_aggregated_order`
--
...
--
-- Structure de la table `mg_sales_order_aggregated_created`
--
...
--
-- Structure de la table `mg_sales_order_aggregated_updated`
--
...
--
-- Structure de la table `mg_sales_order_status`
--
...
--
-- Contenu de la table `mg_sales_order_status`
--
...
--
-- Structure de la table `mg_sales_order_status_label`
--
...
--
-- Structure de la table `mg_sales_order_status_state`
--
...
--
-- Contenu de la table `mg_sales_order_status_state`
--
...
--
-- Structure de la table `mg_sales_order_tax`
--
...
--
-- Structure de la table `mg_sales_order_tax_item`
--
...
--
-- Structure de la table `mg_sales_payment_transaction`
--
...
--
-- Structure de la table `mg_sales_recurring_profile`
--
...
--
-- Structure de la table `mg_sales_recurring_profile_order`
--
...
--
-- Structure de la table `mg_sales_refunded_aggregated`
--
...
--
-- Structure de la table `mg_sales_refunded_aggregated_order`
--
...
--
-- Structure de la table `mg_sales_shipping_aggregated`
--
...
--
-- Structure de la table `mg_sales_shipping_aggregated_order`
--
...
--
-- Structure de la table `mg_sendfriend_log`
--
...
--
-- Structure de la table `mg_shipping_tablerate`
--
...
--
-- Structure de la table `mg_sitemap`
--
...
--
-- Structure de la table `mg_tag_properties`
--
...
--
-- Structure de la table `mg_tag_relation`
--
...
--
-- Structure de la table `mg_tag_summary`
--
...
--
-- Structure de la table `mg_tax_calculation`
--
...
--
-- Contenu de la table `mg_tax_calculation`
--
...
--
-- Structure de la table `mg_tax_calculation_rate`
--
...
--
-- Contenu de la table `mg_tax_calculation_rate`
--
...
--
-- Structure de la table `mg_tax_calculation_rate_title`
--
...
--
-- Structure de la table `mg_tax_calculation_rule`
--
...
--
-- Contenu de la table `mg_tax_calculation_rule`
--
...
--
-- Structure de la table `mg_tax_class`
--
...
--
-- Contenu de la table `mg_tax_class`
--
...
--
-- Structure de la table `mg_tax_order_aggregated_created`
--
...
--
-- Structure de la table `mg_tax_order_aggregated_updated`
--
...
--
-- Structure de la table `mg_weee_discount`
--
...
--
-- Structure de la table `mg_weee_tax`
--
...
--
-- Structure de la table `mg_widget`
--
...
--
-- Structure de la table `mg_widget_instance`
--
...
--
-- Structure de la table `mg_widget_instance_page`
--
...
--
-- Structure de la table `mg_widget_instance_page_layout`
--
...
--
-- Structure de la table `mg_wishlist`
--
...
--
-- Structure de la table `mg_wishlist_item`
--
...
--
-- Structure de la table `mg_wishlist_item_option`
--
...
--
-- Index pour la table `mg_adminnotification_inbox`
--
ALTER TABLE `mg_adminnotification_inbox`
  ADD PRIMARY KEY (`notification_id`),
  ADD KEY `IDX_MG_ADMINNOTIFICATION_INBOX_SEVERITY` (`severity`),
  ADD KEY `IDX_MG_ADMINNOTIFICATION_INBOX_IS_READ` (`is_read`),
  ADD KEY `IDX_MG_ADMINNOTIFICATION_INBOX_IS_REMOVE` (`is_remove`);

--
-- Index pour la table `mg_admin_assert`
--
ALTER TABLE `mg_admin_assert`
  ADD PRIMARY KEY (`assert_id`);

--
-- Index pour la table `mg_admin_role`
--
ALTER TABLE `mg_admin_role`
  ADD PRIMARY KEY (`role_id`),
  ADD KEY `IDX_MG_ADMIN_ROLE_PARENT_ID_SORT_ORDER` (`parent_id`,`sort_order`),
  ADD KEY `IDX_MG_ADMIN_ROLE_TREE_LEVEL` (`tree_level`);

--
-- Index pour la table `mg_admin_rule`
--
ALTER TABLE `mg_admin_rule`
  ADD PRIMARY KEY (`rule_id`),
  ADD KEY `IDX_MG_ADMIN_RULE_RESOURCE_ID_ROLE_ID` (`resource_id`,`role_id`),
  ADD KEY `IDX_MG_ADMIN_RULE_ROLE_ID_RESOURCE_ID` (`role_id`,`resource_id`);

--
-- Index pour la table `mg_admin_user`
--
ALTER TABLE `mg_admin_user`
  ADD PRIMARY KEY (`user_id`),
  ADD UNIQUE KEY `UNQ_MG_ADMIN_USER_USERNAME` (`username`);

--
-- Index pour la table `mg_api2_acl_attribute`
--
ALTER TABLE `mg_api2_acl_attribute`
  ADD PRIMARY KEY (`entity_id`),
  ADD UNIQUE KEY `UNQ_MG_MG_API2_ACL_ATTRIBUTE_USER_TYPE_RESOURCE_ID_OPERATION` (`user_type`,`resource_id`,`operation`),
  ADD KEY `IDX_MG_API2_ACL_ATTRIBUTE_USER_TYPE` (`user_type`);

--
-- Index pour la table `mg_api2_acl_role`
--
ALTER TABLE `mg_api2_acl_role`
  ADD PRIMARY KEY (`entity_id`),
  ADD KEY `IDX_MG_API2_ACL_ROLE_CREATED_AT` (`created_at`),
  ADD KEY `IDX_MG_API2_ACL_ROLE_UPDATED_AT` (`updated_at`);

--
-- Index pour la table `mg_api2_acl_rule`
--
ALTER TABLE `mg_api2_acl_rule`
  ADD PRIMARY KEY (`entity_id`),
  ADD UNIQUE KEY `UNQ_MG_MG_API2_ACL_RULE_ROLE_ID_RESOURCE_ID_PRIVILEGE` (`role_id`,`resource_id`,`privilege`);

--
-- Index pour la table `mg_api2_acl_user`
--
ALTER TABLE `mg_api2_acl_user`
  ADD UNIQUE KEY `UNQ_MG_MG_API2_ACL_USER_ADMIN_ID` (`admin_id`),
  ADD KEY `FK_MG_API2_ACL_USER_ROLE_ID_MG_API2_ACL_ROLE_ENTITY_ID` (`role_id`);

--
-- Index pour la table `mg_api_assert`
--
ALTER TABLE `mg_api_assert`
  ADD PRIMARY KEY (`assert_id`);

--
-- Index pour la table `mg_api_role`
--
ALTER TABLE `mg_api_role`
  ADD PRIMARY KEY (`role_id`),
  ADD KEY `IDX_MG_API_ROLE_PARENT_ID_SORT_ORDER` (`parent_id`,`sort_order`),
  ADD KEY `IDX_MG_API_ROLE_TREE_LEVEL` (`tree_level`);

--
-- Index pour la table `mg_api_rule`
--
ALTER TABLE `mg_api_rule`
  ADD PRIMARY KEY (`rule_id`),
  ADD KEY `IDX_MG_API_RULE_RESOURCE_ID_ROLE_ID` (`resource_id`,`role_id`),
  ADD KEY `IDX_MG_API_RULE_ROLE_ID_RESOURCE_ID` (`role_id`,`resource_id`);

--
-- Index pour la table `mg_api_session`
--
ALTER TABLE `mg_api_session`
  ADD KEY `IDX_MG_API_SESSION_USER_ID` (`user_id`),
  ADD KEY `IDX_MG_API_SESSION_SESSID` (`sessid`);

--
-- Index pour la table `mg_api_user`
--
ALTER TABLE `mg_api_user`
  ADD PRIMARY KEY (`user_id`);

--
-- Index pour la table `mg_captcha_log`
--
ALTER TABLE `mg_captcha_log`
  ADD PRIMARY KEY (`type`,`value`);

--
-- Index pour la table `mg_cataloginventory_stock`
--
ALTER TABLE `mg_cataloginventory_stock`
  ADD PRIMARY KEY (`stock_id`);

--
-- Index pour la table `mg_cataloginventory_stock_item`
--
ALTER TABLE `mg_cataloginventory_stock_item`
  ADD PRIMARY KEY (`item_id`),
  ADD UNIQUE KEY `UNQ_MG_CATALOGINVENTORY_STOCK_ITEM_PRODUCT_ID_STOCK_ID` (`product_id`,`stock_id`),
  ADD KEY `IDX_MG_CATALOGINVENTORY_STOCK_ITEM_PRODUCT_ID` (`product_id`),
  ADD KEY `IDX_MG_CATALOGINVENTORY_STOCK_ITEM_STOCK_ID` (`stock_id`);

--
-- Index pour la table `mg_cataloginventory_stock_status`
--
ALTER TABLE `mg_cataloginventory_stock_status`
  ADD PRIMARY KEY (`product_id`,`website_id`,`stock_id`),
  ADD KEY `IDX_MG_CATALOGINVENTORY_STOCK_STATUS_STOCK_ID` (`stock_id`),
  ADD KEY `IDX_MG_CATALOGINVENTORY_STOCK_STATUS_WEBSITE_ID` (`website_id`);

--
-- Index pour la table `mg_cataloginventory_stock_status_idx`
--
ALTER TABLE `mg_cataloginventory_stock_status_idx`
  ADD PRIMARY KEY (`product_id`,`website_id`,`stock_id`),
  ADD KEY `IDX_MG_CATALOGINVENTORY_STOCK_STATUS_IDX_STOCK_ID` (`stock_id`),
  ADD KEY `IDX_MG_CATALOGINVENTORY_STOCK_STATUS_IDX_WEBSITE_ID` (`website_id`);

--
-- Index pour la table `mg_cataloginventory_stock_status_tmp`
--
ALTER TABLE `mg_cataloginventory_stock_status_tmp`
  ADD PRIMARY KEY (`product_id`,`website_id`,`stock_id`),
  ADD KEY `IDX_MG_CATALOGINVENTORY_STOCK_STATUS_TMP_STOCK_ID` (`stock_id`),
  ADD KEY `IDX_MG_CATALOGINVENTORY_STOCK_STATUS_TMP_WEBSITE_ID` (`website_id`);

--
-- Index pour la table `mg_catalogrule`
--
ALTER TABLE `mg_catalogrule`
  ADD PRIMARY KEY (`rule_id`),
  ADD KEY `IDX_MG_CATALOGRULE_IS_ACTIVE_SORT_ORDER_TO_DATE_FROM_DATE` (`is_active`,`sort_order`,`to_date`,`from_date`);

--
-- Index pour la table `mg_catalogrule_affected_product`
--
ALTER TABLE `mg_catalogrule_affected_product`
  ADD PRIMARY KEY (`product_id`);

--
-- Index pour la table `mg_catalogrule_customer_group`
--
ALTER TABLE `mg_catalogrule_customer_group`
  ADD PRIMARY KEY (`rule_id`,`customer_group_id`),
  ADD KEY `IDX_MG_CATALOGRULE_CUSTOMER_GROUP_RULE_ID` (`rule_id`),
  ADD KEY `IDX_MG_CATALOGRULE_CUSTOMER_GROUP_CUSTOMER_GROUP_ID` (`customer_group_id`);

--
-- Index pour la table `mg_catalogrule_group_website`
--
ALTER TABLE `mg_catalogrule_group_website`
  ADD PRIMARY KEY (`rule_id`,`customer_group_id`,`website_id`),
  ADD KEY `IDX_MG_CATALOGRULE_GROUP_WEBSITE_RULE_ID` (`rule_id`),
  ADD KEY `IDX_MG_CATALOGRULE_GROUP_WEBSITE_CUSTOMER_GROUP_ID` (`customer_group_id`),
  ADD KEY `IDX_MG_CATALOGRULE_GROUP_WEBSITE_WEBSITE_ID` (`website_id`);

--
-- Index pour la table `mg_catalogrule_product`
--
ALTER TABLE `mg_catalogrule_product`
  ADD PRIMARY KEY (`rule_product_id`),
  ADD UNIQUE KEY `DA1358CC06FA5B33D4A0E2FC597C56CD` (`rule_id`,`from_time`,`to_time`,`website_id`,`customer_group_id`,`product_id`,`sort_order`),
  ADD KEY `IDX_MG_CATALOGRULE_PRODUCT_RULE_ID` (`rule_id`),
  ADD KEY `IDX_MG_CATALOGRULE_PRODUCT_CUSTOMER_GROUP_ID` (`customer_group_id`),
  ADD KEY `IDX_MG_CATALOGRULE_PRODUCT_WEBSITE_ID` (`website_id`),
  ADD KEY `IDX_MG_CATALOGRULE_PRODUCT_FROM_TIME` (`from_time`),
  ADD KEY `IDX_MG_CATALOGRULE_PRODUCT_TO_TIME` (`to_time`),
  ADD KEY `IDX_MG_CATALOGRULE_PRODUCT_PRODUCT_ID` (`product_id`);

--
-- Index pour la table `mg_catalogrule_product_price`
--
ALTER TABLE `mg_catalogrule_product_price`
  ADD PRIMARY KEY (`rule_product_price_id`),
  ADD UNIQUE KEY `UNQ_MG_CATRULE_PRD_PRICE_RULE_DATE_WS_ID_CSTR_GROUP_ID_PRD_ID` (`rule_date`,`website_id`,`customer_group_id`,`product_id`),
  ADD KEY `IDX_MG_CATALOGRULE_PRODUCT_PRICE_CUSTOMER_GROUP_ID` (`customer_group_id`),
  ADD KEY `IDX_MG_CATALOGRULE_PRODUCT_PRICE_WEBSITE_ID` (`website_id`),
  ADD KEY `IDX_MG_CATALOGRULE_PRODUCT_PRICE_PRODUCT_ID` (`product_id`);

--
-- Index pour la table `mg_catalogrule_website`
--
ALTER TABLE `mg_catalogrule_website`
  ADD PRIMARY KEY (`rule_id`,`website_id`),
  ADD KEY `IDX_MG_CATALOGRULE_WEBSITE_RULE_ID` (`rule_id`),
  ADD KEY `IDX_MG_CATALOGRULE_WEBSITE_WEBSITE_ID` (`website_id`);

--
-- Index pour la table `mg_catalogsearch_fulltext`
--
ALTER TABLE `mg_catalogsearch_fulltext`
  ADD PRIMARY KEY (`fulltext_id`),
  ADD UNIQUE KEY `UNQ_MG_CATALOGSEARCH_FULLTEXT_PRODUCT_ID_STORE_ID` (`product_id`,`store_id`),
  ADD FULLTEXT KEY `FTI_MG_CATALOGSEARCH_FULLTEXT_DATA_INDEX` (`data_index`);

--
-- Index pour la table `mg_catalogsearch_query`
--
ALTER TABLE `mg_catalogsearch_query`
  ADD PRIMARY KEY (`query_id`),
  ADD KEY `IDX_MG_CATALOGSEARCH_QUERY_QUERY_TEXT_STORE_ID_POPULARITY` (`query_text`,`store_id`,`popularity`),
  ADD KEY `IDX_MG_CATALOGSEARCH_QUERY_STORE_ID` (`store_id`),
  ADD KEY `IDX_MG_MG_CATALOGSEARCH_QUERY_SYNONYM_FOR` (`synonym_for`);

--
-- Index pour la table `mg_catalogsearch_result`
--
ALTER TABLE `mg_catalogsearch_result`
  ADD PRIMARY KEY (`query_id`,`product_id`),
  ADD KEY `IDX_MG_CATALOGSEARCH_RESULT_QUERY_ID` (`query_id`),
  ADD KEY `IDX_MG_CATALOGSEARCH_RESULT_PRODUCT_ID` (`product_id`);

--
-- Index pour la table `mg_catalog_category_anc_categs_index_idx`
--
ALTER TABLE `mg_catalog_category_anc_categs_index_idx`
  ADD KEY `IDX_MG_CATALOG_CATEGORY_ANC_CATEGS_INDEX_IDX_CATEGORY_ID` (`category_id`),
  ADD KEY `IDX_MG_CATALOG_CATEGORY_ANC_CATEGS_INDEX_IDX_PATH_CATEGORY_ID` (`path`,`category_id`);

--
-- Index pour la table `mg_catalog_category_anc_categs_index_tmp`
--
ALTER TABLE `mg_catalog_category_anc_categs_index_tmp`
  ADD KEY `IDX_MG_CATALOG_CATEGORY_ANC_CATEGS_INDEX_TMP_CATEGORY_ID` (`category_id`),
  ADD KEY `IDX_MG_CATALOG_CATEGORY_ANC_CATEGS_INDEX_TMP_PATH_CATEGORY_ID` (`path`,`category_id`);

--
-- Index pour la table `mg_catalog_category_anc_products_index_idx`
--
ALTER TABLE `mg_catalog_category_anc_products_index_idx`
  ADD KEY `IDX_MG_CAT_CTGR_ANC_PRDS_IDX_IDX_CTGR_ID_PRD_ID_POSITION` (`category_id`,`product_id`,`position`);

--
-- Index pour la table `mg_catalog_category_anc_products_index_tmp`
--
ALTER TABLE `mg_catalog_category_anc_products_index_tmp`
  ADD KEY `IDX_MG_CAT_CTGR_ANC_PRDS_IDX_TMP_CTGR_ID_PRD_ID_POSITION` (`category_id`,`product_id`,`position`);

--
-- Index pour la table `mg_catalog_category_entity`
--
ALTER TABLE `mg_catalog_category_entity`
  ADD PRIMARY KEY (`entity_id`),
  ADD KEY `IDX_MG_CATALOG_CATEGORY_ENTITY_LEVEL` (`level`),
  ADD KEY `IDX_MG_CATALOG_CATEGORY_ENTITY_PATH_ENTITY_ID` (`path`,`entity_id`);

--
-- Index pour la table `mg_catalog_category_entity_datetime`
--
ALTER TABLE `mg_catalog_category_entity_datetime`
  ADD PRIMARY KEY (`value_id`),
  ADD UNIQUE KEY `UNQ_MG_CAT_CTGR_ENTT_DTIME_ENTT_TYPE_ID_ENTT_ID_ATTR_ID_STORE_ID` (`entity_type_id`,`entity_id`,`attribute_id`,`store_id`),
  ADD KEY `IDX_MG_CATALOG_CATEGORY_ENTITY_DATETIME_ENTITY_ID` (`entity_id`),
  ADD KEY `IDX_MG_CATALOG_CATEGORY_ENTITY_DATETIME_ATTRIBUTE_ID` (`attribute_id`),
  ADD KEY `IDX_MG_CATALOG_CATEGORY_ENTITY_DATETIME_STORE_ID` (`store_id`);

--
-- Index pour la table `mg_catalog_category_entity_decimal`
--
ALTER TABLE `mg_catalog_category_entity_decimal`
  ADD PRIMARY KEY (`value_id`),
  ADD UNIQUE KEY `UNQ_MG_CAT_CTGR_ENTT_DEC_ENTT_TYPE_ID_ENTT_ID_ATTR_ID_STORE_ID` (`entity_type_id`,`entity_id`,`attribute_id`,`store_id`),
  ADD KEY `IDX_MG_CATALOG_CATEGORY_ENTITY_DECIMAL_ENTITY_ID` (`entity_id`),
  ADD KEY `IDX_MG_CATALOG_CATEGORY_ENTITY_DECIMAL_ATTRIBUTE_ID` (`attribute_id`),
  ADD KEY `IDX_MG_CATALOG_CATEGORY_ENTITY_DECIMAL_STORE_ID` (`store_id`);

--
-- Index pour la table `mg_catalog_category_entity_int`
--
ALTER TABLE `mg_catalog_category_entity_int`
  ADD PRIMARY KEY (`value_id`),
  ADD UNIQUE KEY `UNQ_MG_CAT_CTGR_ENTT_INT_ENTT_TYPE_ID_ENTT_ID_ATTR_ID_STORE_ID` (`entity_type_id`,`entity_id`,`attribute_id`,`store_id`),
  ADD KEY `IDX_MG_CATALOG_CATEGORY_ENTITY_INT_ENTITY_ID` (`entity_id`),
  ADD KEY `IDX_MG_CATALOG_CATEGORY_ENTITY_INT_ATTRIBUTE_ID` (`attribute_id`),
  ADD KEY `IDX_MG_CATALOG_CATEGORY_ENTITY_INT_STORE_ID` (`store_id`);

--
-- Index pour la table `mg_catalog_category_entity_text`
--
ALTER TABLE `mg_catalog_category_entity_text`
  ADD PRIMARY KEY (`value_id`),
  ADD UNIQUE KEY `UNQ_MG_CAT_CTGR_ENTT_TEXT_ENTT_TYPE_ID_ENTT_ID_ATTR_ID_STORE_ID` (`entity_type_id`,`entity_id`,`attribute_id`,`store_id`),
  ADD KEY `IDX_MG_CATALOG_CATEGORY_ENTITY_TEXT_ENTITY_ID` (`entity_id`),
  ADD KEY `IDX_MG_CATALOG_CATEGORY_ENTITY_TEXT_ATTRIBUTE_ID` (`attribute_id`),
  ADD KEY `IDX_MG_CATALOG_CATEGORY_ENTITY_TEXT_STORE_ID` (`store_id`);

--
-- Index pour la table `mg_catalog_category_entity_varchar`
--
ALTER TABLE `mg_catalog_category_entity_varchar`
  ADD PRIMARY KEY (`value_id`),
  ADD UNIQUE KEY `UNQ_MG_CAT_CTGR_ENTT_VCHR_ENTT_TYPE_ID_ENTT_ID_ATTR_ID_STORE_ID` (`entity_type_id`,`entity_id`,`attribute_id`,`store_id`),
  ADD KEY `IDX_MG_CATALOG_CATEGORY_ENTITY_VARCHAR_ENTITY_ID` (`entity_id`),
  ADD KEY `IDX_MG_CATALOG_CATEGORY_ENTITY_VARCHAR_ATTRIBUTE_ID` (`attribute_id`),
  ADD KEY `IDX_MG_CATALOG_CATEGORY_ENTITY_VARCHAR_STORE_ID` (`store_id`);

--
-- Index pour la table `mg_catalog_category_product`
--
ALTER TABLE `mg_catalog_category_product`
  ADD PRIMARY KEY (`category_id`,`product_id`),
  ADD KEY `IDX_MG_CATALOG_CATEGORY_PRODUCT_PRODUCT_ID` (`product_id`);

--
-- Index pour la table `mg_catalog_category_product_index`
--
ALTER TABLE `mg_catalog_category_product_index`
  ADD PRIMARY KEY (`category_id`,`product_id`,`store_id`),
  ADD KEY `IDX_MG_CAT_CTGR_PRD_IDX_PRD_ID_STORE_ID_CTGR_ID_VISIBILITY` (`product_id`,`store_id`,`category_id`,`visibility`),
  ADD KEY `9F0DE3351D175F137D28704CB260F849` (`store_id`,`category_id`,`visibility`,`is_parent`,`position`);

--
-- Index pour la table `mg_catalog_category_product_index_enbl_idx`
--
ALTER TABLE `mg_catalog_category_product_index_enbl_idx`
  ADD KEY `IDX_MG_CATALOG_CATEGORY_PRODUCT_INDEX_ENBL_IDX_PRODUCT_ID` (`product_id`),
  ADD KEY `IDX_MG_CAT_CTGR_PRD_IDX_ENBL_IDX_PRD_ID_VISIBILITY` (`product_id`,`visibility`);

--
-- Index pour la table `mg_catalog_category_product_index_enbl_tmp`
--
ALTER TABLE `mg_catalog_category_product_index_enbl_tmp`
  ADD KEY `IDX_MG_CATALOG_CATEGORY_PRODUCT_INDEX_ENBL_TMP_PRODUCT_ID` (`product_id`),
  ADD KEY `IDX_MG_CAT_CTGR_PRD_IDX_ENBL_TMP_PRD_ID_VISIBILITY` (`product_id`,`visibility`);

--
-- Index pour la table `mg_catalog_category_product_index_idx`
--
ALTER TABLE `mg_catalog_category_product_index_idx`
  ADD KEY `IDX_MG_CAT_CTGR_PRD_IDX_IDX_PRD_ID_CTGR_ID_STORE_ID` (`product_id`,`category_id`,`store_id`);

--
-- Index pour la table `mg_catalog_category_product_index_tmp`
--
ALTER TABLE `mg_catalog_category_product_index_tmp`
  ADD KEY `IDX_MG_CAT_CTGR_PRD_IDX_TMP_PRD_ID_CTGR_ID_STORE_ID` (`product_id`,`category_id`,`store_id`);

--
-- Index pour la table `mg_catalog_compare_item`
--
ALTER TABLE `mg_catalog_compare_item`
  ADD PRIMARY KEY (`catalog_compare_item_id`),
  ADD KEY `IDX_MG_CATALOG_COMPARE_ITEM_CUSTOMER_ID` (`customer_id`),
  ADD KEY `IDX_MG_CATALOG_COMPARE_ITEM_PRODUCT_ID` (`product_id`),
  ADD KEY `IDX_MG_CATALOG_COMPARE_ITEM_VISITOR_ID_PRODUCT_ID` (`visitor_id`,`product_id`),
  ADD KEY `IDX_MG_CATALOG_COMPARE_ITEM_CUSTOMER_ID_PRODUCT_ID` (`customer_id`,`product_id`),
  ADD KEY `IDX_MG_CATALOG_COMPARE_ITEM_STORE_ID` (`store_id`);

--
-- Index pour la table `mg_catalog_eav_attribute`
--
ALTER TABLE `mg_catalog_eav_attribute`
  ADD PRIMARY KEY (`attribute_id`),
  ADD KEY `IDX_MG_CATALOG_EAV_ATTRIBUTE_USED_FOR_SORT_BY` (`used_for_sort_by`),
  ADD KEY `IDX_MG_CATALOG_EAV_ATTRIBUTE_USED_IN_PRODUCT_LISTING` (`used_in_product_listing`);

--
-- Index pour la table `mg_catalog_product_bundle_option`
--
ALTER TABLE `mg_catalog_product_bundle_option`
  ADD PRIMARY KEY (`option_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_BUNDLE_OPTION_PARENT_ID` (`parent_id`);

--
-- Index pour la table `mg_catalog_product_bundle_option_value`
--
ALTER TABLE `mg_catalog_product_bundle_option_value`
  ADD PRIMARY KEY (`value_id`),
  ADD UNIQUE KEY `UNQ_MG_CATALOG_PRODUCT_BUNDLE_OPTION_VALUE_OPTION_ID_STORE_ID` (`option_id`,`store_id`);

--
-- Index pour la table `mg_catalog_product_bundle_price_index`
--
ALTER TABLE `mg_catalog_product_bundle_price_index`
  ADD PRIMARY KEY (`entity_id`,`website_id`,`customer_group_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_BUNDLE_PRICE_INDEX_WEBSITE_ID` (`website_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_BUNDLE_PRICE_INDEX_CUSTOMER_GROUP_ID` (`customer_group_id`);

--
-- Index pour la table `mg_catalog_product_bundle_selection`
--
ALTER TABLE `mg_catalog_product_bundle_selection`
  ADD PRIMARY KEY (`selection_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_BUNDLE_SELECTION_OPTION_ID` (`option_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_BUNDLE_SELECTION_PRODUCT_ID` (`product_id`);

--
-- Index pour la table `mg_catalog_product_bundle_selection_price`
--
ALTER TABLE `mg_catalog_product_bundle_selection_price`
  ADD PRIMARY KEY (`selection_id`,`website_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_BUNDLE_SELECTION_PRICE_WEBSITE_ID` (`website_id`);

--
-- Index pour la table `mg_catalog_product_bundle_stock_index`
--
ALTER TABLE `mg_catalog_product_bundle_stock_index`
  ADD PRIMARY KEY (`entity_id`,`website_id`,`stock_id`,`option_id`);

--
-- Index pour la table `mg_catalog_product_enabled_index`
--
ALTER TABLE `mg_catalog_product_enabled_index`
  ADD PRIMARY KEY (`product_id`,`store_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_ENABLED_INDEX_STORE_ID` (`store_id`);

--
-- Index pour la table `mg_catalog_product_entity`
--
ALTER TABLE `mg_catalog_product_entity`
  ADD PRIMARY KEY (`entity_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_ENTITY_ENTITY_TYPE_ID` (`entity_type_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_ENTITY_ATTRIBUTE_SET_ID` (`attribute_set_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_ENTITY_SKU` (`sku`);

--
-- Index pour la table `mg_catalog_product_entity_datetime`
--
ALTER TABLE `mg_catalog_product_entity_datetime`
  ADD PRIMARY KEY (`value_id`),
  ADD UNIQUE KEY `UNQ_MG_CAT_PRD_ENTT_DTIME_ENTT_ID_ATTR_ID_STORE_ID` (`entity_id`,`attribute_id`,`store_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_ENTITY_DATETIME_ATTRIBUTE_ID` (`attribute_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_ENTITY_DATETIME_STORE_ID` (`store_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_ENTITY_DATETIME_ENTITY_ID` (`entity_id`);

--
-- Index pour la table `mg_catalog_product_entity_decimal`
--
ALTER TABLE `mg_catalog_product_entity_decimal`
  ADD PRIMARY KEY (`value_id`),
  ADD UNIQUE KEY `UNQ_MG_CAT_PRD_ENTT_DEC_ENTT_ID_ATTR_ID_STORE_ID` (`entity_id`,`attribute_id`,`store_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_ENTITY_DECIMAL_STORE_ID` (`store_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_ENTITY_DECIMAL_ENTITY_ID` (`entity_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_ENTITY_DECIMAL_ATTRIBUTE_ID` (`attribute_id`);

--
-- Index pour la table `mg_catalog_product_entity_gallery`
--
ALTER TABLE `mg_catalog_product_entity_gallery`
  ADD PRIMARY KEY (`value_id`),
  ADD UNIQUE KEY `UNQ_MG_CAT_PRD_ENTT_GLR_ENTT_TYPE_ID_ENTT_ID_ATTR_ID_STORE_ID` (`entity_type_id`,`entity_id`,`attribute_id`,`store_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_ENTITY_GALLERY_ENTITY_ID` (`entity_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_ENTITY_GALLERY_ATTRIBUTE_ID` (`attribute_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_ENTITY_GALLERY_STORE_ID` (`store_id`);

--
-- Index pour la table `mg_catalog_product_entity_group_price`
--
ALTER TABLE `mg_catalog_product_entity_group_price`
  ADD PRIMARY KEY (`value_id`),
  ADD UNIQUE KEY `BD6DADE3E4CD24F3E6F99CF01F03CD7A` (`entity_id`,`all_groups`,`customer_group_id`,`website_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_ENTITY_GROUP_PRICE_ENTITY_ID` (`entity_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_ENTITY_GROUP_PRICE_CUSTOMER_GROUP_ID` (`customer_group_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_ENTITY_GROUP_PRICE_WEBSITE_ID` (`website_id`);

--
-- Index pour la table `mg_catalog_product_entity_int`
--
ALTER TABLE `mg_catalog_product_entity_int`
  ADD PRIMARY KEY (`value_id`),
  ADD UNIQUE KEY `UNQ_MG_CAT_PRD_ENTT_INT_ENTT_ID_ATTR_ID_STORE_ID` (`entity_id`,`attribute_id`,`store_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_ENTITY_INT_ATTRIBUTE_ID` (`attribute_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_ENTITY_INT_STORE_ID` (`store_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_ENTITY_INT_ENTITY_ID` (`entity_id`);

--
-- Index pour la table `mg_catalog_product_entity_media_gallery`
--
ALTER TABLE `mg_catalog_product_entity_media_gallery`
  ADD PRIMARY KEY (`value_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_ENTITY_MEDIA_GALLERY_ATTRIBUTE_ID` (`attribute_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_ENTITY_MEDIA_GALLERY_ENTITY_ID` (`entity_id`);

--
-- Index pour la table `mg_catalog_product_entity_media_gallery_value`
--
ALTER TABLE `mg_catalog_product_entity_media_gallery_value`
  ADD PRIMARY KEY (`value_id`,`store_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_ENTITY_MEDIA_GALLERY_VALUE_STORE_ID` (`store_id`);

--
-- Index pour la table `mg_catalog_product_entity_text`
--
ALTER TABLE `mg_catalog_product_entity_text`
  ADD PRIMARY KEY (`value_id`),
  ADD UNIQUE KEY `UNQ_MG_CAT_PRD_ENTT_TEXT_ENTT_ID_ATTR_ID_STORE_ID` (`entity_id`,`attribute_id`,`store_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_ENTITY_TEXT_ATTRIBUTE_ID` (`attribute_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_ENTITY_TEXT_STORE_ID` (`store_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_ENTITY_TEXT_ENTITY_ID` (`entity_id`);

--
-- Index pour la table `mg_catalog_product_entity_tier_price`
--
ALTER TABLE `mg_catalog_product_entity_tier_price`
  ADD PRIMARY KEY (`value_id`),
  ADD UNIQUE KEY `C993396E720E6ED52BF4AD082B2ACE02` (`entity_id`,`all_groups`,`customer_group_id`,`qty`,`website_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_ENTITY_TIER_PRICE_ENTITY_ID` (`entity_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_ENTITY_TIER_PRICE_CUSTOMER_GROUP_ID` (`customer_group_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_ENTITY_TIER_PRICE_WEBSITE_ID` (`website_id`);

--
-- Index pour la table `mg_catalog_product_entity_varchar`
--
ALTER TABLE `mg_catalog_product_entity_varchar`
  ADD PRIMARY KEY (`value_id`),
  ADD UNIQUE KEY `UNQ_MG_CAT_PRD_ENTT_VCHR_ENTT_ID_ATTR_ID_STORE_ID` (`entity_id`,`attribute_id`,`store_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_ENTITY_VARCHAR_ATTRIBUTE_ID` (`attribute_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_ENTITY_VARCHAR_STORE_ID` (`store_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_ENTITY_VARCHAR_ENTITY_ID` (`entity_id`);

--
-- Index pour la table `mg_catalog_product_index_eav`
--
ALTER TABLE `mg_catalog_product_index_eav`
  ADD PRIMARY KEY (`entity_id`,`attribute_id`,`store_id`,`value`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_INDEX_EAV_ENTITY_ID` (`entity_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_INDEX_EAV_ATTRIBUTE_ID` (`attribute_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_INDEX_EAV_STORE_ID` (`store_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_INDEX_EAV_VALUE` (`value`);

--
-- Index pour la table `mg_catalog_product_index_eav_decimal`
--
ALTER TABLE `mg_catalog_product_index_eav_decimal`
  ADD PRIMARY KEY (`entity_id`,`attribute_id`,`store_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_INDEX_EAV_DECIMAL_ENTITY_ID` (`entity_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_INDEX_EAV_DECIMAL_ATTRIBUTE_ID` (`attribute_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_INDEX_EAV_DECIMAL_STORE_ID` (`store_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_INDEX_EAV_DECIMAL_VALUE` (`value`);

--
-- Index pour la table `mg_catalog_product_index_eav_decimal_idx`
--
ALTER TABLE `mg_catalog_product_index_eav_decimal_idx`
  ADD PRIMARY KEY (`entity_id`,`attribute_id`,`store_id`,`value`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_INDEX_EAV_DECIMAL_IDX_ENTITY_ID` (`entity_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_INDEX_EAV_DECIMAL_IDX_ATTRIBUTE_ID` (`attribute_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_INDEX_EAV_DECIMAL_IDX_STORE_ID` (`store_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_INDEX_EAV_DECIMAL_IDX_VALUE` (`value`);

--
-- Index pour la table `mg_catalog_product_index_eav_decimal_tmp`
--
ALTER TABLE `mg_catalog_product_index_eav_decimal_tmp`
  ADD PRIMARY KEY (`entity_id`,`attribute_id`,`store_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_INDEX_EAV_DECIMAL_TMP_ENTITY_ID` (`entity_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_INDEX_EAV_DECIMAL_TMP_ATTRIBUTE_ID` (`attribute_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_INDEX_EAV_DECIMAL_TMP_STORE_ID` (`store_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_INDEX_EAV_DECIMAL_TMP_VALUE` (`value`);

--
-- Index pour la table `mg_catalog_product_index_eav_idx`
--
ALTER TABLE `mg_catalog_product_index_eav_idx`
  ADD PRIMARY KEY (`entity_id`,`attribute_id`,`store_id`,`value`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_INDEX_EAV_IDX_ENTITY_ID` (`entity_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_INDEX_EAV_IDX_ATTRIBUTE_ID` (`attribute_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_INDEX_EAV_IDX_STORE_ID` (`store_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_INDEX_EAV_IDX_VALUE` (`value`);

--
-- Index pour la table `mg_catalog_product_index_eav_tmp`
--
ALTER TABLE `mg_catalog_product_index_eav_tmp`
  ADD PRIMARY KEY (`entity_id`,`attribute_id`,`store_id`,`value`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_INDEX_EAV_TMP_ENTITY_ID` (`entity_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_INDEX_EAV_TMP_ATTRIBUTE_ID` (`attribute_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_INDEX_EAV_TMP_STORE_ID` (`store_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_INDEX_EAV_TMP_VALUE` (`value`);

--
-- Index pour la table `mg_catalog_product_index_group_price`
--
ALTER TABLE `mg_catalog_product_index_group_price`
  ADD PRIMARY KEY (`entity_id`,`customer_group_id`,`website_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_INDEX_GROUP_PRICE_CUSTOMER_GROUP_ID` (`customer_group_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_INDEX_GROUP_PRICE_WEBSITE_ID` (`website_id`);

--
-- Index pour la table `mg_catalog_product_index_price`
--
ALTER TABLE `mg_catalog_product_index_price`
  ADD PRIMARY KEY (`entity_id`,`customer_group_id`,`website_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_INDEX_PRICE_CUSTOMER_GROUP_ID` (`customer_group_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_INDEX_PRICE_WEBSITE_ID` (`website_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_INDEX_PRICE_MIN_PRICE` (`min_price`),
  ADD KEY `IDX_MG_CAT_PRD_IDX_PRICE_WS_ID_CSTR_GROUP_ID_MIN_PRICE` (`website_id`,`customer_group_id`,`min_price`);

--
-- Index pour la table `mg_catalog_product_index_price_bundle_idx`
--
ALTER TABLE `mg_catalog_product_index_price_bundle_idx`
  ADD PRIMARY KEY (`entity_id`,`customer_group_id`,`website_id`);

--
-- Index pour la table `mg_catalog_product_index_price_bundle_opt_idx`
--
ALTER TABLE `mg_catalog_product_index_price_bundle_opt_idx`
  ADD PRIMARY KEY (`entity_id`,`customer_group_id`,`website_id`,`option_id`);

--
-- Index pour la table `mg_catalog_product_index_price_bundle_opt_tmp`
--
ALTER TABLE `mg_catalog_product_index_price_bundle_opt_tmp`
  ADD PRIMARY KEY (`entity_id`,`customer_group_id`,`website_id`,`option_id`);

--
-- Index pour la table `mg_catalog_product_index_price_bundle_sel_idx`
--
ALTER TABLE `mg_catalog_product_index_price_bundle_sel_idx`
  ADD PRIMARY KEY (`entity_id`,`customer_group_id`,`website_id`,`option_id`,`selection_id`);

--
-- Index pour la table `mg_catalog_product_index_price_bundle_sel_tmp`
--
ALTER TABLE `mg_catalog_product_index_price_bundle_sel_tmp`
  ADD PRIMARY KEY (`entity_id`,`customer_group_id`,`website_id`,`option_id`,`selection_id`);

--
-- Index pour la table `mg_catalog_product_index_price_bundle_tmp`
--
ALTER TABLE `mg_catalog_product_index_price_bundle_tmp`
  ADD PRIMARY KEY (`entity_id`,`customer_group_id`,`website_id`);

--
-- Index pour la table `mg_catalog_product_index_price_cfg_opt_agr_idx`
--
ALTER TABLE `mg_catalog_product_index_price_cfg_opt_agr_idx`
  ADD PRIMARY KEY (`parent_id`,`child_id`,`customer_group_id`,`website_id`);

--
-- Index pour la table `mg_catalog_product_index_price_cfg_opt_agr_tmp`
--
ALTER TABLE `mg_catalog_product_index_price_cfg_opt_agr_tmp`
  ADD PRIMARY KEY (`parent_id`,`child_id`,`customer_group_id`,`website_id`);

--
-- Index pour la table `mg_catalog_product_index_price_cfg_opt_idx`
--
ALTER TABLE `mg_catalog_product_index_price_cfg_opt_idx`
  ADD PRIMARY KEY (`entity_id`,`customer_group_id`,`website_id`);

--
-- Index pour la table `mg_catalog_product_index_price_cfg_opt_tmp`
--
ALTER TABLE `mg_catalog_product_index_price_cfg_opt_tmp`
  ADD PRIMARY KEY (`entity_id`,`customer_group_id`,`website_id`);

--
-- Index pour la table `mg_catalog_product_index_price_downlod_idx`
--
ALTER TABLE `mg_catalog_product_index_price_downlod_idx`
  ADD PRIMARY KEY (`entity_id`,`customer_group_id`,`website_id`);

--
-- Index pour la table `mg_catalog_product_index_price_downlod_tmp`
--
ALTER TABLE `mg_catalog_product_index_price_downlod_tmp`
  ADD PRIMARY KEY (`entity_id`,`customer_group_id`,`website_id`);

--
-- Index pour la table `mg_catalog_product_index_price_final_idx`
--
ALTER TABLE `mg_catalog_product_index_price_final_idx`
  ADD PRIMARY KEY (`entity_id`,`customer_group_id`,`website_id`);

--
-- Index pour la table `mg_catalog_product_index_price_final_tmp`
--
ALTER TABLE `mg_catalog_product_index_price_final_tmp`
  ADD PRIMARY KEY (`entity_id`,`customer_group_id`,`website_id`);

--
-- Index pour la table `mg_catalog_product_index_price_idx`
--
ALTER TABLE `mg_catalog_product_index_price_idx`
  ADD PRIMARY KEY (`entity_id`,`customer_group_id`,`website_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_INDEX_PRICE_IDX_CUSTOMER_GROUP_ID` (`customer_group_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_INDEX_PRICE_IDX_WEBSITE_ID` (`website_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_INDEX_PRICE_IDX_MIN_PRICE` (`min_price`);

--
-- Index pour la table `mg_catalog_product_index_price_opt_agr_idx`
--
ALTER TABLE `mg_catalog_product_index_price_opt_agr_idx`
  ADD PRIMARY KEY (`entity_id`,`customer_group_id`,`website_id`,`option_id`);

--
-- Index pour la table `mg_catalog_product_index_price_opt_agr_tmp`
--
ALTER TABLE `mg_catalog_product_index_price_opt_agr_tmp`
  ADD PRIMARY KEY (`entity_id`,`customer_group_id`,`website_id`,`option_id`);

--
-- Index pour la table `mg_catalog_product_index_price_opt_idx`
--
ALTER TABLE `mg_catalog_product_index_price_opt_idx`
  ADD PRIMARY KEY (`entity_id`,`customer_group_id`,`website_id`);

--
-- Index pour la table `mg_catalog_product_index_price_opt_tmp`
--
ALTER TABLE `mg_catalog_product_index_price_opt_tmp`
  ADD PRIMARY KEY (`entity_id`,`customer_group_id`,`website_id`);

--
-- Index pour la table `mg_catalog_product_index_price_tmp`
--
ALTER TABLE `mg_catalog_product_index_price_tmp`
  ADD PRIMARY KEY (`entity_id`,`customer_group_id`,`website_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_INDEX_PRICE_TMP_CUSTOMER_GROUP_ID` (`customer_group_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_INDEX_PRICE_TMP_WEBSITE_ID` (`website_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_INDEX_PRICE_TMP_MIN_PRICE` (`min_price`);

--
-- Index pour la table `mg_catalog_product_index_tier_price`
--
ALTER TABLE `mg_catalog_product_index_tier_price`
  ADD PRIMARY KEY (`entity_id`,`customer_group_id`,`website_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_INDEX_TIER_PRICE_CUSTOMER_GROUP_ID` (`customer_group_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_INDEX_TIER_PRICE_WEBSITE_ID` (`website_id`);

--
-- Index pour la table `mg_catalog_product_index_website`
--
ALTER TABLE `mg_catalog_product_index_website`
  ADD PRIMARY KEY (`website_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_INDEX_WEBSITE_WEBSITE_DATE` (`website_date`);

--
-- Index pour la table `mg_catalog_product_link`
--
ALTER TABLE `mg_catalog_product_link`
  ADD PRIMARY KEY (`link_id`),
  ADD UNIQUE KEY `UNQ_MG_CAT_PRD_LNK_LNK_TYPE_ID_PRD_ID_LNKED_PRD_ID` (`link_type_id`,`product_id`,`linked_product_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_LINK_PRODUCT_ID` (`product_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_LINK_LINKED_PRODUCT_ID` (`linked_product_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_LINK_LINK_TYPE_ID` (`link_type_id`);

--
-- Index pour la table `mg_catalog_product_link_attribute`
--
ALTER TABLE `mg_catalog_product_link_attribute`
  ADD PRIMARY KEY (`product_link_attribute_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_LINK_ATTRIBUTE_LINK_TYPE_ID` (`link_type_id`);

--
-- Index pour la table `mg_catalog_product_link_attribute_decimal`
--
ALTER TABLE `mg_catalog_product_link_attribute_decimal`
  ADD PRIMARY KEY (`value_id`),
  ADD UNIQUE KEY `UNQ_MG_CAT_PRD_LNK_ATTR_DEC_PRD_LNK_ATTR_ID_LNK_ID` (`product_link_attribute_id`,`link_id`),
  ADD KEY `IDX_MG_CAT_PRD_LNK_ATTR_DEC_PRD_LNK_ATTR_ID` (`product_link_attribute_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_LINK_ATTRIBUTE_DECIMAL_LINK_ID` (`link_id`);

--
-- Index pour la table `mg_catalog_product_link_attribute_int`
--
ALTER TABLE `mg_catalog_product_link_attribute_int`
  ADD PRIMARY KEY (`value_id`),
  ADD UNIQUE KEY `UNQ_MG_CAT_PRD_LNK_ATTR_INT_PRD_LNK_ATTR_ID_LNK_ID` (`product_link_attribute_id`,`link_id`),
  ADD KEY `IDX_MG_CAT_PRD_LNK_ATTR_INT_PRD_LNK_ATTR_ID` (`product_link_attribute_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_LINK_ATTRIBUTE_INT_LINK_ID` (`link_id`);

--
-- Index pour la table `mg_catalog_product_link_attribute_varchar`
--
ALTER TABLE `mg_catalog_product_link_attribute_varchar`
  ADD PRIMARY KEY (`value_id`),
  ADD UNIQUE KEY `UNQ_MG_CAT_PRD_LNK_ATTR_VCHR_PRD_LNK_ATTR_ID_LNK_ID` (`product_link_attribute_id`,`link_id`),
  ADD KEY `IDX_MG_CAT_PRD_LNK_ATTR_VCHR_PRD_LNK_ATTR_ID` (`product_link_attribute_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_LINK_ATTRIBUTE_VARCHAR_LINK_ID` (`link_id`);

--
-- Index pour la table `mg_catalog_product_link_type`
--
ALTER TABLE `mg_catalog_product_link_type`
  ADD PRIMARY KEY (`link_type_id`);

--
-- Index pour la table `mg_catalog_product_option`
--
ALTER TABLE `mg_catalog_product_option`
  ADD PRIMARY KEY (`option_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_OPTION_PRODUCT_ID` (`product_id`);

--
-- Index pour la table `mg_catalog_product_option_price`
--
ALTER TABLE `mg_catalog_product_option_price`
  ADD PRIMARY KEY (`option_price_id`),
  ADD UNIQUE KEY `UNQ_MG_CATALOG_PRODUCT_OPTION_PRICE_OPTION_ID_STORE_ID` (`option_id`,`store_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_OPTION_PRICE_OPTION_ID` (`option_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_OPTION_PRICE_STORE_ID` (`store_id`);

--
-- Index pour la table `mg_catalog_product_option_title`
--
ALTER TABLE `mg_catalog_product_option_title`
  ADD PRIMARY KEY (`option_title_id`),
  ADD UNIQUE KEY `UNQ_MG_CATALOG_PRODUCT_OPTION_TITLE_OPTION_ID_STORE_ID` (`option_id`,`store_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_OPTION_TITLE_OPTION_ID` (`option_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_OPTION_TITLE_STORE_ID` (`store_id`);

--
-- Index pour la table `mg_catalog_product_option_type_price`
--
ALTER TABLE `mg_catalog_product_option_type_price`
  ADD PRIMARY KEY (`option_type_price_id`),
  ADD UNIQUE KEY `UNQ_MG_CATALOG_PRODUCT_OPTION_TYPE_PRICE_OPTION_TYPE_ID_STORE_ID` (`option_type_id`,`store_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_OPTION_TYPE_PRICE_OPTION_TYPE_ID` (`option_type_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_OPTION_TYPE_PRICE_STORE_ID` (`store_id`);

--
-- Index pour la table `mg_catalog_product_option_type_title`
--
ALTER TABLE `mg_catalog_product_option_type_title`
  ADD PRIMARY KEY (`option_type_title_id`),
  ADD UNIQUE KEY `UNQ_MG_CATALOG_PRODUCT_OPTION_TYPE_TITLE_OPTION_TYPE_ID_STORE_ID` (`option_type_id`,`store_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_OPTION_TYPE_TITLE_OPTION_TYPE_ID` (`option_type_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_OPTION_TYPE_TITLE_STORE_ID` (`store_id`);

--
-- Index pour la table `mg_catalog_product_option_type_value`
--
ALTER TABLE `mg_catalog_product_option_type_value`
  ADD PRIMARY KEY (`option_type_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_OPTION_TYPE_VALUE_OPTION_ID` (`option_id`);

--
-- Index pour la table `mg_catalog_product_relation`
--
ALTER TABLE `mg_catalog_product_relation`
  ADD PRIMARY KEY (`parent_id`,`child_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_RELATION_CHILD_ID` (`child_id`);

--
-- Index pour la table `mg_catalog_product_super_attribute`
--
ALTER TABLE `mg_catalog_product_super_attribute`
  ADD PRIMARY KEY (`product_super_attribute_id`),
  ADD UNIQUE KEY `UNQ_MG_CATALOG_PRODUCT_SUPER_ATTRIBUTE_PRODUCT_ID_ATTRIBUTE_ID` (`product_id`,`attribute_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_SUPER_ATTRIBUTE_PRODUCT_ID` (`product_id`);

--
-- Index pour la table `mg_catalog_product_super_attribute_label`
--
ALTER TABLE `mg_catalog_product_super_attribute_label`
  ADD PRIMARY KEY (`value_id`),
  ADD UNIQUE KEY `UNQ_MG_CAT_PRD_SPR_ATTR_LBL_PRD_SPR_ATTR_ID_STORE_ID` (`product_super_attribute_id`,`store_id`),
  ADD KEY `IDX_MG_CAT_PRD_SPR_ATTR_LBL_PRD_SPR_ATTR_ID` (`product_super_attribute_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_SUPER_ATTRIBUTE_LABEL_STORE_ID` (`store_id`);

--
-- Index pour la table `mg_catalog_product_super_attribute_pricing`
--
ALTER TABLE `mg_catalog_product_super_attribute_pricing`
  ADD PRIMARY KEY (`value_id`),
  ADD UNIQUE KEY `UNQ_MG_CAT_PRD_SPR_ATTR_PRICING_PRD_SPR_ATTR_ID_VAL_IDX_WS_ID` (`product_super_attribute_id`,`value_index`,`website_id`),
  ADD KEY `IDX_MG_CAT_PRD_SPR_ATTR_PRICING_PRD_SPR_ATTR_ID` (`product_super_attribute_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_SUPER_ATTRIBUTE_PRICING_WEBSITE_ID` (`website_id`);

--
-- Index pour la table `mg_catalog_product_super_link`
--
ALTER TABLE `mg_catalog_product_super_link`
  ADD PRIMARY KEY (`link_id`),
  ADD UNIQUE KEY `UNQ_MG_CATALOG_PRODUCT_SUPER_LINK_PRODUCT_ID_PARENT_ID` (`product_id`,`parent_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_SUPER_LINK_PARENT_ID` (`parent_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_SUPER_LINK_PRODUCT_ID` (`product_id`);

--
-- Index pour la table `mg_catalog_product_website`
--
ALTER TABLE `mg_catalog_product_website`
  ADD PRIMARY KEY (`product_id`,`website_id`),
  ADD KEY `IDX_MG_CATALOG_PRODUCT_WEBSITE_WEBSITE_ID` (`website_id`);

--
-- Index pour la table `mg_checkout_agreement`
--
ALTER TABLE `mg_checkout_agreement`
  ADD PRIMARY KEY (`agreement_id`);

--
-- Index pour la table `mg_checkout_agreement_store`
--
ALTER TABLE `mg_checkout_agreement_store`
  ADD PRIMARY KEY (`agreement_id`,`store_id`),
  ADD KEY `FK_MG_CHECKOUT_AGREEMENT_STORE_STORE_ID_MG_CORE_STORE_STORE_ID` (`store_id`);

--
-- Index pour la table `mg_cms_block`
--
ALTER TABLE `mg_cms_block`
  ADD PRIMARY KEY (`block_id`);

--
-- Index pour la table `mg_cms_block_store`
--
ALTER TABLE `mg_cms_block_store`
  ADD PRIMARY KEY (`block_id`,`store_id`),
  ADD KEY `IDX_MG_CMS_BLOCK_STORE_STORE_ID` (`store_id`);

--
-- Index pour la table `mg_cms_page`
--
ALTER TABLE `mg_cms_page`
  ADD PRIMARY KEY (`page_id`),
  ADD KEY `IDX_MG_CMS_PAGE_IDENTIFIER` (`identifier`);

--
-- Index pour la table `mg_cms_page_store`
--
ALTER TABLE `mg_cms_page_store`
  ADD PRIMARY KEY (`page_id`,`store_id`),
  ADD KEY `IDX_MG_CMS_PAGE_STORE_STORE_ID` (`store_id`);

--
-- Index pour la table `mg_core_cache`
--
ALTER TABLE `mg_core_cache`
  ADD PRIMARY KEY (`id`),
  ADD KEY `IDX_MG_CORE_CACHE_EXPIRE_TIME` (`expire_time`);

--
-- Index pour la table `mg_core_cache_option`
--
ALTER TABLE `mg_core_cache_option`
  ADD PRIMARY KEY (`code`);

--
-- Index pour la table `mg_core_cache_tag`
--
ALTER TABLE `mg_core_cache_tag`
  ADD PRIMARY KEY (`tag`,`cache_id`),
  ADD KEY `IDX_MG_CORE_CACHE_TAG_CACHE_ID` (`cache_id`);

--
-- Index pour la table `mg_core_config_data`
--
ALTER TABLE `mg_core_config_data`
  ADD PRIMARY KEY (`config_id`),
  ADD UNIQUE KEY `UNQ_MG_CORE_CONFIG_DATA_SCOPE_SCOPE_ID_PATH` (`scope`,`scope_id`,`path`);

--
-- Index pour la table `mg_core_email_queue`
--
ALTER TABLE `mg_core_email_queue`
  ADD PRIMARY KEY (`message_id`),
  ADD KEY `14B076DC519354349FEFB134A2107CA3` (`entity_id`,`entity_type`,`event_type`,`message_body_hash`);

--
-- Index pour la table `mg_core_email_queue_recipients`
--
ALTER TABLE `mg_core_email_queue_recipients`
  ADD PRIMARY KEY (`recipient_id`),
  ADD UNIQUE KEY `7272D79F622E2C99CA8B71DF02F8464D` (`message_id`,`recipient_email`,`email_type`),
  ADD KEY `IDX_MG_CORE_EMAIL_QUEUE_RECIPIENTS_RECIPIENT_EMAIL` (`recipient_email`),
  ADD KEY `IDX_MG_CORE_EMAIL_QUEUE_RECIPIENTS_EMAIL_TYPE` (`email_type`);

--
-- Index pour la table `mg_core_email_template`
--
ALTER TABLE `mg_core_email_template`
  ADD PRIMARY KEY (`template_id`),
  ADD UNIQUE KEY `UNQ_MG_CORE_EMAIL_TEMPLATE_TEMPLATE_CODE` (`template_code`),
  ADD KEY `IDX_MG_CORE_EMAIL_TEMPLATE_ADDED_AT` (`added_at`),
  ADD KEY `IDX_MG_CORE_EMAIL_TEMPLATE_MODIFIED_AT` (`modified_at`);

--
-- Index pour la table `mg_core_flag`
--
ALTER TABLE `mg_core_flag`
  ADD PRIMARY KEY (`flag_id`),
  ADD KEY `IDX_MG_CORE_FLAG_LAST_UPDATE` (`last_update`);

--
-- Index pour la table `mg_core_layout_link`
--
ALTER TABLE `mg_core_layout_link`
  ADD PRIMARY KEY (`layout_link_id`),
  ADD UNIQUE KEY `UNQ_MG_CORE_LAYOUT_LINK_STORE_ID_PACKAGE_THEME_LAYOUT_UPDATE_ID` (`store_id`,`package`,`theme`,`layout_update_id`),
  ADD KEY `IDX_MG_CORE_LAYOUT_LINK_LAYOUT_UPDATE_ID` (`layout_update_id`);

--
-- Index pour la table `mg_core_layout_update`
--
ALTER TABLE `mg_core_layout_update`
  ADD PRIMARY KEY (`layout_update_id`),
  ADD KEY `IDX_MG_CORE_LAYOUT_UPDATE_HANDLE` (`handle`);

--
-- Index pour la table `mg_core_resource`
--
ALTER TABLE `mg_core_resource`
  ADD PRIMARY KEY (`code`);

--
-- Index pour la table `mg_core_session`
--
ALTER TABLE `mg_core_session`
  ADD PRIMARY KEY (`session_id`);

--
-- Index pour la table `mg_core_store`
--
ALTER TABLE `mg_core_store`
  ADD PRIMARY KEY (`store_id`),
  ADD UNIQUE KEY `UNQ_MG_CORE_STORE_CODE` (`code`),
  ADD KEY `IDX_MG_CORE_STORE_WEBSITE_ID` (`website_id`),
  ADD KEY `IDX_MG_CORE_STORE_IS_ACTIVE_SORT_ORDER` (`is_active`,`sort_order`),
  ADD KEY `IDX_MG_CORE_STORE_GROUP_ID` (`group_id`);

--
-- Index pour la table `mg_core_store_group`
--
ALTER TABLE `mg_core_store_group`
  ADD PRIMARY KEY (`group_id`),
  ADD KEY `IDX_MG_CORE_STORE_GROUP_WEBSITE_ID` (`website_id`),
  ADD KEY `IDX_MG_CORE_STORE_GROUP_DEFAULT_STORE_ID` (`default_store_id`);

--
-- Index pour la table `mg_core_translate`
--
ALTER TABLE `mg_core_translate`
  ADD PRIMARY KEY (`key_id`),
  ADD UNIQUE KEY `UNQ_MG_CORE_TRANSLATE_STORE_ID_LOCALE_CRC_STRING_STRING` (`store_id`,`locale`,`crc_string`,`string`),
  ADD KEY `IDX_MG_CORE_TRANSLATE_STORE_ID` (`store_id`);

--
-- Index pour la table `mg_core_url_rewrite`
--
ALTER TABLE `mg_core_url_rewrite`
  ADD PRIMARY KEY (`url_rewrite_id`),
  ADD UNIQUE KEY `UNQ_MG_CORE_URL_REWRITE_REQUEST_PATH_STORE_ID` (`request_path`,`store_id`),
  ADD UNIQUE KEY `UNQ_MG_CORE_URL_REWRITE_ID_PATH_IS_SYSTEM_STORE_ID` (`id_path`,`is_system`,`store_id`),
  ADD KEY `IDX_MG_CORE_URL_REWRITE_TARGET_PATH_STORE_ID` (`target_path`,`store_id`),
  ADD KEY `IDX_MG_CORE_URL_REWRITE_ID_PATH` (`id_path`),
  ADD KEY `IDX_MG_CORE_URL_REWRITE_STORE_ID` (`store_id`),
  ADD KEY `FK_MG_CORE_URL_REWRITE_CTGR_ID_MG_CAT_CTGR_ENTT_ENTT_ID` (`category_id`),
  ADD KEY `FK_MG_CORE_URL_REWRITE_PRD_ID_MG_CAT_CTGR_ENTT_ENTT_ID` (`product_id`);

--
-- Index pour la table `mg_core_variable`
--
ALTER TABLE `mg_core_variable`
  ADD PRIMARY KEY (`variable_id`),
  ADD UNIQUE KEY `UNQ_MG_CORE_VARIABLE_CODE` (`code`);

--
-- Index pour la table `mg_core_variable_value`
--
ALTER TABLE `mg_core_variable_value`
  ADD PRIMARY KEY (`value_id`),
  ADD UNIQUE KEY `UNQ_MG_CORE_VARIABLE_VALUE_VARIABLE_ID_STORE_ID` (`variable_id`,`store_id`),
  ADD KEY `IDX_MG_CORE_VARIABLE_VALUE_VARIABLE_ID` (`variable_id`),
  ADD KEY `IDX_MG_CORE_VARIABLE_VALUE_STORE_ID` (`store_id`);

--
-- Index pour la table `mg_core_website`
--
ALTER TABLE `mg_core_website`
  ADD PRIMARY KEY (`website_id`),
  ADD UNIQUE KEY `UNQ_MG_CORE_WEBSITE_CODE` (`code`),
  ADD KEY `IDX_MG_CORE_WEBSITE_SORT_ORDER` (`sort_order`),
  ADD KEY `IDX_MG_CORE_WEBSITE_DEFAULT_GROUP_ID` (`default_group_id`);

--
-- Index pour la table `mg_coupon_aggregated`
--
ALTER TABLE `mg_coupon_aggregated`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `UNQ_MG_COUPON_AGGRED_PERIOD_STORE_ID_ORDER_STS_COUPON_CODE` (`period`,`store_id`,`order_status`,`coupon_code`),
  ADD KEY `IDX_MG_COUPON_AGGREGATED_STORE_ID` (`store_id`),
  ADD KEY `IDX_MG_COUPON_AGGREGATED_RULE_NAME` (`rule_name`);

--
-- Index pour la table `mg_coupon_aggregated_order`
--
ALTER TABLE `mg_coupon_aggregated_order`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `UNQ_MG_COUPON_AGGRED_ORDER_PERIOD_STORE_ID_ORDER_STS_COUPON_CODE` (`period`,`store_id`,`order_status`,`coupon_code`),
  ADD KEY `IDX_MG_COUPON_AGGREGATED_ORDER_STORE_ID` (`store_id`),
  ADD KEY `IDX_MG_COUPON_AGGREGATED_ORDER_RULE_NAME` (`rule_name`);

--
-- Index pour la table `mg_coupon_aggregated_updated`
--
ALTER TABLE `mg_coupon_aggregated_updated`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `815F1B064BD39A72FFDC0A1547DD4909` (`period`,`store_id`,`order_status`,`coupon_code`),
  ADD KEY `IDX_MG_COUPON_AGGREGATED_UPDATED_STORE_ID` (`store_id`),
  ADD KEY `IDX_MG_COUPON_AGGREGATED_UPDATED_RULE_NAME` (`rule_name`);

--
-- Index pour la table `mg_cron_schedule`
--
ALTER TABLE `mg_cron_schedule`
  ADD PRIMARY KEY (`schedule_id`),
  ADD KEY `IDX_MG_CRON_SCHEDULE_JOB_CODE` (`job_code`),
  ADD KEY `IDX_MG_CRON_SCHEDULE_SCHEDULED_AT_STATUS` (`scheduled_at`,`status`);

--
-- Index pour la table `mg_customer_address_entity`
--
ALTER TABLE `mg_customer_address_entity`
  ADD PRIMARY KEY (`entity_id`),
  ADD KEY `IDX_MG_CUSTOMER_ADDRESS_ENTITY_PARENT_ID` (`parent_id`);

--
-- Index pour la table `mg_customer_address_entity_datetime`
--
ALTER TABLE `mg_customer_address_entity_datetime`
  ADD PRIMARY KEY (`value_id`),
  ADD UNIQUE KEY `UNQ_MG_CUSTOMER_ADDRESS_ENTITY_DATETIME_ENTITY_ID_ATTRIBUTE_ID` (`entity_id`,`attribute_id`),
  ADD KEY `IDX_MG_CUSTOMER_ADDRESS_ENTITY_DATETIME_ENTITY_TYPE_ID` (`entity_type_id`),
  ADD KEY `IDX_MG_CUSTOMER_ADDRESS_ENTITY_DATETIME_ATTRIBUTE_ID` (`attribute_id`),
  ADD KEY `IDX_MG_CUSTOMER_ADDRESS_ENTITY_DATETIME_ENTITY_ID` (`entity_id`),
  ADD KEY `IDX_MG_CSTR_ADDR_ENTT_DTIME_ENTT_ID_ATTR_ID_VAL` (`entity_id`,`attribute_id`,`value`);

--
-- Index pour la table `mg_customer_address_entity_decimal`
--
ALTER TABLE `mg_customer_address_entity_decimal`
  ADD PRIMARY KEY (`value_id`),
  ADD UNIQUE KEY `UNQ_MG_CUSTOMER_ADDRESS_ENTITY_DECIMAL_ENTITY_ID_ATTRIBUTE_ID` (`entity_id`,`attribute_id`),
  ADD KEY `IDX_MG_CUSTOMER_ADDRESS_ENTITY_DECIMAL_ENTITY_TYPE_ID` (`entity_type_id`),
  ADD KEY `IDX_MG_CUSTOMER_ADDRESS_ENTITY_DECIMAL_ATTRIBUTE_ID` (`attribute_id`),
  ADD KEY `IDX_MG_CUSTOMER_ADDRESS_ENTITY_DECIMAL_ENTITY_ID` (`entity_id`),
  ADD KEY `IDX_MG_CSTR_ADDR_ENTT_DEC_ENTT_ID_ATTR_ID_VAL` (`entity_id`,`attribute_id`,`value`);

--
-- Index pour la table `mg_customer_address_entity_int`
--
ALTER TABLE `mg_customer_address_entity_int`
  ADD PRIMARY KEY (`value_id`),
  ADD UNIQUE KEY `UNQ_MG_CUSTOMER_ADDRESS_ENTITY_INT_ENTITY_ID_ATTRIBUTE_ID` (`entity_id`,`attribute_id`),
  ADD KEY `IDX_MG_CUSTOMER_ADDRESS_ENTITY_INT_ENTITY_TYPE_ID` (`entity_type_id`),
  ADD KEY `IDX_MG_CUSTOMER_ADDRESS_ENTITY_INT_ATTRIBUTE_ID` (`attribute_id`),
  ADD KEY `IDX_MG_CUSTOMER_ADDRESS_ENTITY_INT_ENTITY_ID` (`entity_id`),
  ADD KEY `IDX_MG_CUSTOMER_ADDRESS_ENTITY_INT_ENTITY_ID_ATTRIBUTE_ID_VALUE` (`entity_id`,`attribute_id`,`value`);

--
-- Index pour la table `mg_customer_address_entity_text`
--
ALTER TABLE `mg_customer_address_entity_text`
  ADD PRIMARY KEY (`value_id`),
  ADD UNIQUE KEY `UNQ_MG_CUSTOMER_ADDRESS_ENTITY_TEXT_ENTITY_ID_ATTRIBUTE_ID` (`entity_id`,`attribute_id`),
  ADD KEY `IDX_MG_CUSTOMER_ADDRESS_ENTITY_TEXT_ENTITY_TYPE_ID` (`entity_type_id`),
  ADD KEY `IDX_MG_CUSTOMER_ADDRESS_ENTITY_TEXT_ATTRIBUTE_ID` (`attribute_id`),
  ADD KEY `IDX_MG_CUSTOMER_ADDRESS_ENTITY_TEXT_ENTITY_ID` (`entity_id`);

--
-- Index pour la table `mg_customer_address_entity_varchar`
--
ALTER TABLE `mg_customer_address_entity_varchar`
  ADD PRIMARY KEY (`value_id`),
  ADD UNIQUE KEY `UNQ_MG_CUSTOMER_ADDRESS_ENTITY_VARCHAR_ENTITY_ID_ATTRIBUTE_ID` (`entity_id`,`attribute_id`),
  ADD KEY `IDX_MG_CUSTOMER_ADDRESS_ENTITY_VARCHAR_ENTITY_TYPE_ID` (`entity_type_id`),
  ADD KEY `IDX_MG_CUSTOMER_ADDRESS_ENTITY_VARCHAR_ATTRIBUTE_ID` (`attribute_id`),
  ADD KEY `IDX_MG_CUSTOMER_ADDRESS_ENTITY_VARCHAR_ENTITY_ID` (`entity_id`),
  ADD KEY `IDX_MG_CSTR_ADDR_ENTT_VCHR_ENTT_ID_ATTR_ID_VAL` (`entity_id`,`attribute_id`,`value`);

--
-- Index pour la table `mg_customer_eav_attribute`
--
ALTER TABLE `mg_customer_eav_attribute`
  ADD PRIMARY KEY (`attribute_id`);

--
-- Index pour la table `mg_customer_eav_attribute_website`
--
ALTER TABLE `mg_customer_eav_attribute_website`
  ADD PRIMARY KEY (`attribute_id`,`website_id`),
  ADD KEY `IDX_MG_CUSTOMER_EAV_ATTRIBUTE_WEBSITE_WEBSITE_ID` (`website_id`);

--
-- Index pour la table `mg_customer_entity`
--
ALTER TABLE `mg_customer_entity`
  ADD PRIMARY KEY (`entity_id`),
  ADD UNIQUE KEY `UNQ_MG_CUSTOMER_ENTITY_EMAIL_WEBSITE_ID` (`email`,`website_id`),
  ADD KEY `IDX_MG_CUSTOMER_ENTITY_STORE_ID` (`store_id`),
  ADD KEY `IDX_MG_CUSTOMER_ENTITY_ENTITY_TYPE_ID` (`entity_type_id`),
  ADD KEY `IDX_MG_CUSTOMER_ENTITY_EMAIL_WEBSITE_ID` (`email`,`website_id`),
  ADD KEY `IDX_MG_CUSTOMER_ENTITY_WEBSITE_ID` (`website_id`);

--
-- Index pour la table `mg_customer_entity_datetime`
--
ALTER TABLE `mg_customer_entity_datetime`
  ADD PRIMARY KEY (`value_id`),
  ADD UNIQUE KEY `UNQ_MG_CUSTOMER_ENTITY_DATETIME_ENTITY_ID_ATTRIBUTE_ID` (`entity_id`,`attribute_id`),
  ADD KEY `IDX_MG_CUSTOMER_ENTITY_DATETIME_ENTITY_TYPE_ID` (`entity_type_id`),
  ADD KEY `IDX_MG_CUSTOMER_ENTITY_DATETIME_ATTRIBUTE_ID` (`attribute_id`),
  ADD KEY `IDX_MG_CUSTOMER_ENTITY_DATETIME_ENTITY_ID` (`entity_id`),
  ADD KEY `IDX_MG_CUSTOMER_ENTITY_DATETIME_ENTITY_ID_ATTRIBUTE_ID_VALUE` (`entity_id`,`attribute_id`,`value`);

--
-- Index pour la table `mg_customer_entity_decimal`
--
ALTER TABLE `mg_customer_entity_decimal`
  ADD PRIMARY KEY (`value_id`),
  ADD UNIQUE KEY `UNQ_MG_CUSTOMER_ENTITY_DECIMAL_ENTITY_ID_ATTRIBUTE_ID` (`entity_id`,`attribute_id`),
  ADD KEY `IDX_MG_CUSTOMER_ENTITY_DECIMAL_ENTITY_TYPE_ID` (`entity_type_id`),
  ADD KEY `IDX_MG_CUSTOMER_ENTITY_DECIMAL_ATTRIBUTE_ID` (`attribute_id`),
  ADD KEY `IDX_MG_CUSTOMER_ENTITY_DECIMAL_ENTITY_ID` (`entity_id`),
  ADD KEY `IDX_MG_CUSTOMER_ENTITY_DECIMAL_ENTITY_ID_ATTRIBUTE_ID_VALUE` (`entity_id`,`attribute_id`,`value`);

--
-- Index pour la table `mg_customer_entity_int`
--
ALTER TABLE `mg_customer_entity_int`
  ADD PRIMARY KEY (`value_id`),
  ADD UNIQUE KEY `UNQ_MG_CUSTOMER_ENTITY_INT_ENTITY_ID_ATTRIBUTE_ID` (`entity_id`,`attribute_id`),
  ADD KEY `IDX_MG_CUSTOMER_ENTITY_INT_ENTITY_TYPE_ID` (`entity_type_id`),
  ADD KEY `IDX_MG_CUSTOMER_ENTITY_INT_ATTRIBUTE_ID` (`attribute_id`),
  ADD KEY `IDX_MG_CUSTOMER_ENTITY_INT_ENTITY_ID` (`entity_id`),
  ADD KEY `IDX_MG_CUSTOMER_ENTITY_INT_ENTITY_ID_ATTRIBUTE_ID_VALUE` (`entity_id`,`attribute_id`,`value`);

--
-- Index pour la table `mg_customer_entity_text`
--
ALTER TABLE `mg_customer_entity_text`
  ADD PRIMARY KEY (`value_id`),
  ADD UNIQUE KEY `UNQ_MG_CUSTOMER_ENTITY_TEXT_ENTITY_ID_ATTRIBUTE_ID` (`entity_id`,`attribute_id`),
  ADD KEY `IDX_MG_CUSTOMER_ENTITY_TEXT_ENTITY_TYPE_ID` (`entity_type_id`),
  ADD KEY `IDX_MG_CUSTOMER_ENTITY_TEXT_ATTRIBUTE_ID` (`attribute_id`),
  ADD KEY `IDX_MG_CUSTOMER_ENTITY_TEXT_ENTITY_ID` (`entity_id`);

--
-- Index pour la table `mg_customer_entity_varchar`
--
ALTER TABLE `mg_customer_entity_varchar`
  ADD PRIMARY KEY (`value_id`),
  ADD UNIQUE KEY `UNQ_MG_CUSTOMER_ENTITY_VARCHAR_ENTITY_ID_ATTRIBUTE_ID` (`entity_id`,`attribute_id`),
  ADD KEY `IDX_MG_CUSTOMER_ENTITY_VARCHAR_ENTITY_TYPE_ID` (`entity_type_id`),
  ADD KEY `IDX_MG_CUSTOMER_ENTITY_VARCHAR_ATTRIBUTE_ID` (`attribute_id`),
  ADD KEY `IDX_MG_CUSTOMER_ENTITY_VARCHAR_ENTITY_ID` (`entity_id`),
  ADD KEY `IDX_MG_CUSTOMER_ENTITY_VARCHAR_ENTITY_ID_ATTRIBUTE_ID_VALUE` (`entity_id`,`attribute_id`,`value`);

--
-- Index pour la table `mg_customer_flowpassword`
--
ALTER TABLE `mg_customer_flowpassword`
  ADD PRIMARY KEY (`flowpassword_id`),
  ADD KEY `IDX_MG_CUSTOMER_FLOWPASSWORD_EMAIL` (`email`),
  ADD KEY `IDX_MG_CUSTOMER_FLOWPASSWORD_IP` (`ip`),
  ADD KEY `IDX_MG_CUSTOMER_FLOWPASSWORD_REQUESTED_DATE` (`requested_date`);

--
-- Index pour la table `mg_customer_form_attribute`
--
ALTER TABLE `mg_customer_form_attribute`
  ADD PRIMARY KEY (`form_code`,`attribute_id`),
  ADD KEY `IDX_MG_CUSTOMER_FORM_ATTRIBUTE_ATTRIBUTE_ID` (`attribute_id`);

--
-- Index pour la table `mg_customer_group`
--
ALTER TABLE `mg_customer_group`
  ADD PRIMARY KEY (`customer_group_id`);

--
-- Index pour la table `mg_dataflow_batch`
--
ALTER TABLE `mg_dataflow_batch`
  ADD PRIMARY KEY (`batch_id`),
  ADD KEY `IDX_MG_DATAFLOW_BATCH_PROFILE_ID` (`profile_id`),
  ADD KEY `IDX_MG_DATAFLOW_BATCH_STORE_ID` (`store_id`),
  ADD KEY `IDX_MG_DATAFLOW_BATCH_CREATED_AT` (`created_at`);

--
-- Index pour la table `mg_dataflow_batch_export`
--
ALTER TABLE `mg_dataflow_batch_export`
  ADD PRIMARY KEY (`batch_export_id`),
  ADD KEY `IDX_MG_DATAFLOW_BATCH_EXPORT_BATCH_ID` (`batch_id`);

--
-- Index pour la table `mg_dataflow_batch_import`
--
ALTER TABLE `mg_dataflow_batch_import`
  ADD PRIMARY KEY (`batch_import_id`),
  ADD KEY `IDX_MG_DATAFLOW_BATCH_IMPORT_BATCH_ID` (`batch_id`);

--
-- Index pour la table `mg_dataflow_import_data`
--
ALTER TABLE `mg_dataflow_import_data`
  ADD PRIMARY KEY (`import_id`),
  ADD KEY `IDX_MG_DATAFLOW_IMPORT_DATA_SESSION_ID` (`session_id`);

--
-- Index pour la table `mg_dataflow_profile`
--
ALTER TABLE `mg_dataflow_profile`
  ADD PRIMARY KEY (`profile_id`);

--
-- Index pour la table `mg_dataflow_profile_history`
--
ALTER TABLE `mg_dataflow_profile_history`
  ADD PRIMARY KEY (`history_id`),
  ADD KEY `IDX_MG_DATAFLOW_PROFILE_HISTORY_PROFILE_ID` (`profile_id`);

--
-- Index pour la table `mg_dataflow_session`
--
ALTER TABLE `mg_dataflow_session`
  ADD PRIMARY KEY (`session_id`);

--
-- Index pour la table `mg_design_change`
--
ALTER TABLE `mg_design_change`
  ADD PRIMARY KEY (`design_change_id`),
  ADD KEY `IDX_MG_DESIGN_CHANGE_STORE_ID` (`store_id`);

--
-- Index pour la table `mg_directory_country`
--
ALTER TABLE `mg_directory_country`
  ADD PRIMARY KEY (`country_id`);

--
-- Index pour la table `mg_directory_country_format`
--
ALTER TABLE `mg_directory_country_format`
  ADD PRIMARY KEY (`country_format_id`),
  ADD UNIQUE KEY `UNQ_MG_DIRECTORY_COUNTRY_FORMAT_COUNTRY_ID_TYPE` (`country_id`,`type`);

--
-- Index pour la table `mg_directory_country_region`
--
ALTER TABLE `mg_directory_country_region`
  ADD PRIMARY KEY (`region_id`),
  ADD KEY `IDX_MG_DIRECTORY_COUNTRY_REGION_COUNTRY_ID` (`country_id`);

--
-- Index pour la table `mg_directory_country_region_name`
--
ALTER TABLE `mg_directory_country_region_name`
  ADD PRIMARY KEY (`locale`,`region_id`),
  ADD KEY `IDX_MG_DIRECTORY_COUNTRY_REGION_NAME_REGION_ID` (`region_id`);

--
-- Index pour la table `mg_directory_currency_rate`
--
ALTER TABLE `mg_directory_currency_rate`
  ADD PRIMARY KEY (`currency_from`,`currency_to`),
  ADD KEY `IDX_MG_DIRECTORY_CURRENCY_RATE_CURRENCY_TO` (`currency_to`);

--
-- Index pour la table `mg_downloadable_link`
--
ALTER TABLE `mg_downloadable_link`
  ADD PRIMARY KEY (`link_id`),
  ADD KEY `IDX_MG_DOWNLOADABLE_LINK_PRODUCT_ID` (`product_id`),
  ADD KEY `IDX_MG_DOWNLOADABLE_LINK_PRODUCT_ID_SORT_ORDER` (`product_id`,`sort_order`);

--
-- Index pour la table `mg_downloadable_link_price`
--
ALTER TABLE `mg_downloadable_link_price`
  ADD PRIMARY KEY (`price_id`),
  ADD KEY `IDX_MG_DOWNLOADABLE_LINK_PRICE_LINK_ID` (`link_id`),
  ADD KEY `IDX_MG_DOWNLOADABLE_LINK_PRICE_WEBSITE_ID` (`website_id`);

--
-- Index pour la table `mg_downloadable_link_purchased`
--
ALTER TABLE `mg_downloadable_link_purchased`
  ADD PRIMARY KEY (`purchased_id`),
  ADD KEY `IDX_MG_DOWNLOADABLE_LINK_PURCHASED_ORDER_ID` (`order_id`),
  ADD KEY `IDX_MG_DOWNLOADABLE_LINK_PURCHASED_ORDER_ITEM_ID` (`order_item_id`),
  ADD KEY `IDX_MG_DOWNLOADABLE_LINK_PURCHASED_CUSTOMER_ID` (`customer_id`);

--
-- Index pour la table `mg_downloadable_link_purchased_item`
--
ALTER TABLE `mg_downloadable_link_purchased_item`
  ADD PRIMARY KEY (`item_id`),
  ADD KEY `IDX_MG_DOWNLOADABLE_LINK_PURCHASED_ITEM_LINK_HASH` (`link_hash`),
  ADD KEY `IDX_MG_DOWNLOADABLE_LINK_PURCHASED_ITEM_ORDER_ITEM_ID` (`order_item_id`),
  ADD KEY `IDX_MG_DOWNLOADABLE_LINK_PURCHASED_ITEM_PURCHASED_ID` (`purchased_id`);

--
-- Index pour la table `mg_downloadable_link_title`
--
ALTER TABLE `mg_downloadable_link_title`
  ADD PRIMARY KEY (`title_id`),
  ADD UNIQUE KEY `UNQ_MG_DOWNLOADABLE_LINK_TITLE_LINK_ID_STORE_ID` (`link_id`,`store_id`),
  ADD KEY `IDX_MG_DOWNLOADABLE_LINK_TITLE_LINK_ID` (`link_id`),
  ADD KEY `IDX_MG_DOWNLOADABLE_LINK_TITLE_STORE_ID` (`store_id`);

--
-- Index pour la table `mg_downloadable_sample`
--
ALTER TABLE `mg_downloadable_sample`
  ADD PRIMARY KEY (`sample_id`),
  ADD KEY `IDX_MG_DOWNLOADABLE_SAMPLE_PRODUCT_ID` (`product_id`);

--
-- Index pour la table `mg_downloadable_sample_title`
--
ALTER TABLE `mg_downloadable_sample_title`
  ADD PRIMARY KEY (`title_id`),
  ADD UNIQUE KEY `UNQ_MG_DOWNLOADABLE_SAMPLE_TITLE_SAMPLE_ID_STORE_ID` (`sample_id`,`store_id`),
  ADD KEY `IDX_MG_DOWNLOADABLE_SAMPLE_TITLE_SAMPLE_ID` (`sample_id`),
  ADD KEY `IDX_MG_DOWNLOADABLE_SAMPLE_TITLE_STORE_ID` (`store_id`);

--
-- Index pour la table `mg_eav_attribute`
--
ALTER TABLE `mg_eav_attribute`
  ADD PRIMARY KEY (`attribute_id`),
  ADD UNIQUE KEY `UNQ_MG_EAV_ATTRIBUTE_ENTITY_TYPE_ID_ATTRIBUTE_CODE` (`entity_type_id`,`attribute_code`),
  ADD KEY `IDX_MG_EAV_ATTRIBUTE_ENTITY_TYPE_ID` (`entity_type_id`);

--
-- Index pour la table `mg_eav_attribute_group`
--
ALTER TABLE `mg_eav_attribute_group`
  ADD PRIMARY KEY (`attribute_group_id`),
  ADD UNIQUE KEY `UNQ_MG_EAV_ATTRIBUTE_GROUP_ATTRIBUTE_SET_ID_ATTRIBUTE_GROUP_NAME` (`attribute_set_id`,`attribute_group_name`),
  ADD KEY `IDX_MG_EAV_ATTRIBUTE_GROUP_ATTRIBUTE_SET_ID_SORT_ORDER` (`attribute_set_id`,`sort_order`);

--
-- Index pour la table `mg_eav_attribute_label`
--
ALTER TABLE `mg_eav_attribute_label`
  ADD PRIMARY KEY (`attribute_label_id`),
  ADD KEY `IDX_MG_EAV_ATTRIBUTE_LABEL_ATTRIBUTE_ID` (`attribute_id`),
  ADD KEY `IDX_MG_EAV_ATTRIBUTE_LABEL_STORE_ID` (`store_id`),
  ADD KEY `IDX_MG_EAV_ATTRIBUTE_LABEL_ATTRIBUTE_ID_STORE_ID` (`attribute_id`,`store_id`);

--
-- Index pour la table `mg_eav_attribute_option`
--
ALTER TABLE `mg_eav_attribute_option`
  ADD PRIMARY KEY (`option_id`),
  ADD KEY `IDX_MG_EAV_ATTRIBUTE_OPTION_ATTRIBUTE_ID` (`attribute_id`);

--
-- Index pour la table `mg_eav_attribute_option_value`
--
ALTER TABLE `mg_eav_attribute_option_value`
  ADD PRIMARY KEY (`value_id`),
  ADD KEY `IDX_MG_EAV_ATTRIBUTE_OPTION_VALUE_OPTION_ID` (`option_id`),
  ADD KEY `IDX_MG_EAV_ATTRIBUTE_OPTION_VALUE_STORE_ID` (`store_id`);

--
-- Index pour la table `mg_eav_attribute_set`
--
ALTER TABLE `mg_eav_attribute_set`
  ADD PRIMARY KEY (`attribute_set_id`),
  ADD UNIQUE KEY `UNQ_MG_EAV_ATTRIBUTE_SET_ENTITY_TYPE_ID_ATTRIBUTE_SET_NAME` (`entity_type_id`,`attribute_set_name`),
  ADD KEY `IDX_MG_EAV_ATTRIBUTE_SET_ENTITY_TYPE_ID_SORT_ORDER` (`entity_type_id`,`sort_order`);

--
-- Index pour la table `mg_eav_entity`
--
ALTER TABLE `mg_eav_entity`
  ADD PRIMARY KEY (`entity_id`),
  ADD KEY `IDX_MG_EAV_ENTITY_ENTITY_TYPE_ID` (`entity_type_id`),
  ADD KEY `IDX_MG_EAV_ENTITY_STORE_ID` (`store_id`);

--
-- Index pour la table `mg_eav_entity_attribute`
--
ALTER TABLE `mg_eav_entity_attribute`
  ADD PRIMARY KEY (`entity_attribute_id`),
  ADD UNIQUE KEY `UNQ_MG_EAV_ENTITY_ATTRIBUTE_ATTRIBUTE_SET_ID_ATTRIBUTE_ID` (`attribute_set_id`,`attribute_id`),
  ADD UNIQUE KEY `UNQ_MG_EAV_ENTITY_ATTRIBUTE_ATTRIBUTE_GROUP_ID_ATTRIBUTE_ID` (`attribute_group_id`,`attribute_id`),
  ADD KEY `IDX_MG_EAV_ENTITY_ATTRIBUTE_ATTRIBUTE_SET_ID_SORT_ORDER` (`attribute_set_id`,`sort_order`),
  ADD KEY `IDX_MG_EAV_ENTITY_ATTRIBUTE_ATTRIBUTE_ID` (`attribute_id`);

--
-- Index pour la table `mg_eav_entity_datetime`
--
ALTER TABLE `mg_eav_entity_datetime`
  ADD PRIMARY KEY (`value_id`),
  ADD UNIQUE KEY `UNQ_MG_EAV_ENTITY_DATETIME_ENTITY_ID_ATTRIBUTE_ID_STORE_ID` (`entity_id`,`attribute_id`,`store_id`),
  ADD KEY `IDX_MG_EAV_ENTITY_DATETIME_ENTITY_TYPE_ID` (`entity_type_id`),
  ADD KEY `IDX_MG_EAV_ENTITY_DATETIME_ATTRIBUTE_ID` (`attribute_id`),
  ADD KEY `IDX_MG_EAV_ENTITY_DATETIME_STORE_ID` (`store_id`),
  ADD KEY `IDX_MG_EAV_ENTITY_DATETIME_ENTITY_ID` (`entity_id`),
  ADD KEY `IDX_MG_EAV_ENTITY_DATETIME_ATTRIBUTE_ID_VALUE` (`attribute_id`,`value`),
  ADD KEY `IDX_MG_EAV_ENTITY_DATETIME_ENTITY_TYPE_ID_VALUE` (`entity_type_id`,`value`);

--
-- Index pour la table `mg_eav_entity_decimal`
--
ALTER TABLE `mg_eav_entity_decimal`
  ADD PRIMARY KEY (`value_id`),
  ADD UNIQUE KEY `UNQ_MG_EAV_ENTITY_DECIMAL_ENTITY_ID_ATTRIBUTE_ID_STORE_ID` (`entity_id`,`attribute_id`,`store_id`),
  ADD KEY `IDX_MG_EAV_ENTITY_DECIMAL_ENTITY_TYPE_ID` (`entity_type_id`),
  ADD KEY `IDX_MG_EAV_ENTITY_DECIMAL_ATTRIBUTE_ID` (`attribute_id`),
  ADD KEY `IDX_MG_EAV_ENTITY_DECIMAL_STORE_ID` (`store_id`),
  ADD KEY `IDX_MG_EAV_ENTITY_DECIMAL_ENTITY_ID` (`entity_id`),
  ADD KEY `IDX_MG_EAV_ENTITY_DECIMAL_ATTRIBUTE_ID_VALUE` (`attribute_id`,`value`),
  ADD KEY `IDX_MG_EAV_ENTITY_DECIMAL_ENTITY_TYPE_ID_VALUE` (`entity_type_id`,`value`);

--
-- Index pour la table `mg_eav_entity_int`
--
ALTER TABLE `mg_eav_entity_int`
  ADD PRIMARY KEY (`value_id`),
  ADD UNIQUE KEY `UNQ_MG_EAV_ENTITY_INT_ENTITY_ID_ATTRIBUTE_ID_STORE_ID` (`entity_id`,`attribute_id`,`store_id`),
  ADD KEY `IDX_MG_EAV_ENTITY_INT_ENTITY_TYPE_ID` (`entity_type_id`),
  ADD KEY `IDX_MG_EAV_ENTITY_INT_ATTRIBUTE_ID` (`attribute_id`),
  ADD KEY `IDX_MG_EAV_ENTITY_INT_STORE_ID` (`store_id`),
  ADD KEY `IDX_MG_EAV_ENTITY_INT_ENTITY_ID` (`entity_id`),
  ADD KEY `IDX_MG_EAV_ENTITY_INT_ATTRIBUTE_ID_VALUE` (`attribute_id`,`value`),
  ADD KEY `IDX_MG_EAV_ENTITY_INT_ENTITY_TYPE_ID_VALUE` (`entity_type_id`,`value`);

--
-- Index pour la table `mg_eav_entity_store`
--
ALTER TABLE `mg_eav_entity_store`
  ADD PRIMARY KEY (`entity_store_id`),
  ADD KEY `IDX_MG_EAV_ENTITY_STORE_ENTITY_TYPE_ID` (`entity_type_id`),
  ADD KEY `IDX_MG_EAV_ENTITY_STORE_STORE_ID` (`store_id`);

--
-- Index pour la table `mg_eav_entity_text`
--
ALTER TABLE `mg_eav_entity_text`
  ADD PRIMARY KEY (`value_id`),
  ADD UNIQUE KEY `UNQ_MG_EAV_ENTITY_TEXT_ENTITY_ID_ATTRIBUTE_ID_STORE_ID` (`entity_id`,`attribute_id`,`store_id`),
  ADD KEY `IDX_MG_EAV_ENTITY_TEXT_ENTITY_TYPE_ID` (`entity_type_id`),
  ADD KEY `IDX_MG_EAV_ENTITY_TEXT_ATTRIBUTE_ID` (`attribute_id`),
  ADD KEY `IDX_MG_EAV_ENTITY_TEXT_STORE_ID` (`store_id`),
  ADD KEY `IDX_MG_EAV_ENTITY_TEXT_ENTITY_ID` (`entity_id`);

--
-- Index pour la table `mg_eav_entity_type`
--
ALTER TABLE `mg_eav_entity_type`
  ADD PRIMARY KEY (`entity_type_id`),
  ADD KEY `IDX_MG_EAV_ENTITY_TYPE_ENTITY_TYPE_CODE` (`entity_type_code`);

--
-- Index pour la table `mg_eav_entity_varchar`
--
ALTER TABLE `mg_eav_entity_varchar`
  ADD PRIMARY KEY (`value_id`),
  ADD UNIQUE KEY `UNQ_MG_EAV_ENTITY_VARCHAR_ENTITY_ID_ATTRIBUTE_ID_STORE_ID` (`entity_id`,`attribute_id`,`store_id`),
  ADD KEY `IDX_MG_EAV_ENTITY_VARCHAR_ENTITY_TYPE_ID` (`entity_type_id`),
  ADD KEY `IDX_MG_EAV_ENTITY_VARCHAR_ATTRIBUTE_ID` (`attribute_id`),
  ADD KEY `IDX_MG_EAV_ENTITY_VARCHAR_STORE_ID` (`store_id`),
  ADD KEY `IDX_MG_EAV_ENTITY_VARCHAR_ENTITY_ID` (`entity_id`),
  ADD KEY `IDX_MG_EAV_ENTITY_VARCHAR_ATTRIBUTE_ID_VALUE` (`attribute_id`,`value`),
  ADD KEY `IDX_MG_EAV_ENTITY_VARCHAR_ENTITY_TYPE_ID_VALUE` (`entity_type_id`,`value`);

--
-- Index pour la table `mg_eav_form_element`
--
ALTER TABLE `mg_eav_form_element`
  ADD PRIMARY KEY (`element_id`),
  ADD UNIQUE KEY `UNQ_MG_EAV_FORM_ELEMENT_TYPE_ID_ATTRIBUTE_ID` (`type_id`,`attribute_id`),
  ADD KEY `IDX_MG_EAV_FORM_ELEMENT_TYPE_ID` (`type_id`),
  ADD KEY `IDX_MG_EAV_FORM_ELEMENT_FIELDSET_ID` (`fieldset_id`),
  ADD KEY `IDX_MG_EAV_FORM_ELEMENT_ATTRIBUTE_ID` (`attribute_id`);

--
-- Index pour la table `mg_eav_form_fieldset`
--
ALTER TABLE `mg_eav_form_fieldset`
  ADD PRIMARY KEY (`fieldset_id`),
  ADD UNIQUE KEY `UNQ_MG_EAV_FORM_FIELDSET_TYPE_ID_CODE` (`type_id`,`code`),
  ADD KEY `IDX_MG_EAV_FORM_FIELDSET_TYPE_ID` (`type_id`);

--
-- Index pour la table `mg_eav_form_fieldset_label`
--
ALTER TABLE `mg_eav_form_fieldset_label`
  ADD PRIMARY KEY (`fieldset_id`,`store_id`),
  ADD KEY `IDX_MG_EAV_FORM_FIELDSET_LABEL_FIELDSET_ID` (`fieldset_id`),
  ADD KEY `IDX_MG_EAV_FORM_FIELDSET_LABEL_STORE_ID` (`store_id`);

--
-- Index pour la table `mg_eav_form_type`
--
ALTER TABLE `mg_eav_form_type`
  ADD PRIMARY KEY (`type_id`),
  ADD UNIQUE KEY `UNQ_MG_EAV_FORM_TYPE_CODE_THEME_STORE_ID` (`code`,`theme`,`store_id`),
  ADD KEY `IDX_MG_EAV_FORM_TYPE_STORE_ID` (`store_id`);

--
-- Index pour la table `mg_eav_form_type_entity`
--
ALTER TABLE `mg_eav_form_type_entity`
  ADD PRIMARY KEY (`type_id`,`entity_type_id`),
  ADD KEY `IDX_MG_EAV_FORM_TYPE_ENTITY_ENTITY_TYPE_ID` (`entity_type_id`);

--
-- Index pour la table `mg_gift_message`
--
ALTER TABLE `mg_gift_message`
  ADD PRIMARY KEY (`gift_message_id`);

--
-- Index pour la table `mg_importexport_importdata`
--
ALTER TABLE `mg_importexport_importdata`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `mg_index_event`
--
ALTER TABLE `mg_index_event`
  ADD PRIMARY KEY (`event_id`),
  ADD UNIQUE KEY `UNQ_MG_INDEX_EVENT_TYPE_ENTITY_ENTITY_PK` (`type`,`entity`,`entity_pk`);

--
-- Index pour la table `mg_index_process`
--
ALTER TABLE `mg_index_process`
  ADD PRIMARY KEY (`process_id`),
  ADD UNIQUE KEY `UNQ_MG_INDEX_PROCESS_INDEXER_CODE` (`indexer_code`);

--
-- Index pour la table `mg_index_process_event`
--
ALTER TABLE `mg_index_process_event`
  ADD PRIMARY KEY (`process_id`,`event_id`),
  ADD KEY `IDX_MG_INDEX_PROCESS_EVENT_EVENT_ID` (`event_id`);

--
-- Index pour la table `mg_learning_slider_slide`
--
ALTER TABLE `mg_learning_slider_slide`
  ADD PRIMARY KEY (`entity_id`);

--
-- Index pour la table `mg_log_customer`
--
ALTER TABLE `mg_log_customer`
  ADD PRIMARY KEY (`log_id`),
  ADD KEY `IDX_MG_LOG_CUSTOMER_VISITOR_ID` (`visitor_id`);

--
-- Index pour la table `mg_log_quote`
--
ALTER TABLE `mg_log_quote`
  ADD PRIMARY KEY (`quote_id`);

--
-- Index pour la table `mg_log_summary`
--
ALTER TABLE `mg_log_summary`
  ADD PRIMARY KEY (`summary_id`);

--
-- Index pour la table `mg_log_summary_type`
--
ALTER TABLE `mg_log_summary_type`
  ADD PRIMARY KEY (`type_id`);

--
-- Index pour la table `mg_log_url`
--
ALTER TABLE `mg_log_url`
  ADD KEY `IDX_MG_LOG_URL_VISITOR_ID` (`visitor_id`),
  ADD KEY `url_id` (`url_id`);

--
-- Index pour la table `mg_log_url_info`
--
ALTER TABLE `mg_log_url_info`
  ADD PRIMARY KEY (`url_id`);

--
-- Index pour la table `mg_log_visitor`
--
ALTER TABLE `mg_log_visitor`
  ADD PRIMARY KEY (`visitor_id`);

--
-- Index pour la table `mg_log_visitor_info`
--
ALTER TABLE `mg_log_visitor_info`
  ADD PRIMARY KEY (`visitor_id`);

--
-- Index pour la table `mg_log_visitor_online`
--
ALTER TABLE `mg_log_visitor_online`
  ADD PRIMARY KEY (`visitor_id`),
  ADD KEY `IDX_MG_LOG_VISITOR_ONLINE_VISITOR_TYPE` (`visitor_type`),
  ADD KEY `IDX_MG_LOG_VISITOR_ONLINE_FIRST_VISIT_AT_LAST_VISIT_AT` (`first_visit_at`,`last_visit_at`),
  ADD KEY `IDX_MG_LOG_VISITOR_ONLINE_CUSTOMER_ID` (`customer_id`);

--
-- Index pour la table `mg_newsletter_problem`
--
ALTER TABLE `mg_newsletter_problem`
  ADD PRIMARY KEY (`problem_id`),
  ADD KEY `IDX_MG_NEWSLETTER_PROBLEM_SUBSCRIBER_ID` (`subscriber_id`),
  ADD KEY `IDX_MG_NEWSLETTER_PROBLEM_QUEUE_ID` (`queue_id`);

--
-- Index pour la table `mg_newsletter_queue`
--
ALTER TABLE `mg_newsletter_queue`
  ADD PRIMARY KEY (`queue_id`),
  ADD KEY `IDX_MG_NEWSLETTER_QUEUE_TEMPLATE_ID` (`template_id`);

--
-- Index pour la table `mg_newsletter_queue_link`
--
ALTER TABLE `mg_newsletter_queue_link`
  ADD PRIMARY KEY (`queue_link_id`),
  ADD KEY `IDX_MG_NEWSLETTER_QUEUE_LINK_SUBSCRIBER_ID` (`subscriber_id`),
  ADD KEY `IDX_MG_NEWSLETTER_QUEUE_LINK_QUEUE_ID` (`queue_id`),
  ADD KEY `IDX_MG_NEWSLETTER_QUEUE_LINK_QUEUE_ID_LETTER_SENT_AT` (`queue_id`,`letter_sent_at`);

--
-- Index pour la table `mg_newsletter_queue_store_link`
--
ALTER TABLE `mg_newsletter_queue_store_link`
  ADD PRIMARY KEY (`queue_id`,`store_id`),
  ADD KEY `IDX_MG_NEWSLETTER_QUEUE_STORE_LINK_STORE_ID` (`store_id`);

--
-- Index pour la table `mg_newsletter_subscriber`
--
ALTER TABLE `mg_newsletter_subscriber`
  ADD PRIMARY KEY (`subscriber_id`),
  ADD KEY `IDX_MG_NEWSLETTER_SUBSCRIBER_CUSTOMER_ID` (`customer_id`),
  ADD KEY `IDX_MG_NEWSLETTER_SUBSCRIBER_STORE_ID` (`store_id`);

--
-- Index pour la table `mg_newsletter_template`
--
ALTER TABLE `mg_newsletter_template`
  ADD PRIMARY KEY (`template_id`),
  ADD KEY `IDX_MG_NEWSLETTER_TEMPLATE_TEMPLATE_ACTUAL` (`template_actual`),
  ADD KEY `IDX_MG_NEWSLETTER_TEMPLATE_ADDED_AT` (`added_at`),
  ADD KEY `IDX_MG_NEWSLETTER_TEMPLATE_MODIFIED_AT` (`modified_at`);

--
-- Index pour la table `mg_oauth_consumer`
--
ALTER TABLE `mg_oauth_consumer`
  ADD PRIMARY KEY (`entity_id`),
  ADD UNIQUE KEY `UNQ_MG_MG_OAUTH_CONSUMER_KEY` (`key`),
  ADD UNIQUE KEY `UNQ_MG_MG_OAUTH_CONSUMER_SECRET` (`secret`),
  ADD KEY `IDX_MG_OAUTH_CONSUMER_CREATED_AT` (`created_at`),
  ADD KEY `IDX_MG_OAUTH_CONSUMER_UPDATED_AT` (`updated_at`);

--
-- Index pour la table `mg_oauth_nonce`
--
ALTER TABLE `mg_oauth_nonce`
  ADD UNIQUE KEY `UNQ_MG_MG_OAUTH_NONCE_NONCE` (`nonce`);

--
-- Index pour la table `mg_oauth_token`
--
ALTER TABLE `mg_oauth_token`
  ADD PRIMARY KEY (`entity_id`),
  ADD UNIQUE KEY `UNQ_MG_MG_OAUTH_TOKEN_TOKEN` (`token`),
  ADD KEY `IDX_MG_MG_OAUTH_TOKEN_CONSUMER_ID` (`consumer_id`),
  ADD KEY `FK_MG_OAUTH_TOKEN_ADMIN_ID_MG_MG_ADMIN_USER_USER_ID` (`admin_id`),
  ADD KEY `FK_MG_OAUTH_TOKEN_CUSTOMER_ID_MG_MG_CUSTOMER_ENTITY_ENTITY_ID` (`customer_id`);

--
-- Index pour la table `mg_paypal_cert`
--
ALTER TABLE `mg_paypal_cert`
  ADD PRIMARY KEY (`cert_id`),
  ADD KEY `IDX_MG_PAYPAL_CERT_WEBSITE_ID` (`website_id`);

--
-- Index pour la table `mg_paypal_payment_transaction`
--
ALTER TABLE `mg_paypal_payment_transaction`
  ADD PRIMARY KEY (`transaction_id`),
  ADD UNIQUE KEY `UNQ_MG_PAYPAL_PAYMENT_TRANSACTION_TXN_ID` (`txn_id`);

--
-- Index pour la table `mg_paypal_settlement_report`
--
ALTER TABLE `mg_paypal_settlement_report`
  ADD PRIMARY KEY (`report_id`),
  ADD UNIQUE KEY `UNQ_MG_PAYPAL_SETTLEMENT_REPORT_REPORT_DATE_ACCOUNT_ID` (`report_date`,`account_id`);

--
-- Index pour la table `mg_paypal_settlement_report_row`
--
ALTER TABLE `mg_paypal_settlement_report_row`
  ADD PRIMARY KEY (`row_id`),
  ADD KEY `IDX_MG_PAYPAL_SETTLEMENT_REPORT_ROW_REPORT_ID` (`report_id`);

--
-- Index pour la table `mg_permission_block`
--
ALTER TABLE `mg_permission_block`
  ADD PRIMARY KEY (`block_id`),
  ADD UNIQUE KEY `UNQ_MG_PERMISSION_BLOCK_BLOCK_NAME` (`block_name`);

--
-- Index pour la table `mg_permission_variable`
--
ALTER TABLE `mg_permission_variable`
  ADD PRIMARY KEY (`variable_id`,`variable_name`),
  ADD UNIQUE KEY `UNQ_MG_PERMISSION_VARIABLE_VARIABLE_NAME` (`variable_name`);

--
-- Index pour la table `mg_persistent_session`
--
ALTER TABLE `mg_persistent_session`
  ADD PRIMARY KEY (`persistent_id`),
  ADD UNIQUE KEY `IDX_MG_PERSISTENT_SESSION_KEY` (`key`),
  ADD UNIQUE KEY `IDX_MG_PERSISTENT_SESSION_CUSTOMER_ID` (`customer_id`),
  ADD KEY `IDX_MG_PERSISTENT_SESSION_UPDATED_AT` (`updated_at`),
  ADD KEY `FK_MG_PERSISTENT_SESSION_WEBSITE_ID_MG_CORE_WEBSITE_WEBSITE_ID` (`website_id`);

--
-- Index pour la table `mg_poll`
--
ALTER TABLE `mg_poll`
  ADD PRIMARY KEY (`poll_id`),
  ADD KEY `IDX_MG_POLL_STORE_ID` (`store_id`);

--
-- Index pour la table `mg_poll_answer`
--
ALTER TABLE `mg_poll_answer`
  ADD PRIMARY KEY (`answer_id`),
  ADD KEY `IDX_MG_POLL_ANSWER_POLL_ID` (`poll_id`);

--
-- Index pour la table `mg_poll_store`
--
ALTER TABLE `mg_poll_store`
  ADD PRIMARY KEY (`poll_id`,`store_id`),
  ADD KEY `IDX_MG_POLL_STORE_STORE_ID` (`store_id`);

--
-- Index pour la table `mg_poll_vote`
--
ALTER TABLE `mg_poll_vote`
  ADD PRIMARY KEY (`vote_id`),
  ADD KEY `IDX_MG_POLL_VOTE_POLL_ANSWER_ID` (`poll_answer_id`);

--
-- Index pour la table `mg_product_alert_price`
--
ALTER TABLE `mg_product_alert_price`
  ADD PRIMARY KEY (`alert_price_id`),
  ADD KEY `IDX_MG_PRODUCT_ALERT_PRICE_CUSTOMER_ID` (`customer_id`),
  ADD KEY `IDX_MG_PRODUCT_ALERT_PRICE_PRODUCT_ID` (`product_id`),
  ADD KEY `IDX_MG_PRODUCT_ALERT_PRICE_WEBSITE_ID` (`website_id`);

--
-- Index pour la table `mg_product_alert_stock`
--
ALTER TABLE `mg_product_alert_stock`
  ADD PRIMARY KEY (`alert_stock_id`),
  ADD KEY `IDX_MG_PRODUCT_ALERT_STOCK_CUSTOMER_ID` (`customer_id`),
  ADD KEY `IDX_MG_PRODUCT_ALERT_STOCK_PRODUCT_ID` (`product_id`),
  ADD KEY `IDX_MG_PRODUCT_ALERT_STOCK_WEBSITE_ID` (`website_id`);

--
-- Index pour la table `mg_rating`
--
ALTER TABLE `mg_rating`
  ADD PRIMARY KEY (`rating_id`),
  ADD UNIQUE KEY `UNQ_MG_RATING_RATING_CODE` (`rating_code`),
  ADD KEY `IDX_MG_RATING_ENTITY_ID` (`entity_id`);

--
-- Index pour la table `mg_rating_entity`
--
ALTER TABLE `mg_rating_entity`
  ADD PRIMARY KEY (`entity_id`),
  ADD UNIQUE KEY `UNQ_MG_RATING_ENTITY_ENTITY_CODE` (`entity_code`);

--
-- Index pour la table `mg_rating_option`
--
ALTER TABLE `mg_rating_option`
  ADD PRIMARY KEY (`option_id`),
  ADD KEY `IDX_MG_RATING_OPTION_RATING_ID` (`rating_id`);

--
-- Index pour la table `mg_rating_option_vote`
--
ALTER TABLE `mg_rating_option_vote`
  ADD PRIMARY KEY (`vote_id`),
  ADD KEY `IDX_MG_RATING_OPTION_VOTE_OPTION_ID` (`option_id`),
  ADD KEY `FK_MG_RATING_OPTION_VOTE_REVIEW_ID_MG_REVIEW_REVIEW_ID` (`review_id`);

--
-- Index pour la table `mg_rating_option_vote_aggregated`
--
ALTER TABLE `mg_rating_option_vote_aggregated`
  ADD PRIMARY KEY (`primary_id`),
  ADD KEY `IDX_MG_RATING_OPTION_VOTE_AGGREGATED_RATING_ID` (`rating_id`),
  ADD KEY `IDX_MG_RATING_OPTION_VOTE_AGGREGATED_STORE_ID` (`store_id`);

--
-- Index pour la table `mg_rating_store`
--
ALTER TABLE `mg_rating_store`
  ADD PRIMARY KEY (`rating_id`,`store_id`),
  ADD KEY `IDX_MG_RATING_STORE_STORE_ID` (`store_id`);

--
-- Index pour la table `mg_rating_title`
--
ALTER TABLE `mg_rating_title`
  ADD PRIMARY KEY (`rating_id`,`store_id`),
  ADD KEY `IDX_MG_RATING_TITLE_STORE_ID` (`store_id`);

--
-- Index pour la table `mg_report_compared_product_index`
--
ALTER TABLE `mg_report_compared_product_index`
  ADD PRIMARY KEY (`index_id`),
  ADD UNIQUE KEY `UNQ_MG_REPORT_COMPARED_PRODUCT_INDEX_VISITOR_ID_PRODUCT_ID` (`visitor_id`,`product_id`),
  ADD UNIQUE KEY `UNQ_MG_REPORT_COMPARED_PRODUCT_INDEX_CUSTOMER_ID_PRODUCT_ID` (`customer_id`,`product_id`),
  ADD KEY `IDX_MG_REPORT_COMPARED_PRODUCT_INDEX_STORE_ID` (`store_id`),
  ADD KEY `IDX_MG_REPORT_COMPARED_PRODUCT_INDEX_ADDED_AT` (`added_at`),
  ADD KEY `IDX_MG_REPORT_COMPARED_PRODUCT_INDEX_PRODUCT_ID` (`product_id`);

--
-- Index pour la table `mg_report_event`
--
ALTER TABLE `mg_report_event`
  ADD PRIMARY KEY (`event_id`),
  ADD KEY `IDX_MG_REPORT_EVENT_EVENT_TYPE_ID` (`event_type_id`),
  ADD KEY `IDX_MG_REPORT_EVENT_SUBJECT_ID` (`subject_id`),
  ADD KEY `IDX_MG_REPORT_EVENT_OBJECT_ID` (`object_id`),
  ADD KEY `IDX_MG_REPORT_EVENT_SUBTYPE` (`subtype`),
  ADD KEY `IDX_MG_REPORT_EVENT_STORE_ID` (`store_id`);

--
-- Index pour la table `mg_report_event_types`
--
ALTER TABLE `mg_report_event_types`
  ADD PRIMARY KEY (`event_type_id`);

--
-- Index pour la table `mg_report_viewed_product_aggregated_daily`
--
ALTER TABLE `mg_report_viewed_product_aggregated_daily`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `UNQ_MG_REPORT_VIEWED_PRD_AGGRED_DAILY_PERIOD_STORE_ID_PRD_ID` (`period`,`store_id`,`product_id`),
  ADD KEY `IDX_MG_REPORT_VIEWED_PRODUCT_AGGREGATED_DAILY_STORE_ID` (`store_id`),
  ADD KEY `IDX_MG_REPORT_VIEWED_PRODUCT_AGGREGATED_DAILY_PRODUCT_ID` (`product_id`);

--
-- Index pour la table `mg_report_viewed_product_aggregated_monthly`
--
ALTER TABLE `mg_report_viewed_product_aggregated_monthly`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `UNQ_MG_REPORT_VIEWED_PRD_AGGRED_MONTHLY_PERIOD_STORE_ID_PRD_ID` (`period`,`store_id`,`product_id`),
  ADD KEY `IDX_MG_REPORT_VIEWED_PRODUCT_AGGREGATED_MONTHLY_STORE_ID` (`store_id`),
  ADD KEY `IDX_MG_REPORT_VIEWED_PRODUCT_AGGREGATED_MONTHLY_PRODUCT_ID` (`product_id`);

--
-- Index pour la table `mg_report_viewed_product_aggregated_yearly`
--
ALTER TABLE `mg_report_viewed_product_aggregated_yearly`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `UNQ_MG_REPORT_VIEWED_PRD_AGGRED_YEARLY_PERIOD_STORE_ID_PRD_ID` (`period`,`store_id`,`product_id`),
  ADD KEY `IDX_MG_REPORT_VIEWED_PRODUCT_AGGREGATED_YEARLY_STORE_ID` (`store_id`),
  ADD KEY `IDX_MG_REPORT_VIEWED_PRODUCT_AGGREGATED_YEARLY_PRODUCT_ID` (`product_id`);

--
-- Index pour la table `mg_report_viewed_product_index`
--
ALTER TABLE `mg_report_viewed_product_index`
  ADD PRIMARY KEY (`index_id`),
  ADD UNIQUE KEY `UNQ_MG_REPORT_VIEWED_PRODUCT_INDEX_VISITOR_ID_PRODUCT_ID` (`visitor_id`,`product_id`),
  ADD UNIQUE KEY `UNQ_MG_REPORT_VIEWED_PRODUCT_INDEX_CUSTOMER_ID_PRODUCT_ID` (`customer_id`,`product_id`),
  ADD KEY `IDX_MG_REPORT_VIEWED_PRODUCT_INDEX_STORE_ID` (`store_id`),
  ADD KEY `IDX_MG_REPORT_VIEWED_PRODUCT_INDEX_ADDED_AT` (`added_at`),
  ADD KEY `IDX_MG_REPORT_VIEWED_PRODUCT_INDEX_PRODUCT_ID` (`product_id`);

--
-- Index pour la table `mg_review`
--
ALTER TABLE `mg_review`
  ADD PRIMARY KEY (`review_id`),
  ADD KEY `IDX_MG_REVIEW_ENTITY_ID` (`entity_id`),
  ADD KEY `IDX_MG_REVIEW_STATUS_ID` (`status_id`),
  ADD KEY `IDX_MG_REVIEW_ENTITY_PK_VALUE` (`entity_pk_value`);

--
-- Index pour la table `mg_review_detail`
--
ALTER TABLE `mg_review_detail`
  ADD PRIMARY KEY (`detail_id`),
  ADD KEY `IDX_MG_REVIEW_DETAIL_REVIEW_ID` (`review_id`),
  ADD KEY `IDX_MG_REVIEW_DETAIL_STORE_ID` (`store_id`),
  ADD KEY `IDX_MG_REVIEW_DETAIL_CUSTOMER_ID` (`customer_id`);

--
-- Index pour la table `mg_review_entity`
--
ALTER TABLE `mg_review_entity`
  ADD PRIMARY KEY (`entity_id`);

--
-- Index pour la table `mg_review_entity_summary`
--
ALTER TABLE `mg_review_entity_summary`
  ADD PRIMARY KEY (`primary_id`),
  ADD KEY `IDX_MG_REVIEW_ENTITY_SUMMARY_STORE_ID` (`store_id`);

--
-- Index pour la table `mg_review_status`
--
ALTER TABLE `mg_review_status`
  ADD PRIMARY KEY (`status_id`);

--
-- Index pour la table `mg_review_store`
--
ALTER TABLE `mg_review_store`
  ADD PRIMARY KEY (`review_id`,`store_id`),
  ADD KEY `IDX_MG_REVIEW_STORE_STORE_ID` (`store_id`);

--
-- Index pour la table `mg_salesrule`
--
ALTER TABLE `mg_salesrule`
  ADD PRIMARY KEY (`rule_id`),
  ADD KEY `IDX_MG_SALESRULE_IS_ACTIVE_SORT_ORDER_TO_DATE_FROM_DATE` (`is_active`,`sort_order`,`to_date`,`from_date`);

--
-- Index pour la table `mg_salesrule_coupon`
--
ALTER TABLE `mg_salesrule_coupon`
  ADD PRIMARY KEY (`coupon_id`),
  ADD UNIQUE KEY `UNQ_MG_SALESRULE_COUPON_CODE` (`code`),
  ADD UNIQUE KEY `UNQ_MG_SALESRULE_COUPON_RULE_ID_IS_PRIMARY` (`rule_id`,`is_primary`),
  ADD KEY `IDX_MG_SALESRULE_COUPON_RULE_ID` (`rule_id`);

--
-- Index pour la table `mg_salesrule_coupon_usage`
--
ALTER TABLE `mg_salesrule_coupon_usage`
  ADD PRIMARY KEY (`coupon_id`,`customer_id`),
  ADD KEY `IDX_MG_SALESRULE_COUPON_USAGE_COUPON_ID` (`coupon_id`),
  ADD KEY `IDX_MG_SALESRULE_COUPON_USAGE_CUSTOMER_ID` (`customer_id`);

--
-- Index pour la table `mg_salesrule_customer`
--
ALTER TABLE `mg_salesrule_customer`
  ADD PRIMARY KEY (`rule_customer_id`),
  ADD KEY `IDX_MG_SALESRULE_CUSTOMER_RULE_ID_CUSTOMER_ID` (`rule_id`,`customer_id`),
  ADD KEY `IDX_MG_SALESRULE_CUSTOMER_CUSTOMER_ID_RULE_ID` (`customer_id`,`rule_id`);

--
-- Index pour la table `mg_salesrule_customer_group`
--
ALTER TABLE `mg_salesrule_customer_group`
  ADD PRIMARY KEY (`rule_id`,`customer_group_id`),
  ADD KEY `IDX_MG_SALESRULE_CUSTOMER_GROUP_RULE_ID` (`rule_id`),
  ADD KEY `IDX_MG_SALESRULE_CUSTOMER_GROUP_CUSTOMER_GROUP_ID` (`customer_group_id`);

--
-- Index pour la table `mg_salesrule_label`
--
ALTER TABLE `mg_salesrule_label`
  ADD PRIMARY KEY (`label_id`),
  ADD UNIQUE KEY `UNQ_MG_SALESRULE_LABEL_RULE_ID_STORE_ID` (`rule_id`,`store_id`),
  ADD KEY `IDX_MG_SALESRULE_LABEL_STORE_ID` (`store_id`),
  ADD KEY `IDX_MG_SALESRULE_LABEL_RULE_ID` (`rule_id`);

--
-- Index pour la table `mg_salesrule_product_attribute`
--
ALTER TABLE `mg_salesrule_product_attribute`
  ADD PRIMARY KEY (`rule_id`,`website_id`,`customer_group_id`,`attribute_id`),
  ADD KEY `IDX_MG_SALESRULE_PRODUCT_ATTRIBUTE_WEBSITE_ID` (`website_id`),
  ADD KEY `IDX_MG_SALESRULE_PRODUCT_ATTRIBUTE_CUSTOMER_GROUP_ID` (`customer_group_id`),
  ADD KEY `IDX_MG_SALESRULE_PRODUCT_ATTRIBUTE_ATTRIBUTE_ID` (`attribute_id`);

--
-- Index pour la table `mg_salesrule_website`
--
ALTER TABLE `mg_salesrule_website`
  ADD PRIMARY KEY (`rule_id`,`website_id`),
  ADD KEY `IDX_MG_SALESRULE_WEBSITE_RULE_ID` (`rule_id`),
  ADD KEY `IDX_MG_SALESRULE_WEBSITE_WEBSITE_ID` (`website_id`);

--
-- Index pour la table `mg_sales_bestsellers_aggregated_daily`
--
ALTER TABLE `mg_sales_bestsellers_aggregated_daily`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `UNQ_MG_SALES_BESTSELLERS_AGGRED_DAILY_PERIOD_STORE_ID_PRD_ID` (`period`,`store_id`,`product_id`),
  ADD KEY `IDX_MG_SALES_BESTSELLERS_AGGREGATED_DAILY_STORE_ID` (`store_id`),
  ADD KEY `IDX_MG_SALES_BESTSELLERS_AGGREGATED_DAILY_PRODUCT_ID` (`product_id`);

--
-- Index pour la table `mg_sales_bestsellers_aggregated_monthly`
--
ALTER TABLE `mg_sales_bestsellers_aggregated_monthly`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `UNQ_MG_SALES_BESTSELLERS_AGGRED_MONTHLY_PERIOD_STORE_ID_PRD_ID` (`period`,`store_id`,`product_id`),
  ADD KEY `IDX_MG_SALES_BESTSELLERS_AGGREGATED_MONTHLY_STORE_ID` (`store_id`),
  ADD KEY `IDX_MG_SALES_BESTSELLERS_AGGREGATED_MONTHLY_PRODUCT_ID` (`product_id`);

--
-- Index pour la table `mg_sales_bestsellers_aggregated_yearly`
--
ALTER TABLE `mg_sales_bestsellers_aggregated_yearly`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `UNQ_MG_SALES_BESTSELLERS_AGGRED_YEARLY_PERIOD_STORE_ID_PRD_ID` (`period`,`store_id`,`product_id`),
  ADD KEY `IDX_MG_SALES_BESTSELLERS_AGGREGATED_YEARLY_STORE_ID` (`store_id`),
  ADD KEY `IDX_MG_SALES_BESTSELLERS_AGGREGATED_YEARLY_PRODUCT_ID` (`product_id`);

--
-- Index pour la table `mg_sales_billing_agreement`
--
ALTER TABLE `mg_sales_billing_agreement`
  ADD PRIMARY KEY (`agreement_id`),
  ADD KEY `IDX_MG_SALES_BILLING_AGREEMENT_CUSTOMER_ID` (`customer_id`),
  ADD KEY `IDX_MG_SALES_BILLING_AGREEMENT_STORE_ID` (`store_id`);

--
-- Index pour la table `mg_sales_billing_agreement_order`
--
ALTER TABLE `mg_sales_billing_agreement_order`
  ADD PRIMARY KEY (`agreement_id`,`order_id`),
  ADD KEY `IDX_MG_SALES_BILLING_AGREEMENT_ORDER_ORDER_ID` (`order_id`);

--
-- Index pour la table `mg_sales_flat_creditmemo`
--
ALTER TABLE `mg_sales_flat_creditmemo`
  ADD PRIMARY KEY (`entity_id`),
  ADD UNIQUE KEY `UNQ_MG_SALES_FLAT_CREDITMEMO_INCREMENT_ID` (`increment_id`),
  ADD KEY `IDX_MG_SALES_FLAT_CREDITMEMO_STORE_ID` (`store_id`),
  ADD KEY `IDX_MG_SALES_FLAT_CREDITMEMO_ORDER_ID` (`order_id`),
  ADD KEY `IDX_MG_SALES_FLAT_CREDITMEMO_CREDITMEMO_STATUS` (`creditmemo_status`),
  ADD KEY `IDX_MG_SALES_FLAT_CREDITMEMO_STATE` (`state`),
  ADD KEY `IDX_MG_SALES_FLAT_CREDITMEMO_CREATED_AT` (`created_at`);

--
-- Index pour la table `mg_sales_flat_creditmemo_comment`
--
ALTER TABLE `mg_sales_flat_creditmemo_comment`
  ADD PRIMARY KEY (`entity_id`),
  ADD KEY `IDX_MG_SALES_FLAT_CREDITMEMO_COMMENT_CREATED_AT` (`created_at`),
  ADD KEY `IDX_MG_SALES_FLAT_CREDITMEMO_COMMENT_PARENT_ID` (`parent_id`);

--
-- Index pour la table `mg_sales_flat_creditmemo_grid`
--
ALTER TABLE `mg_sales_flat_creditmemo_grid`
  ADD PRIMARY KEY (`entity_id`),
  ADD UNIQUE KEY `UNQ_MG_SALES_FLAT_CREDITMEMO_GRID_INCREMENT_ID` (`increment_id`),
  ADD KEY `IDX_MG_SALES_FLAT_CREDITMEMO_GRID_STORE_ID` (`store_id`),
  ADD KEY `IDX_MG_SALES_FLAT_CREDITMEMO_GRID_GRAND_TOTAL` (`grand_total`),
  ADD KEY `IDX_MG_SALES_FLAT_CREDITMEMO_GRID_BASE_GRAND_TOTAL` (`base_grand_total`),
  ADD KEY `IDX_MG_SALES_FLAT_CREDITMEMO_GRID_ORDER_ID` (`order_id`),
  ADD KEY `IDX_MG_SALES_FLAT_CREDITMEMO_GRID_CREDITMEMO_STATUS` (`creditmemo_status`),
  ADD KEY `IDX_MG_SALES_FLAT_CREDITMEMO_GRID_STATE` (`state`),
  ADD KEY `IDX_MG_SALES_FLAT_CREDITMEMO_GRID_ORDER_INCREMENT_ID` (`order_increment_id`),
  ADD KEY `IDX_MG_SALES_FLAT_CREDITMEMO_GRID_CREATED_AT` (`created_at`),
  ADD KEY `IDX_MG_SALES_FLAT_CREDITMEMO_GRID_ORDER_CREATED_AT` (`order_created_at`),
  ADD KEY `IDX_MG_SALES_FLAT_CREDITMEMO_GRID_BILLING_NAME` (`billing_name`);

--
-- Index pour la table `mg_sales_flat_creditmemo_item`
--
ALTER TABLE `mg_sales_flat_creditmemo_item`
  ADD PRIMARY KEY (`entity_id`),
  ADD KEY `IDX_MG_SALES_FLAT_CREDITMEMO_ITEM_PARENT_ID` (`parent_id`);

--
-- Index pour la table `mg_sales_flat_invoice`
--
ALTER TABLE `mg_sales_flat_invoice`
  ADD PRIMARY KEY (`entity_id`),
  ADD UNIQUE KEY `UNQ_MG_SALES_FLAT_INVOICE_INCREMENT_ID` (`increment_id`),
  ADD KEY `IDX_MG_SALES_FLAT_INVOICE_STORE_ID` (`store_id`),
  ADD KEY `IDX_MG_SALES_FLAT_INVOICE_GRAND_TOTAL` (`grand_total`),
  ADD KEY `IDX_MG_SALES_FLAT_INVOICE_ORDER_ID` (`order_id`),
  ADD KEY `IDX_MG_SALES_FLAT_INVOICE_STATE` (`state`),
  ADD KEY `IDX_MG_SALES_FLAT_INVOICE_CREATED_AT` (`created_at`);

--
-- Index pour la table `mg_sales_flat_invoice_comment`
--
ALTER TABLE `mg_sales_flat_invoice_comment`
  ADD PRIMARY KEY (`entity_id`),
  ADD KEY `IDX_MG_SALES_FLAT_INVOICE_COMMENT_CREATED_AT` (`created_at`),
  ADD KEY `IDX_MG_SALES_FLAT_INVOICE_COMMENT_PARENT_ID` (`parent_id`);

--
-- Index pour la table `mg_sales_flat_invoice_grid`
--
ALTER TABLE `mg_sales_flat_invoice_grid`
  ADD PRIMARY KEY (`entity_id`),
  ADD UNIQUE KEY `UNQ_MG_SALES_FLAT_INVOICE_GRID_INCREMENT_ID` (`increment_id`),
  ADD KEY `IDX_MG_SALES_FLAT_INVOICE_GRID_STORE_ID` (`store_id`),
  ADD KEY `IDX_MG_SALES_FLAT_INVOICE_GRID_GRAND_TOTAL` (`grand_total`),
  ADD KEY `IDX_MG_SALES_FLAT_INVOICE_GRID_ORDER_ID` (`order_id`),
  ADD KEY `IDX_MG_SALES_FLAT_INVOICE_GRID_STATE` (`state`),
  ADD KEY `IDX_MG_SALES_FLAT_INVOICE_GRID_ORDER_INCREMENT_ID` (`order_increment_id`),
  ADD KEY `IDX_MG_SALES_FLAT_INVOICE_GRID_CREATED_AT` (`created_at`),
  ADD KEY `IDX_MG_SALES_FLAT_INVOICE_GRID_ORDER_CREATED_AT` (`order_created_at`),
  ADD KEY `IDX_MG_SALES_FLAT_INVOICE_GRID_BILLING_NAME` (`billing_name`);

--
-- Index pour la table `mg_sales_flat_invoice_item`
--
ALTER TABLE `mg_sales_flat_invoice_item`
  ADD PRIMARY KEY (`entity_id`),
  ADD KEY `IDX_MG_SALES_FLAT_INVOICE_ITEM_PARENT_ID` (`parent_id`);

--
-- Index pour la table `mg_sales_flat_order`
--
ALTER TABLE `mg_sales_flat_order`
  ADD PRIMARY KEY (`entity_id`),
  ADD UNIQUE KEY `UNQ_MG_SALES_FLAT_ORDER_INCREMENT_ID` (`increment_id`),
  ADD KEY `IDX_MG_SALES_FLAT_ORDER_STATUS` (`status`),
  ADD KEY `IDX_MG_SALES_FLAT_ORDER_STATE` (`state`),
  ADD KEY `IDX_MG_SALES_FLAT_ORDER_STORE_ID` (`store_id`),
  ADD KEY `IDX_MG_SALES_FLAT_ORDER_CREATED_AT` (`created_at`),
  ADD KEY `IDX_MG_SALES_FLAT_ORDER_CUSTOMER_ID` (`customer_id`),
  ADD KEY `IDX_MG_SALES_FLAT_ORDER_EXT_ORDER_ID` (`ext_order_id`),
  ADD KEY `IDX_MG_SALES_FLAT_ORDER_QUOTE_ID` (`quote_id`),
  ADD KEY `IDX_MG_SALES_FLAT_ORDER_UPDATED_AT` (`updated_at`);

--
-- Index pour la table `mg_sales_flat_order_address`
--
ALTER TABLE `mg_sales_flat_order_address`
  ADD PRIMARY KEY (`entity_id`),
  ADD KEY `IDX_MG_SALES_FLAT_ORDER_ADDRESS_PARENT_ID` (`parent_id`);

--
-- Index pour la table `mg_sales_flat_order_grid`
--
ALTER TABLE `mg_sales_flat_order_grid`
  ADD PRIMARY KEY (`entity_id`),
  ADD UNIQUE KEY `UNQ_MG_SALES_FLAT_ORDER_GRID_INCREMENT_ID` (`increment_id`),
  ADD KEY `IDX_MG_SALES_FLAT_ORDER_GRID_STATUS` (`status`),
  ADD KEY `IDX_MG_SALES_FLAT_ORDER_GRID_STORE_ID` (`store_id`),
  ADD KEY `IDX_MG_SALES_FLAT_ORDER_GRID_BASE_GRAND_TOTAL` (`base_grand_total`),
  ADD KEY `IDX_MG_SALES_FLAT_ORDER_GRID_BASE_TOTAL_PAID` (`base_total_paid`),
  ADD KEY `IDX_MG_SALES_FLAT_ORDER_GRID_GRAND_TOTAL` (`grand_total`),
  ADD KEY `IDX_MG_SALES_FLAT_ORDER_GRID_TOTAL_PAID` (`total_paid`),
  ADD KEY `IDX_MG_SALES_FLAT_ORDER_GRID_SHIPPING_NAME` (`shipping_name`),
  ADD KEY `IDX_MG_SALES_FLAT_ORDER_GRID_BILLING_NAME` (`billing_name`),
  ADD KEY `IDX_MG_SALES_FLAT_ORDER_GRID_CREATED_AT` (`created_at`),
  ADD KEY `IDX_MG_SALES_FLAT_ORDER_GRID_CUSTOMER_ID` (`customer_id`),
  ADD KEY `IDX_MG_SALES_FLAT_ORDER_GRID_UPDATED_AT` (`updated_at`);

--
-- Index pour la table `mg_sales_flat_order_item`
--
ALTER TABLE `mg_sales_flat_order_item`
  ADD PRIMARY KEY (`item_id`),
  ADD KEY `IDX_MG_SALES_FLAT_ORDER_ITEM_ORDER_ID` (`order_id`),
  ADD KEY `IDX_MG_SALES_FLAT_ORDER_ITEM_STORE_ID` (`store_id`);

--
-- Index pour la table `mg_sales_flat_order_payment`
--
ALTER TABLE `mg_sales_flat_order_payment`
  ADD PRIMARY KEY (`entity_id`),
  ADD KEY `IDX_MG_SALES_FLAT_ORDER_PAYMENT_PARENT_ID` (`parent_id`);

--
-- Index pour la table `mg_sales_flat_order_status_history`
--
ALTER TABLE `mg_sales_flat_order_status_history`
  ADD PRIMARY KEY (`entity_id`),
  ADD KEY `IDX_MG_SALES_FLAT_ORDER_STATUS_HISTORY_PARENT_ID` (`parent_id`),
  ADD KEY `IDX_MG_SALES_FLAT_ORDER_STATUS_HISTORY_CREATED_AT` (`created_at`);

--
-- Index pour la table `mg_sales_flat_quote`
--
ALTER TABLE `mg_sales_flat_quote`
  ADD PRIMARY KEY (`entity_id`),
  ADD KEY `IDX_MG_SALES_FLAT_QUOTE_CUSTOMER_ID_STORE_ID_IS_ACTIVE` (`customer_id`,`store_id`,`is_active`),
  ADD KEY `IDX_MG_SALES_FLAT_QUOTE_STORE_ID` (`store_id`);

--
-- Index pour la table `mg_sales_flat_quote_address`
--
ALTER TABLE `mg_sales_flat_quote_address`
  ADD PRIMARY KEY (`address_id`),
  ADD KEY `IDX_MG_SALES_FLAT_QUOTE_ADDRESS_QUOTE_ID` (`quote_id`);

--
-- Index pour la table `mg_sales_flat_quote_address_item`
--
ALTER TABLE `mg_sales_flat_quote_address_item`
  ADD PRIMARY KEY (`address_item_id`),
  ADD KEY `IDX_MG_SALES_FLAT_QUOTE_ADDRESS_ITEM_QUOTE_ADDRESS_ID` (`quote_address_id`),
  ADD KEY `IDX_MG_SALES_FLAT_QUOTE_ADDRESS_ITEM_PARENT_ITEM_ID` (`parent_item_id`),
  ADD KEY `IDX_MG_SALES_FLAT_QUOTE_ADDRESS_ITEM_QUOTE_ITEM_ID` (`quote_item_id`);

--
-- Index pour la table `mg_sales_flat_quote_item`
--
ALTER TABLE `mg_sales_flat_quote_item`
  ADD PRIMARY KEY (`item_id`),
  ADD KEY `IDX_MG_SALES_FLAT_QUOTE_ITEM_PARENT_ITEM_ID` (`parent_item_id`),
  ADD KEY `IDX_MG_SALES_FLAT_QUOTE_ITEM_PRODUCT_ID` (`product_id`),
  ADD KEY `IDX_MG_SALES_FLAT_QUOTE_ITEM_QUOTE_ID` (`quote_id`),
  ADD KEY `IDX_MG_SALES_FLAT_QUOTE_ITEM_STORE_ID` (`store_id`);

--
-- Index pour la table `mg_sales_flat_quote_item_option`
--
ALTER TABLE `mg_sales_flat_quote_item_option`
  ADD PRIMARY KEY (`option_id`),
  ADD KEY `IDX_MG_SALES_FLAT_QUOTE_ITEM_OPTION_ITEM_ID` (`item_id`);

--
-- Index pour la table `mg_sales_flat_quote_payment`
--
ALTER TABLE `mg_sales_flat_quote_payment`
  ADD PRIMARY KEY (`payment_id`),
  ADD KEY `IDX_MG_SALES_FLAT_QUOTE_PAYMENT_QUOTE_ID` (`quote_id`);

--
-- Index pour la table `mg_sales_flat_quote_shipping_rate`
--
ALTER TABLE `mg_sales_flat_quote_shipping_rate`
  ADD PRIMARY KEY (`rate_id`),
  ADD KEY `IDX_MG_SALES_FLAT_QUOTE_SHIPPING_RATE_ADDRESS_ID` (`address_id`);

--
-- Index pour la table `mg_sales_flat_shipment`
--
ALTER TABLE `mg_sales_flat_shipment`
  ADD PRIMARY KEY (`entity_id`),
  ADD UNIQUE KEY `UNQ_MG_SALES_FLAT_SHIPMENT_INCREMENT_ID` (`increment_id`),
  ADD KEY `IDX_MG_SALES_FLAT_SHIPMENT_STORE_ID` (`store_id`),
  ADD KEY `IDX_MG_SALES_FLAT_SHIPMENT_TOTAL_QTY` (`total_qty`),
  ADD KEY `IDX_MG_SALES_FLAT_SHIPMENT_ORDER_ID` (`order_id`),
  ADD KEY `IDX_MG_SALES_FLAT_SHIPMENT_CREATED_AT` (`created_at`),
  ADD KEY `IDX_MG_SALES_FLAT_SHIPMENT_UPDATED_AT` (`updated_at`);

--
-- Index pour la table `mg_sales_flat_shipment_comment`
--
ALTER TABLE `mg_sales_flat_shipment_comment`
  ADD PRIMARY KEY (`entity_id`),
  ADD KEY `IDX_MG_SALES_FLAT_SHIPMENT_COMMENT_CREATED_AT` (`created_at`),
  ADD KEY `IDX_MG_SALES_FLAT_SHIPMENT_COMMENT_PARENT_ID` (`parent_id`);

--
-- Index pour la table `mg_sales_flat_shipment_grid`
--
ALTER TABLE `mg_sales_flat_shipment_grid`
  ADD PRIMARY KEY (`entity_id`),
  ADD UNIQUE KEY `UNQ_MG_SALES_FLAT_SHIPMENT_GRID_INCREMENT_ID` (`increment_id`),
  ADD KEY `IDX_MG_SALES_FLAT_SHIPMENT_GRID_STORE_ID` (`store_id`),
  ADD KEY `IDX_MG_SALES_FLAT_SHIPMENT_GRID_TOTAL_QTY` (`total_qty`),
  ADD KEY `IDX_MG_SALES_FLAT_SHIPMENT_GRID_ORDER_ID` (`order_id`),
  ADD KEY `IDX_MG_SALES_FLAT_SHIPMENT_GRID_SHIPMENT_STATUS` (`shipment_status`),
  ADD KEY `IDX_MG_SALES_FLAT_SHIPMENT_GRID_ORDER_INCREMENT_ID` (`order_increment_id`),
  ADD KEY `IDX_MG_SALES_FLAT_SHIPMENT_GRID_CREATED_AT` (`created_at`),
  ADD KEY `IDX_MG_SALES_FLAT_SHIPMENT_GRID_ORDER_CREATED_AT` (`order_created_at`),
  ADD KEY `IDX_MG_SALES_FLAT_SHIPMENT_GRID_SHIPPING_NAME` (`shipping_name`);

--
-- Index pour la table `mg_sales_flat_shipment_item`
--
ALTER TABLE `mg_sales_flat_shipment_item`
  ADD PRIMARY KEY (`entity_id`),
  ADD KEY `IDX_MG_SALES_FLAT_SHIPMENT_ITEM_PARENT_ID` (`parent_id`);

--
-- Index pour la table `mg_sales_flat_shipment_track`
--
ALTER TABLE `mg_sales_flat_shipment_track`
  ADD PRIMARY KEY (`entity_id`),
  ADD KEY `IDX_MG_SALES_FLAT_SHIPMENT_TRACK_PARENT_ID` (`parent_id`),
  ADD KEY `IDX_MG_SALES_FLAT_SHIPMENT_TRACK_ORDER_ID` (`order_id`),
  ADD KEY `IDX_MG_SALES_FLAT_SHIPMENT_TRACK_CREATED_AT` (`created_at`);

--
-- Index pour la table `mg_sales_invoiced_aggregated`
--
ALTER TABLE `mg_sales_invoiced_aggregated`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `UNQ_MG_SALES_INVOICED_AGGREGATED_PERIOD_STORE_ID_ORDER_STATUS` (`period`,`store_id`,`order_status`),
  ADD KEY `IDX_MG_SALES_INVOICED_AGGREGATED_STORE_ID` (`store_id`);

--
-- Index pour la table `mg_sales_invoiced_aggregated_order`
--
ALTER TABLE `mg_sales_invoiced_aggregated_order`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `UNQ_MG_SALES_INVOICED_AGGRED_ORDER_PERIOD_STORE_ID_ORDER_STS` (`period`,`store_id`,`order_status`),
  ADD KEY `IDX_MG_SALES_INVOICED_AGGREGATED_ORDER_STORE_ID` (`store_id`);

--
-- Index pour la table `mg_sales_order_aggregated_created`
--
ALTER TABLE `mg_sales_order_aggregated_created`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `UNQ_MG_SALES_ORDER_AGGRED_CREATED_PERIOD_STORE_ID_ORDER_STS` (`period`,`store_id`,`order_status`),
  ADD KEY `IDX_MG_SALES_ORDER_AGGREGATED_CREATED_STORE_ID` (`store_id`);

--
-- Index pour la table `mg_sales_order_aggregated_updated`
--
ALTER TABLE `mg_sales_order_aggregated_updated`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `UNQ_MG_SALES_ORDER_AGGRED_UPDATED_PERIOD_STORE_ID_ORDER_STS` (`period`,`store_id`,`order_status`),
  ADD KEY `IDX_MG_SALES_ORDER_AGGREGATED_UPDATED_STORE_ID` (`store_id`);

--
-- Index pour la table `mg_sales_order_status`
--
ALTER TABLE `mg_sales_order_status`
  ADD PRIMARY KEY (`status`);

--
-- Index pour la table `mg_sales_order_status_label`
--
ALTER TABLE `mg_sales_order_status_label`
  ADD PRIMARY KEY (`status`,`store_id`),
  ADD KEY `IDX_MG_SALES_ORDER_STATUS_LABEL_STORE_ID` (`store_id`);

--
-- Index pour la table `mg_sales_order_status_state`
--
ALTER TABLE `mg_sales_order_status_state`
  ADD PRIMARY KEY (`status`,`state`);

--
-- Index pour la table `mg_sales_order_tax`
--
ALTER TABLE `mg_sales_order_tax`
  ADD PRIMARY KEY (`tax_id`),
  ADD KEY `IDX_MG_SALES_ORDER_TAX_ORDER_ID_PRIORITY_POSITION` (`order_id`,`priority`,`position`);

--
-- Index pour la table `mg_sales_order_tax_item`
--
ALTER TABLE `mg_sales_order_tax_item`
  ADD PRIMARY KEY (`tax_item_id`),
  ADD UNIQUE KEY `UNQ_MG_SALES_ORDER_TAX_ITEM_TAX_ID_ITEM_ID` (`tax_id`,`item_id`),
  ADD KEY `IDX_MG_SALES_ORDER_TAX_ITEM_TAX_ID` (`tax_id`),
  ADD KEY `IDX_MG_SALES_ORDER_TAX_ITEM_ITEM_ID` (`item_id`);

--
-- Index pour la table `mg_sales_payment_transaction`
--
ALTER TABLE `mg_sales_payment_transaction`
  ADD PRIMARY KEY (`transaction_id`),
  ADD UNIQUE KEY `UNQ_MG_SALES_PAYMENT_TRANSACTION_ORDER_ID_PAYMENT_ID_TXN_ID` (`order_id`,`payment_id`,`txn_id`),
  ADD KEY `IDX_MG_SALES_PAYMENT_TRANSACTION_ORDER_ID` (`order_id`),
  ADD KEY `IDX_MG_SALES_PAYMENT_TRANSACTION_PARENT_ID` (`parent_id`),
  ADD KEY `IDX_MG_SALES_PAYMENT_TRANSACTION_PAYMENT_ID` (`payment_id`);

--
-- Index pour la table `mg_sales_recurring_profile`
--
ALTER TABLE `mg_sales_recurring_profile`
  ADD PRIMARY KEY (`profile_id`),
  ADD UNIQUE KEY `UNQ_MG_SALES_RECURRING_PROFILE_INTERNAL_REFERENCE_ID` (`internal_reference_id`),
  ADD KEY `IDX_MG_SALES_RECURRING_PROFILE_CUSTOMER_ID` (`customer_id`),
  ADD KEY `IDX_MG_SALES_RECURRING_PROFILE_STORE_ID` (`store_id`);

--
-- Index pour la table `mg_sales_recurring_profile_order`
--
ALTER TABLE `mg_sales_recurring_profile_order`
  ADD PRIMARY KEY (`link_id`),
  ADD UNIQUE KEY `UNQ_MG_SALES_RECURRING_PROFILE_ORDER_PROFILE_ID_ORDER_ID` (`profile_id`,`order_id`),
  ADD KEY `IDX_MG_SALES_RECURRING_PROFILE_ORDER_ORDER_ID` (`order_id`);

--
-- Index pour la table `mg_sales_refunded_aggregated`
--
ALTER TABLE `mg_sales_refunded_aggregated`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `UNQ_MG_SALES_REFUNDED_AGGREGATED_PERIOD_STORE_ID_ORDER_STATUS` (`period`,`store_id`,`order_status`),
  ADD KEY `IDX_MG_SALES_REFUNDED_AGGREGATED_STORE_ID` (`store_id`);

--
-- Index pour la table `mg_sales_refunded_aggregated_order`
--
ALTER TABLE `mg_sales_refunded_aggregated_order`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `UNQ_MG_SALES_REFUNDED_AGGRED_ORDER_PERIOD_STORE_ID_ORDER_STS` (`period`,`store_id`,`order_status`),
  ADD KEY `IDX_MG_SALES_REFUNDED_AGGREGATED_ORDER_STORE_ID` (`store_id`);

--
-- Index pour la table `mg_sales_shipping_aggregated`
--
ALTER TABLE `mg_sales_shipping_aggregated`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `01510D7BAD92162CADEDC6961AC1B60A` (`period`,`store_id`,`order_status`,`shipping_description`),
  ADD KEY `IDX_MG_SALES_SHIPPING_AGGREGATED_STORE_ID` (`store_id`);

--
-- Index pour la table `mg_sales_shipping_aggregated_order`
--
ALTER TABLE `mg_sales_shipping_aggregated_order`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `2F05DEC97D704DCC8AAEA9140E6202CF` (`period`,`store_id`,`order_status`,`shipping_description`),
  ADD KEY `IDX_MG_SALES_SHIPPING_AGGREGATED_ORDER_STORE_ID` (`store_id`);

--
-- Index pour la table `mg_sendfriend_log`
--
ALTER TABLE `mg_sendfriend_log`
  ADD PRIMARY KEY (`log_id`),
  ADD KEY `IDX_MG_SENDFRIEND_LOG_IP` (`ip`),
  ADD KEY `IDX_MG_SENDFRIEND_LOG_TIME` (`time`);

--
-- Index pour la table `mg_shipping_tablerate`
--
ALTER TABLE `mg_shipping_tablerate`
  ADD PRIMARY KEY (`pk`),
  ADD UNIQUE KEY `24C5BFAC7AC50711F0FDC69DF46D7286` (`website_id`,`dest_country_id`,`dest_region_id`,`dest_zip`,`condition_name`,`condition_value`);

--
-- Index pour la table `mg_sitemap`
--
ALTER TABLE `mg_sitemap`
  ADD PRIMARY KEY (`sitemap_id`),
  ADD KEY `IDX_MG_SITEMAP_STORE_ID` (`store_id`);

--
-- Index pour la table `mg_tag`
--
ALTER TABLE `mg_tag`
  ADD PRIMARY KEY (`tag_id`),
  ADD KEY `FK_MG_TAG_FIRST_CUSTOMER_ID_MG_CUSTOMER_ENTITY_ENTITY_ID` (`first_customer_id`),
  ADD KEY `FK_MG_TAG_FIRST_STORE_ID_MG_CORE_STORE_STORE_ID` (`first_store_id`);

--
-- Index pour la table `mg_tag_properties`
--
ALTER TABLE `mg_tag_properties`
  ADD PRIMARY KEY (`tag_id`,`store_id`),
  ADD KEY `IDX_MG_TAG_PROPERTIES_STORE_ID` (`store_id`);

--
-- Index pour la table `mg_tag_relation`
--
ALTER TABLE `mg_tag_relation`
  ADD PRIMARY KEY (`tag_relation_id`),
  ADD UNIQUE KEY `UNQ_MG_TAG_RELATION_TAG_ID_CUSTOMER_ID_PRODUCT_ID_STORE_ID` (`tag_id`,`customer_id`,`product_id`,`store_id`),
  ADD KEY `IDX_MG_TAG_RELATION_PRODUCT_ID` (`product_id`),
  ADD KEY `IDX_MG_TAG_RELATION_TAG_ID` (`tag_id`),
  ADD KEY `IDX_MG_TAG_RELATION_CUSTOMER_ID` (`customer_id`),
  ADD KEY `IDX_MG_TAG_RELATION_STORE_ID` (`store_id`);

--
-- Index pour la table `mg_tag_summary`
--
ALTER TABLE `mg_tag_summary`
  ADD PRIMARY KEY (`tag_id`,`store_id`),
  ADD KEY `IDX_MG_TAG_SUMMARY_STORE_ID` (`store_id`),
  ADD KEY `IDX_MG_TAG_SUMMARY_TAG_ID` (`tag_id`);

--
-- Index pour la table `mg_tax_calculation`
--
ALTER TABLE `mg_tax_calculation`
  ADD PRIMARY KEY (`tax_calculation_id`),
  ADD KEY `IDX_MG_TAX_CALCULATION_TAX_CALCULATION_RULE_ID` (`tax_calculation_rule_id`),
  ADD KEY `IDX_MG_TAX_CALCULATION_TAX_CALCULATION_RATE_ID` (`tax_calculation_rate_id`),
  ADD KEY `IDX_MG_TAX_CALCULATION_CUSTOMER_TAX_CLASS_ID` (`customer_tax_class_id`),
  ADD KEY `IDX_MG_TAX_CALCULATION_PRODUCT_TAX_CLASS_ID` (`product_tax_class_id`),
  ADD KEY `D41E1E1C7864EE3C619CFC0240A91E8D` (`tax_calculation_rate_id`,`customer_tax_class_id`,`product_tax_class_id`);

--
-- Index pour la table `mg_tax_calculation_rate`
--
ALTER TABLE `mg_tax_calculation_rate`
  ADD PRIMARY KEY (`tax_calculation_rate_id`),
  ADD KEY `IDX_MG_TAX_CALC_RATE_TAX_COUNTRY_ID_TAX_REGION_ID_TAX_POSTCODE` (`tax_country_id`,`tax_region_id`,`tax_postcode`),
  ADD KEY `IDX_MG_TAX_CALCULATION_RATE_CODE` (`code`),
  ADD KEY `CCA86D7F60DE4DB9AA7FE619BA73E321` (`tax_calculation_rate_id`,`tax_country_id`,`tax_region_id`,`zip_is_range`,`tax_postcode`);

--
-- Index pour la table `mg_tax_calculation_rate_title`
--
ALTER TABLE `mg_tax_calculation_rate_title`
  ADD PRIMARY KEY (`tax_calculation_rate_title_id`),
  ADD KEY `IDX_MG_TAX_CALC_RATE_TTL_TAX_CALC_RATE_ID_STORE_ID` (`tax_calculation_rate_id`,`store_id`),
  ADD KEY `IDX_MG_TAX_CALCULATION_RATE_TITLE_TAX_CALCULATION_RATE_ID` (`tax_calculation_rate_id`),
  ADD KEY `IDX_MG_TAX_CALCULATION_RATE_TITLE_STORE_ID` (`store_id`);

--
-- Index pour la table `mg_tax_calculation_rule`
--
ALTER TABLE `mg_tax_calculation_rule`
  ADD PRIMARY KEY (`tax_calculation_rule_id`),
  ADD KEY `IDX_MG_TAX_CALC_RULE_PRIORITY_POSITION_TAX_CALC_RULE_ID` (`priority`,`position`,`tax_calculation_rule_id`),
  ADD KEY `IDX_MG_TAX_CALCULATION_RULE_CODE` (`code`);

--
-- Index pour la table `mg_tax_class`
--
ALTER TABLE `mg_tax_class`
  ADD PRIMARY KEY (`class_id`);

--
-- Index pour la table `mg_tax_order_aggregated_created`
--
ALTER TABLE `mg_tax_order_aggregated_created`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `8B6479C64CB72174486393DFC6709D0D` (`period`,`store_id`,`code`,`percent`,`order_status`),
  ADD KEY `IDX_MG_TAX_ORDER_AGGREGATED_CREATED_STORE_ID` (`store_id`);

--
-- Index pour la table `mg_tax_order_aggregated_updated`
--
ALTER TABLE `mg_tax_order_aggregated_updated`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `BC3FBF6C5EAB506C2B2655E6F079B2F2` (`period`,`store_id`,`code`,`percent`,`order_status`),
  ADD KEY `IDX_MG_TAX_ORDER_AGGREGATED_UPDATED_STORE_ID` (`store_id`);

--
-- Index pour la table `mg_weee_discount`
--
ALTER TABLE `mg_weee_discount`
  ADD KEY `IDX_MG_WEEE_DISCOUNT_WEBSITE_ID` (`website_id`),
  ADD KEY `IDX_MG_WEEE_DISCOUNT_ENTITY_ID` (`entity_id`),
  ADD KEY `IDX_MG_WEEE_DISCOUNT_CUSTOMER_GROUP_ID` (`customer_group_id`);

--
-- Index pour la table `mg_weee_tax`
--
ALTER TABLE `mg_weee_tax`
  ADD PRIMARY KEY (`value_id`),
  ADD KEY `IDX_MG_WEEE_TAX_WEBSITE_ID` (`website_id`),
  ADD KEY `IDX_MG_WEEE_TAX_ENTITY_ID` (`entity_id`),
  ADD KEY `IDX_MG_WEEE_TAX_COUNTRY` (`country`),
  ADD KEY `IDX_MG_WEEE_TAX_ATTRIBUTE_ID` (`attribute_id`);

--
-- Index pour la table `mg_widget`
--
ALTER TABLE `mg_widget`
  ADD PRIMARY KEY (`widget_id`),
  ADD KEY `IDX_MG_WIDGET_WIDGET_CODE` (`widget_code`);

--
-- Index pour la table `mg_widget_instance`
--
ALTER TABLE `mg_widget_instance`
  ADD PRIMARY KEY (`instance_id`);

--
-- Index pour la table `mg_widget_instance_page`
--
ALTER TABLE `mg_widget_instance_page`
  ADD PRIMARY KEY (`page_id`),
  ADD KEY `IDX_MG_WIDGET_INSTANCE_PAGE_INSTANCE_ID` (`instance_id`);

--
-- Index pour la table `mg_widget_instance_page_layout`
--
ALTER TABLE `mg_widget_instance_page_layout`
  ADD UNIQUE KEY `UNQ_MG_WIDGET_INSTANCE_PAGE_LAYOUT_LAYOUT_UPDATE_ID_PAGE_ID` (`layout_update_id`,`page_id`),
  ADD KEY `IDX_MG_WIDGET_INSTANCE_PAGE_LAYOUT_PAGE_ID` (`page_id`),
  ADD KEY `IDX_MG_WIDGET_INSTANCE_PAGE_LAYOUT_LAYOUT_UPDATE_ID` (`layout_update_id`);

--
-- Index pour la table `mg_wishlist`
--
ALTER TABLE `mg_wishlist`
  ADD PRIMARY KEY (`wishlist_id`),
  ADD UNIQUE KEY `UNQ_MG_WISHLIST_CUSTOMER_ID` (`customer_id`),
  ADD KEY `IDX_MG_WISHLIST_SHARED` (`shared`);

--
-- Index pour la table `mg_wishlist_item`
--
ALTER TABLE `mg_wishlist_item`
  ADD PRIMARY KEY (`wishlist_item_id`),
  ADD KEY `IDX_MG_WISHLIST_ITEM_WISHLIST_ID` (`wishlist_id`),
  ADD KEY `IDX_MG_WISHLIST_ITEM_PRODUCT_ID` (`product_id`),
  ADD KEY `IDX_MG_WISHLIST_ITEM_STORE_ID` (`store_id`);

--
-- Index pour la table `mg_wishlist_item_option`
--
ALTER TABLE `mg_wishlist_item_option`
  ADD PRIMARY KEY (`option_id`),
  ADD KEY `FK_52740CF0FD0849C46ABC912037133550` (`wishlist_item_id`);
...
--
-- AUTO_INCREMENT pour la table `mg_catalog_product_link_attribute_decimal`
--
ALTER TABLE `mg_catalog_product_link_attribute_decimal`
  MODIFY `value_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Value ID';
--
-- AUTO_INCREMENT pour la table `mg_catalog_product_link_attribute_int`
--
ALTER TABLE `mg_catalog_product_link_attribute_int`
  MODIFY `value_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Value ID';
--
-- AUTO_INCREMENT pour la table `mg_catalog_product_link_attribute_varchar`
--
ALTER TABLE `mg_catalog_product_link_attribute_varchar`
  MODIFY `value_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Value ID';
--
-- AUTO_INCREMENT pour la table `mg_catalog_product_link_type`
--
ALTER TABLE `mg_catalog_product_link_type`
  MODIFY `link_type_id` smallint(5) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Link Type ID',AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT pour la table `mg_catalog_product_option`
--
ALTER TABLE `mg_catalog_product_option`
  MODIFY `option_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Option ID';
--
-- AUTO_INCREMENT pour la table `mg_catalog_product_option_price`
--
ALTER TABLE `mg_catalog_product_option_price`
  MODIFY `option_price_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Option Price ID';
--
-- AUTO_INCREMENT pour la table `mg_catalog_product_option_title`
--
ALTER TABLE `mg_catalog_product_option_title`
  MODIFY `option_title_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Option Title ID';
--
-- AUTO_INCREMENT pour la table `mg_catalog_product_option_type_price`
--
ALTER TABLE `mg_catalog_product_option_type_price`
  MODIFY `option_type_price_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Option Type Price ID';
--
-- AUTO_INCREMENT pour la table `mg_catalog_product_option_type_title`
--
ALTER TABLE `mg_catalog_product_option_type_title`
  MODIFY `option_type_title_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Option Type Title ID';
--
-- AUTO_INCREMENT pour la table `mg_catalog_product_option_type_value`
--
ALTER TABLE `mg_catalog_product_option_type_value`
  MODIFY `option_type_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Option Type ID';
--
-- AUTO_INCREMENT pour la table `mg_catalog_product_super_attribute`
--
ALTER TABLE `mg_catalog_product_super_attribute`
  MODIFY `product_super_attribute_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Product Super Attribute ID';
--
-- AUTO_INCREMENT pour la table `mg_catalog_product_super_attribute_label`
--
ALTER TABLE `mg_catalog_product_super_attribute_label`
  MODIFY `value_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Value ID';
--
-- AUTO_INCREMENT pour la table `mg_catalog_product_super_attribute_pricing`
--
ALTER TABLE `mg_catalog_product_super_attribute_pricing`
  MODIFY `value_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Value ID';
--
-- AUTO_INCREMENT pour la table `mg_catalog_product_super_link`
--
ALTER TABLE `mg_catalog_product_super_link`
  MODIFY `link_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Link ID';
--
-- AUTO_INCREMENT pour la table `mg_checkout_agreement`
--
ALTER TABLE `mg_checkout_agreement`
  MODIFY `agreement_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Agreement Id';
--
-- AUTO_INCREMENT pour la table `mg_cms_block`
--
ALTER TABLE `mg_cms_block`
  MODIFY `block_id` smallint(6) NOT NULL AUTO_INCREMENT COMMENT 'Block ID',AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT pour la table `mg_cms_page`
--
ALTER TABLE `mg_cms_page`
  MODIFY `page_id` smallint(6) NOT NULL AUTO_INCREMENT COMMENT 'Page ID',AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT pour la table `mg_core_config_data`
--
ALTER TABLE `mg_core_config_data`
  MODIFY `config_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Config Id',AUTO_INCREMENT=158;
--
-- AUTO_INCREMENT pour la table `mg_core_email_queue`
--
ALTER TABLE `mg_core_email_queue`
  MODIFY `message_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Message Id',AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT pour la table `mg_core_email_queue_recipients`
--
ALTER TABLE `mg_core_email_queue_recipients`
  MODIFY `recipient_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Recipient Id',AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT pour la table `mg_core_email_template`
--
ALTER TABLE `mg_core_email_template`
  MODIFY `template_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Template Id';
--
-- AUTO_INCREMENT pour la table `mg_core_flag`
--
ALTER TABLE `mg_core_flag`
  MODIFY `flag_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Flag Id',AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT pour la table `mg_core_layout_link`
--
ALTER TABLE `mg_core_layout_link`
  MODIFY `layout_link_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Link Id';
--
-- AUTO_INCREMENT pour la table `mg_core_layout_update`
--
ALTER TABLE `mg_core_layout_update`
  MODIFY `layout_update_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Layout Update Id';
--
-- AUTO_INCREMENT pour la table `mg_core_store`
--
ALTER TABLE `mg_core_store`
  MODIFY `store_id` smallint(5) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Store Id',AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT pour la table `mg_core_store_group`
--
ALTER TABLE `mg_core_store_group`
  MODIFY `group_id` smallint(5) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Group Id',AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT pour la table `mg_core_translate`
--
ALTER TABLE `mg_core_translate`
  MODIFY `key_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Key Id of Translation';
--
-- AUTO_INCREMENT pour la table `mg_core_url_rewrite`
--
ALTER TABLE `mg_core_url_rewrite`
  MODIFY `url_rewrite_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Rewrite Id',AUTO_INCREMENT=13;
--
-- AUTO_INCREMENT pour la table `mg_core_variable`
--
ALTER TABLE `mg_core_variable`
  MODIFY `variable_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Variable Id';
--
-- AUTO_INCREMENT pour la table `mg_core_variable_value`
--
ALTER TABLE `mg_core_variable_value`
  MODIFY `value_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Variable Value Id';
--
-- AUTO_INCREMENT pour la table `mg_core_website`
--
ALTER TABLE `mg_core_website`
  MODIFY `website_id` smallint(5) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Website Id',AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT pour la table `mg_coupon_aggregated`
--
ALTER TABLE `mg_coupon_aggregated`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Id';
--
-- AUTO_INCREMENT pour la table `mg_coupon_aggregated_order`
--
ALTER TABLE `mg_coupon_aggregated_order`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Id';
--
-- AUTO_INCREMENT pour la table `mg_coupon_aggregated_updated`
--
ALTER TABLE `mg_coupon_aggregated_updated`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Id';
--
-- AUTO_INCREMENT pour la table `mg_cron_schedule`
--
ALTER TABLE `mg_cron_schedule`
  MODIFY `schedule_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Schedule Id';
--
-- AUTO_INCREMENT pour la table `mg_customer_address_entity`
--
ALTER TABLE `mg_customer_address_entity`
  MODIFY `entity_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity Id';
--
-- AUTO_INCREMENT pour la table `mg_customer_address_entity_datetime`
--
ALTER TABLE `mg_customer_address_entity_datetime`
  MODIFY `value_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Value Id';
--
-- AUTO_INCREMENT pour la table `mg_customer_address_entity_decimal`
--
ALTER TABLE `mg_customer_address_entity_decimal`
  MODIFY `value_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Value Id';
--
-- AUTO_INCREMENT pour la table `mg_customer_address_entity_int`
--
ALTER TABLE `mg_customer_address_entity_int`
  MODIFY `value_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Value Id';
--
-- AUTO_INCREMENT pour la table `mg_customer_address_entity_text`
--
ALTER TABLE `mg_customer_address_entity_text`
  MODIFY `value_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Value Id';
--
-- AUTO_INCREMENT pour la table `mg_customer_address_entity_varchar`
--
ALTER TABLE `mg_customer_address_entity_varchar`
  MODIFY `value_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Value Id';
--
-- AUTO_INCREMENT pour la table `mg_customer_entity`
--
ALTER TABLE `mg_customer_entity`
  MODIFY `entity_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity Id';
--
-- AUTO_INCREMENT pour la table `mg_customer_entity_datetime`
--
ALTER TABLE `mg_customer_entity_datetime`
  MODIFY `value_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Value Id';
--
-- AUTO_INCREMENT pour la table `mg_customer_entity_decimal`
--
ALTER TABLE `mg_customer_entity_decimal`
  MODIFY `value_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Value Id';
--
-- AUTO_INCREMENT pour la table `mg_customer_entity_int`
--
ALTER TABLE `mg_customer_entity_int`
  MODIFY `value_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Value Id';
--
-- AUTO_INCREMENT pour la table `mg_customer_entity_text`
--
ALTER TABLE `mg_customer_entity_text`
  MODIFY `value_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Value Id';
--
-- AUTO_INCREMENT pour la table `mg_customer_entity_varchar`
--
ALTER TABLE `mg_customer_entity_varchar`
  MODIFY `value_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Value Id';
--
-- AUTO_INCREMENT pour la table `mg_customer_flowpassword`
--
ALTER TABLE `mg_customer_flowpassword`
  MODIFY `flowpassword_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Flow password Id';
--
-- AUTO_INCREMENT pour la table `mg_customer_group`
--
ALTER TABLE `mg_customer_group`
  MODIFY `customer_group_id` smallint(5) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Customer Group Id',AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT pour la table `mg_dataflow_batch`
--
ALTER TABLE `mg_dataflow_batch`
  MODIFY `batch_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Batch Id';
--
-- AUTO_INCREMENT pour la table `mg_dataflow_batch_export`
--
ALTER TABLE `mg_dataflow_batch_export`
  MODIFY `batch_export_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Batch Export Id';
--
-- AUTO_INCREMENT pour la table `mg_dataflow_batch_import`
--
ALTER TABLE `mg_dataflow_batch_import`
  MODIFY `batch_import_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Batch Import Id';
--
-- AUTO_INCREMENT pour la table `mg_dataflow_import_data`
--
ALTER TABLE `mg_dataflow_import_data`
  MODIFY `import_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Import Id';
--
-- AUTO_INCREMENT pour la table `mg_dataflow_profile`
--
ALTER TABLE `mg_dataflow_profile`
  MODIFY `profile_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Profile Id',AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT pour la table `mg_dataflow_profile_history`
--
ALTER TABLE `mg_dataflow_profile_history`
  MODIFY `history_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'History Id',AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT pour la table `mg_dataflow_session`
--
ALTER TABLE `mg_dataflow_session`
  MODIFY `session_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Session Id';
--
-- AUTO_INCREMENT pour la table `mg_design_change`
--
ALTER TABLE `mg_design_change`
  MODIFY `design_change_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Design Change Id';
--
-- AUTO_INCREMENT pour la table `mg_directory_country_format`
--
ALTER TABLE `mg_directory_country_format`
  MODIFY `country_format_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Country Format Id';
--
-- AUTO_INCREMENT pour la table `mg_directory_country_region`
--
ALTER TABLE `mg_directory_country_region`
  MODIFY `region_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Region Id',AUTO_INCREMENT=485;
--
-- AUTO_INCREMENT pour la table `mg_downloadable_link`
--
ALTER TABLE `mg_downloadable_link`
  MODIFY `link_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Link ID';
--
-- AUTO_INCREMENT pour la table `mg_downloadable_link_price`
--
ALTER TABLE `mg_downloadable_link_price`
  MODIFY `price_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Price ID';
--
-- AUTO_INCREMENT pour la table `mg_downloadable_link_purchased`
--
ALTER TABLE `mg_downloadable_link_purchased`
  MODIFY `purchased_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Purchased ID';
--
-- AUTO_INCREMENT pour la table `mg_downloadable_link_purchased_item`
--
ALTER TABLE `mg_downloadable_link_purchased_item`
  MODIFY `item_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Item ID';
--
-- AUTO_INCREMENT pour la table `mg_downloadable_link_title`
--
ALTER TABLE `mg_downloadable_link_title`
  MODIFY `title_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Title ID';
--
-- AUTO_INCREMENT pour la table `mg_downloadable_sample`
--
ALTER TABLE `mg_downloadable_sample`
  MODIFY `sample_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Sample ID';
--
-- AUTO_INCREMENT pour la table `mg_downloadable_sample_title`
--
ALTER TABLE `mg_downloadable_sample_title`
  MODIFY `title_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Title ID';
--
-- AUTO_INCREMENT pour la table `mg_eav_attribute`
--
ALTER TABLE `mg_eav_attribute`
  MODIFY `attribute_id` smallint(5) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Attribute Id',AUTO_INCREMENT=132;
--
-- AUTO_INCREMENT pour la table `mg_eav_attribute_group`
--
ALTER TABLE `mg_eav_attribute_group`
  MODIFY `attribute_group_id` smallint(5) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Attribute Group Id',AUTO_INCREMENT=18;
--
-- AUTO_INCREMENT pour la table `mg_eav_attribute_label`
--
ALTER TABLE `mg_eav_attribute_label`
  MODIFY `attribute_label_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Attribute Label Id';
--
-- AUTO_INCREMENT pour la table `mg_eav_attribute_option`
--
ALTER TABLE `mg_eav_attribute_option`
  MODIFY `option_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Option Id',AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT pour la table `mg_eav_attribute_option_value`
--
ALTER TABLE `mg_eav_attribute_option_value`
  MODIFY `value_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Value Id',AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT pour la table `mg_eav_attribute_set`
--
ALTER TABLE `mg_eav_attribute_set`
  MODIFY `attribute_set_id` smallint(5) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Attribute Set Id',AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT pour la table `mg_eav_entity`
--
ALTER TABLE `mg_eav_entity`
  MODIFY `entity_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity Id';
--
-- AUTO_INCREMENT pour la table `mg_eav_entity_attribute`
--
ALTER TABLE `mg_eav_entity_attribute`
  MODIFY `entity_attribute_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity Attribute Id',AUTO_INCREMENT=130;
--
-- AUTO_INCREMENT pour la table `mg_eav_entity_datetime`
--
ALTER TABLE `mg_eav_entity_datetime`
  MODIFY `value_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Value Id';
--
-- AUTO_INCREMENT pour la table `mg_eav_entity_decimal`
--
ALTER TABLE `mg_eav_entity_decimal`
  MODIFY `value_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Value Id';
--
-- AUTO_INCREMENT pour la table `mg_eav_entity_int`
--
ALTER TABLE `mg_eav_entity_int`
  MODIFY `value_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Value Id';
--
-- AUTO_INCREMENT pour la table `mg_eav_entity_store`
--
ALTER TABLE `mg_eav_entity_store`
  MODIFY `entity_store_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity Store Id',AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT pour la table `mg_eav_entity_text`
--
ALTER TABLE `mg_eav_entity_text`
  MODIFY `value_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Value Id';
--
-- AUTO_INCREMENT pour la table `mg_eav_entity_type`
--
ALTER TABLE `mg_eav_entity_type`
  MODIFY `entity_type_id` smallint(5) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity Type Id',AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT pour la table `mg_eav_entity_varchar`
--
ALTER TABLE `mg_eav_entity_varchar`
  MODIFY `value_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Value Id';
--
-- AUTO_INCREMENT pour la table `mg_eav_form_element`
--
ALTER TABLE `mg_eav_form_element`
  MODIFY `element_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Element Id',AUTO_INCREMENT=58;
--
-- AUTO_INCREMENT pour la table `mg_eav_form_fieldset`
--
ALTER TABLE `mg_eav_form_fieldset`
  MODIFY `fieldset_id` smallint(5) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Fieldset Id',AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT pour la table `mg_eav_form_type`
--
ALTER TABLE `mg_eav_form_type`
  MODIFY `type_id` smallint(5) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Type Id',AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT pour la table `mg_gift_message`
--
ALTER TABLE `mg_gift_message`
  MODIFY `gift_message_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'GiftMessage Id';
--
-- AUTO_INCREMENT pour la table `mg_importexport_importdata`
--
ALTER TABLE `mg_importexport_importdata`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Id';
--
-- AUTO_INCREMENT pour la table `mg_index_event`
--
ALTER TABLE `mg_index_event`
  MODIFY `event_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Event Id',AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT pour la table `mg_index_process`
--
ALTER TABLE `mg_index_process`
  MODIFY `process_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Process Id',AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT pour la table `mg_learning_slider_slide`
--
ALTER TABLE `mg_learning_slider_slide`
  MODIFY `entity_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity_id',AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT pour la table `mg_log_customer`
--
ALTER TABLE `mg_log_customer`
  MODIFY `log_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Log ID';
--
-- AUTO_INCREMENT pour la table `mg_log_summary`
--
ALTER TABLE `mg_log_summary`
  MODIFY `summary_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Summary ID';
--
-- AUTO_INCREMENT pour la table `mg_log_summary_type`
--
ALTER TABLE `mg_log_summary_type`
  MODIFY `type_id` smallint(5) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Type ID',AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT pour la table `mg_log_url_info`
--
ALTER TABLE `mg_log_url_info`
  MODIFY `url_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT 'URL ID';
--
-- AUTO_INCREMENT pour la table `mg_log_visitor`
--
ALTER TABLE `mg_log_visitor`
  MODIFY `visitor_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Visitor ID',AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT pour la table `mg_log_visitor_online`
--
ALTER TABLE `mg_log_visitor_online`
  MODIFY `visitor_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Visitor ID';
--
-- AUTO_INCREMENT pour la table `mg_newsletter_problem`
--
ALTER TABLE `mg_newsletter_problem`
  MODIFY `problem_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Problem Id';
--
-- AUTO_INCREMENT pour la table `mg_newsletter_queue`
--
ALTER TABLE `mg_newsletter_queue`
  MODIFY `queue_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Queue Id';
--
-- AUTO_INCREMENT pour la table `mg_newsletter_queue_link`
--
ALTER TABLE `mg_newsletter_queue_link`
  MODIFY `queue_link_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Queue Link Id';
--
-- AUTO_INCREMENT pour la table `mg_newsletter_subscriber`
--
ALTER TABLE `mg_newsletter_subscriber`
  MODIFY `subscriber_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Subscriber Id';
--
-- AUTO_INCREMENT pour la table `mg_newsletter_template`
--
ALTER TABLE `mg_newsletter_template`
  MODIFY `template_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Template Id',AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT pour la table `mg_oauth_consumer`
--
ALTER TABLE `mg_oauth_consumer`
  MODIFY `entity_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity Id';
--
-- AUTO_INCREMENT pour la table `mg_oauth_token`
--
ALTER TABLE `mg_oauth_token`
  MODIFY `entity_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity ID';
--
-- AUTO_INCREMENT pour la table `mg_paypal_cert`
--
ALTER TABLE `mg_paypal_cert`
  MODIFY `cert_id` smallint(5) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Cert Id';
--
-- AUTO_INCREMENT pour la table `mg_paypal_payment_transaction`
--
ALTER TABLE `mg_paypal_payment_transaction`
  MODIFY `transaction_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity Id';
--
-- AUTO_INCREMENT pour la table `mg_paypal_settlement_report`
--
ALTER TABLE `mg_paypal_settlement_report`
  MODIFY `report_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Report Id';
--
-- AUTO_INCREMENT pour la table `mg_paypal_settlement_report_row`
--
ALTER TABLE `mg_paypal_settlement_report_row`
  MODIFY `row_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Row Id';
--
-- AUTO_INCREMENT pour la table `mg_permission_block`
--
ALTER TABLE `mg_permission_block`
  MODIFY `block_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Block ID',AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT pour la table `mg_permission_variable`
--
ALTER TABLE `mg_permission_variable`
  MODIFY `variable_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Variable ID',AUTO_INCREMENT=16;
--
-- AUTO_INCREMENT pour la table `mg_persistent_session`
--
ALTER TABLE `mg_persistent_session`
  MODIFY `persistent_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Session id';
--
-- AUTO_INCREMENT pour la table `mg_poll`
--
ALTER TABLE `mg_poll`
  MODIFY `poll_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Poll Id',AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT pour la table `mg_poll_answer`
--
ALTER TABLE `mg_poll_answer`
  MODIFY `answer_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Answer Id',AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT pour la table `mg_poll_vote`
--
ALTER TABLE `mg_poll_vote`
  MODIFY `vote_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Vote Id',AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT pour la table `mg_product_alert_price`
--
ALTER TABLE `mg_product_alert_price`
  MODIFY `alert_price_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Product alert price id';
--
-- AUTO_INCREMENT pour la table `mg_product_alert_stock`
--
ALTER TABLE `mg_product_alert_stock`
  MODIFY `alert_stock_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Product alert stock id';
--
-- AUTO_INCREMENT pour la table `mg_rating`
--
ALTER TABLE `mg_rating`
  MODIFY `rating_id` smallint(5) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Rating Id',AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT pour la table `mg_rating_entity`
--
ALTER TABLE `mg_rating_entity`
  MODIFY `entity_id` smallint(5) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity Id',AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT pour la table `mg_rating_option`
--
ALTER TABLE `mg_rating_option`
  MODIFY `option_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Rating Option Id',AUTO_INCREMENT=16;
--
-- AUTO_INCREMENT pour la table `mg_rating_option_vote`
--
ALTER TABLE `mg_rating_option_vote`
  MODIFY `vote_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Vote id';
--
-- AUTO_INCREMENT pour la table `mg_rating_option_vote_aggregated`
--
ALTER TABLE `mg_rating_option_vote_aggregated`
  MODIFY `primary_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Vote aggregation id';
--
-- AUTO_INCREMENT pour la table `mg_report_compared_product_index`
--
ALTER TABLE `mg_report_compared_product_index`
  MODIFY `index_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Index Id';
--
-- AUTO_INCREMENT pour la table `mg_report_event`
--
ALTER TABLE `mg_report_event`
  MODIFY `event_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Event Id',AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT pour la table `mg_report_event_types`
--
ALTER TABLE `mg_report_event_types`
  MODIFY `event_type_id` smallint(5) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Event Type Id',AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT pour la table `mg_report_viewed_product_aggregated_daily`
--
ALTER TABLE `mg_report_viewed_product_aggregated_daily`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Id';
--
-- AUTO_INCREMENT pour la table `mg_report_viewed_product_aggregated_monthly`
--
ALTER TABLE `mg_report_viewed_product_aggregated_monthly`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Id';
--
-- AUTO_INCREMENT pour la table `mg_report_viewed_product_aggregated_yearly`
--
ALTER TABLE `mg_report_viewed_product_aggregated_yearly`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Id';
--
-- AUTO_INCREMENT pour la table `mg_report_viewed_product_index`
--
ALTER TABLE `mg_report_viewed_product_index`
  MODIFY `index_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Index Id';
--
-- AUTO_INCREMENT pour la table `mg_review`
--
ALTER TABLE `mg_review`
  MODIFY `review_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Review id';
--
-- AUTO_INCREMENT pour la table `mg_review_detail`
--
ALTER TABLE `mg_review_detail`
  MODIFY `detail_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Review detail id';
--
-- AUTO_INCREMENT pour la table `mg_review_entity`
--
ALTER TABLE `mg_review_entity`
  MODIFY `entity_id` smallint(5) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Review entity id',AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT pour la table `mg_review_entity_summary`
--
ALTER TABLE `mg_review_entity_summary`
  MODIFY `primary_id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'Summary review entity id';
--
-- AUTO_INCREMENT pour la table `mg_review_status`
--
ALTER TABLE `mg_review_status`
  MODIFY `status_id` smallint(5) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Status id',AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT pour la table `mg_salesrule`
--
ALTER TABLE `mg_salesrule`
  MODIFY `rule_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Rule Id';
--
-- AUTO_INCREMENT pour la table `mg_salesrule_coupon`
--
ALTER TABLE `mg_salesrule_coupon`
  MODIFY `coupon_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Coupon Id';
--
-- AUTO_INCREMENT pour la table `mg_salesrule_customer`
--
ALTER TABLE `mg_salesrule_customer`
  MODIFY `rule_customer_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Rule Customer Id';
--
-- AUTO_INCREMENT pour la table `mg_salesrule_label`
--
ALTER TABLE `mg_salesrule_label`
  MODIFY `label_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Label Id';
--
-- AUTO_INCREMENT pour la table `mg_sales_bestsellers_aggregated_daily`
--
ALTER TABLE `mg_sales_bestsellers_aggregated_daily`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Id';
--
-- AUTO_INCREMENT pour la table `mg_sales_bestsellers_aggregated_monthly`
--
ALTER TABLE `mg_sales_bestsellers_aggregated_monthly`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Id';
--
-- AUTO_INCREMENT pour la table `mg_sales_bestsellers_aggregated_yearly`
--
ALTER TABLE `mg_sales_bestsellers_aggregated_yearly`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Id';
--
-- AUTO_INCREMENT pour la table `mg_sales_billing_agreement`
--
ALTER TABLE `mg_sales_billing_agreement`
  MODIFY `agreement_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Agreement Id';
--
-- AUTO_INCREMENT pour la table `mg_sales_flat_creditmemo`
--
ALTER TABLE `mg_sales_flat_creditmemo`
  MODIFY `entity_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity Id';
--
-- AUTO_INCREMENT pour la table `mg_sales_flat_creditmemo_comment`
--
ALTER TABLE `mg_sales_flat_creditmemo_comment`
  MODIFY `entity_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity Id';
--
-- AUTO_INCREMENT pour la table `mg_sales_flat_creditmemo_item`
--
ALTER TABLE `mg_sales_flat_creditmemo_item`
  MODIFY `entity_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity Id';
--
-- AUTO_INCREMENT pour la table `mg_sales_flat_invoice`
--
ALTER TABLE `mg_sales_flat_invoice`
  MODIFY `entity_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity Id';
--
-- AUTO_INCREMENT pour la table `mg_sales_flat_invoice_comment`
--
ALTER TABLE `mg_sales_flat_invoice_comment`
  MODIFY `entity_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity Id';
--
-- AUTO_INCREMENT pour la table `mg_sales_flat_invoice_item`
--
ALTER TABLE `mg_sales_flat_invoice_item`
  MODIFY `entity_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity Id';
--
-- AUTO_INCREMENT pour la table `mg_sales_flat_order`
--
ALTER TABLE `mg_sales_flat_order`
  MODIFY `entity_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity Id',AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT pour la table `mg_sales_flat_order_address`
--
ALTER TABLE `mg_sales_flat_order_address`
  MODIFY `entity_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity Id',AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT pour la table `mg_sales_flat_order_item`
--
ALTER TABLE `mg_sales_flat_order_item`
  MODIFY `item_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Item Id',AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT pour la table `mg_sales_flat_order_payment`
--
ALTER TABLE `mg_sales_flat_order_payment`
  MODIFY `entity_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity Id',AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT pour la table `mg_sales_flat_order_status_history`
--
ALTER TABLE `mg_sales_flat_order_status_history`
  MODIFY `entity_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity Id',AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT pour la table `mg_sales_flat_quote`
--
ALTER TABLE `mg_sales_flat_quote`
  MODIFY `entity_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity Id',AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT pour la table `mg_sales_flat_quote_address`
--
ALTER TABLE `mg_sales_flat_quote_address`
  MODIFY `address_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Address Id',AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT pour la table `mg_sales_flat_quote_address_item`
--
ALTER TABLE `mg_sales_flat_quote_address_item`
  MODIFY `address_item_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Address Item Id';
--
-- AUTO_INCREMENT pour la table `mg_sales_flat_quote_item`
--
ALTER TABLE `mg_sales_flat_quote_item`
  MODIFY `item_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Item Id',AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT pour la table `mg_sales_flat_quote_item_option`
--
ALTER TABLE `mg_sales_flat_quote_item_option`
  MODIFY `option_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Option Id',AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT pour la table `mg_sales_flat_quote_payment`
--
ALTER TABLE `mg_sales_flat_quote_payment`
  MODIFY `payment_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Payment Id',AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT pour la table `mg_sales_flat_quote_shipping_rate`
--
ALTER TABLE `mg_sales_flat_quote_shipping_rate`
  MODIFY `rate_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Rate Id',AUTO_INCREMENT=47;
--
-- AUTO_INCREMENT pour la table `mg_sales_flat_shipment`
--
ALTER TABLE `mg_sales_flat_shipment`
  MODIFY `entity_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity Id';
--
-- AUTO_INCREMENT pour la table `mg_sales_flat_shipment_comment`
--
ALTER TABLE `mg_sales_flat_shipment_comment`
  MODIFY `entity_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity Id';
--
-- AUTO_INCREMENT pour la table `mg_sales_flat_shipment_item`
--
ALTER TABLE `mg_sales_flat_shipment_item`
  MODIFY `entity_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity Id';
--
-- AUTO_INCREMENT pour la table `mg_sales_flat_shipment_track`
--
ALTER TABLE `mg_sales_flat_shipment_track`
  MODIFY `entity_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity Id';
--
-- AUTO_INCREMENT pour la table `mg_sales_invoiced_aggregated`
--
ALTER TABLE `mg_sales_invoiced_aggregated`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Id';
--
-- AUTO_INCREMENT pour la table `mg_sales_invoiced_aggregated_order`
--
ALTER TABLE `mg_sales_invoiced_aggregated_order`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Id';
--
-- AUTO_INCREMENT pour la table `mg_sales_order_aggregated_created`
--
ALTER TABLE `mg_sales_order_aggregated_created`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Id';
--
-- AUTO_INCREMENT pour la table `mg_sales_order_aggregated_updated`
--
ALTER TABLE `mg_sales_order_aggregated_updated`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Id';
--
-- AUTO_INCREMENT pour la table `mg_sales_order_tax`
--
ALTER TABLE `mg_sales_order_tax`
  MODIFY `tax_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Tax Id';
--
-- AUTO_INCREMENT pour la table `mg_sales_order_tax_item`
--
ALTER TABLE `mg_sales_order_tax_item`
  MODIFY `tax_item_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Tax Item Id';
--
-- AUTO_INCREMENT pour la table `mg_sales_payment_transaction`
--
ALTER TABLE `mg_sales_payment_transaction`
  MODIFY `transaction_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Transaction Id';
--
-- AUTO_INCREMENT pour la table `mg_sales_recurring_profile`
--
ALTER TABLE `mg_sales_recurring_profile`
  MODIFY `profile_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Profile Id';
--
-- AUTO_INCREMENT pour la table `mg_sales_recurring_profile_order`
--
ALTER TABLE `mg_sales_recurring_profile_order`
  MODIFY `link_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Link Id';
--
-- AUTO_INCREMENT pour la table `mg_sales_refunded_aggregated`
--
ALTER TABLE `mg_sales_refunded_aggregated`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Id';
--
-- AUTO_INCREMENT pour la table `mg_sales_refunded_aggregated_order`
--
ALTER TABLE `mg_sales_refunded_aggregated_order`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Id';
--
-- AUTO_INCREMENT pour la table `mg_sales_shipping_aggregated`
--
ALTER TABLE `mg_sales_shipping_aggregated`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Id';
--
-- AUTO_INCREMENT pour la table `mg_sales_shipping_aggregated_order`
--
ALTER TABLE `mg_sales_shipping_aggregated_order`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Id';
--
-- AUTO_INCREMENT pour la table `mg_sendfriend_log`
--
ALTER TABLE `mg_sendfriend_log`
  MODIFY `log_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Log ID';
--
-- AUTO_INCREMENT pour la table `mg_shipping_tablerate`
--
ALTER TABLE `mg_shipping_tablerate`
  MODIFY `pk` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary key';
--
-- AUTO_INCREMENT pour la table `mg_sitemap`
--
ALTER TABLE `mg_sitemap`
  MODIFY `sitemap_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Sitemap Id';
--
-- AUTO_INCREMENT pour la table `mg_tag`
--
ALTER TABLE `mg_tag`
  MODIFY `tag_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Tag Id';
--
-- AUTO_INCREMENT pour la table `mg_tag_relation`
--
ALTER TABLE `mg_tag_relation`
  MODIFY `tag_relation_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Tag Relation Id';
--
-- AUTO_INCREMENT pour la table `mg_tax_calculation`
--
ALTER TABLE `mg_tax_calculation`
  MODIFY `tax_calculation_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Tax Calculation Id',AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT pour la table `mg_tax_calculation_rate`
--
ALTER TABLE `mg_tax_calculation_rate`
  MODIFY `tax_calculation_rate_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Tax Calculation Rate Id',AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT pour la table `mg_tax_calculation_rate_title`
--
ALTER TABLE `mg_tax_calculation_rate_title`
  MODIFY `tax_calculation_rate_title_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Tax Calculation Rate Title Id';
--
-- AUTO_INCREMENT pour la table `mg_tax_calculation_rule`
--
ALTER TABLE `mg_tax_calculation_rule`
  MODIFY `tax_calculation_rule_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Tax Calculation Rule Id',AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT pour la table `mg_tax_class`
--
ALTER TABLE `mg_tax_class`
  MODIFY `class_id` smallint(6) NOT NULL AUTO_INCREMENT COMMENT 'Class Id',AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT pour la table `mg_tax_order_aggregated_created`
--
ALTER TABLE `mg_tax_order_aggregated_created`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Id';
--
-- AUTO_INCREMENT pour la table `mg_tax_order_aggregated_updated`
--
ALTER TABLE `mg_tax_order_aggregated_updated`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Id';
--
-- AUTO_INCREMENT pour la table `mg_weee_tax`
--
ALTER TABLE `mg_weee_tax`
  MODIFY `value_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Value Id';
--
-- AUTO_INCREMENT pour la table `mg_widget`
--
ALTER TABLE `mg_widget`
  MODIFY `widget_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Widget Id';
--
-- AUTO_INCREMENT pour la table `mg_widget_instance`
--
ALTER TABLE `mg_widget_instance`
  MODIFY `instance_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Instance Id';
--
-- AUTO_INCREMENT pour la table `mg_widget_instance_page`
--
ALTER TABLE `mg_widget_instance_page`
  MODIFY `page_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Page Id';
--
-- AUTO_INCREMENT pour la table `mg_wishlist`
--
ALTER TABLE `mg_wishlist`
  MODIFY `wishlist_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Wishlist ID';
--
-- AUTO_INCREMENT pour la table `mg_wishlist_item`
--
ALTER TABLE `mg_wishlist_item`
  MODIFY `wishlist_item_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Wishlist item ID';
--
-- AUTO_INCREMENT pour la table `mg_wishlist_item_option`
--
ALTER TABLE `mg_wishlist_item_option`
  MODIFY `option_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Option Id';
--
...
--
-- Contraintes pour la table `mg_admin_rule`
--
ALTER TABLE `mg_admin_rule`
...
--
-- Contraintes pour la table `mg_api2_acl_rule`
--
ALTER TABLE `mg_api2_acl_rule`
...
--
-- Contraintes pour la table `mg_api2_acl_user`
--
ALTER TABLE `mg_api2_acl_user`
...
--
-- Contraintes pour la table `mg_api_rule`
--
ALTER TABLE `mg_api_rule`
...
--
-- Contraintes pour la table `mg_api_session`
--
ALTER TABLE `mg_api_session`
...
--
-- Contraintes pour la table `mg_cataloginventory_stock_item`
--
ALTER TABLE `mg_cataloginventory_stock_item`
...
--
-- Contraintes pour la table `mg_cataloginventory_stock_status`
--
ALTER TABLE `mg_cataloginventory_stock_status`
...
--
-- Contraintes pour la table `mg_catalogrule_customer_group`
--
ALTER TABLE `mg_catalogrule_customer_group`
...
--
-- Contraintes pour la table `mg_catalogrule_group_website`
--
ALTER TABLE `mg_catalogrule_group_website`
...
--
-- Contraintes pour la table `mg_catalogrule_product`
--
ALTER TABLE `mg_catalogrule_product`
...
--
-- Contraintes pour la table `mg_catalogrule_product_price`
--
ALTER TABLE `mg_catalogrule_product_price`
...
--
-- Contraintes pour la table `mg_catalogrule_website`
--
ALTER TABLE `mg_catalogrule_website`
...
--
-- Contraintes pour la table `mg_catalogsearch_query`
--
ALTER TABLE `mg_catalogsearch_query`
...
--
-- Contraintes pour la table `mg_catalogsearch_result`
--
ALTER TABLE `mg_catalogsearch_result`
...
--
-- Contraintes pour la table `mg_catalog_category_entity_datetime`
--
ALTER TABLE `mg_catalog_category_entity_datetime`
...
--
-- Contraintes pour la table `mg_catalog_category_entity_decimal`
--
ALTER TABLE `mg_catalog_category_entity_decimal`
...
--
-- Contraintes pour la table `mg_catalog_category_entity_int`
--
ALTER TABLE `mg_catalog_category_entity_int`
...
--
-- Contraintes pour la table `mg_catalog_category_entity_text`
--
ALTER TABLE `mg_catalog_category_entity_text`
...
--
-- Contraintes pour la table `mg_catalog_category_entity_varchar`
--
ALTER TABLE `mg_catalog_category_entity_varchar`
...
--
-- Contraintes pour la table `mg_catalog_category_product`
--
ALTER TABLE `mg_catalog_category_product`
...
--
-- Contraintes pour la table `mg_catalog_category_product_index`
--
ALTER TABLE `mg_catalog_category_product_index`
...
--
-- Contraintes pour la table `mg_catalog_compare_item`
--
ALTER TABLE `mg_catalog_compare_item`
...
--
-- Contraintes pour la table `mg_catalog_eav_attribute`
--
ALTER TABLE `mg_catalog_eav_attribute`
...
--
-- Contraintes pour la table `mg_catalog_product_bundle_option`
--
ALTER TABLE `mg_catalog_product_bundle_option`
...
--
-- Contraintes pour la table `mg_catalog_product_bundle_option_value`
--
ALTER TABLE `mg_catalog_product_bundle_option_value`
...
--
-- Contraintes pour la table `mg_catalog_product_bundle_price_index`
--
ALTER TABLE `mg_catalog_product_bundle_price_index`
...
--
-- Contraintes pour la table `mg_catalog_product_bundle_selection`
--
ALTER TABLE `mg_catalog_product_bundle_selection`
...
--
-- Contraintes pour la table `mg_catalog_product_bundle_selection_price`
--
ALTER TABLE `mg_catalog_product_bundle_selection_price`
...
--
-- Contraintes pour la table `mg_catalog_product_enabled_index`
--
ALTER TABLE `mg_catalog_product_enabled_index`
...
--
-- Contraintes pour la table `mg_catalog_product_entity`
--
ALTER TABLE `mg_catalog_product_entity`
...
--
-- Contraintes pour la table `mg_catalog_product_entity_datetime`
--
ALTER TABLE `mg_catalog_product_entity_datetime`
...
--
-- Contraintes pour la table `mg_catalog_product_entity_decimal`
--
ALTER TABLE `mg_catalog_product_entity_decimal`
...
--
-- Contraintes pour la table `mg_catalog_product_entity_gallery`
--
ALTER TABLE `mg_catalog_product_entity_gallery`
...
--
-- Contraintes pour la table `mg_catalog_product_entity_group_price`
--
ALTER TABLE `mg_catalog_product_entity_group_price`
...
--
-- Contraintes pour la table `mg_catalog_product_entity_int`
--
ALTER TABLE `mg_catalog_product_entity_int`
...
--
-- Contraintes pour la table `mg_catalog_product_entity_media_gallery`
--
ALTER TABLE `mg_catalog_product_entity_media_gallery`
...
--
-- Contraintes pour la table `mg_catalog_product_entity_media_gallery_value`
--
ALTER TABLE `mg_catalog_product_entity_media_gallery_value`
...
--
-- Contraintes pour la table `mg_catalog_product_entity_text`
--
ALTER TABLE `mg_catalog_product_entity_text`
...
--
-- Contraintes pour la table `mg_catalog_product_entity_tier_price`
--
ALTER TABLE `mg_catalog_product_entity_tier_price`
...
--
-- Contraintes pour la table `mg_catalog_product_entity_varchar`
--
ALTER TABLE `mg_catalog_product_entity_varchar`
...
--
-- Contraintes pour la table `mg_catalog_product_index_eav`
--
ALTER TABLE `mg_catalog_product_index_eav`
...
--
-- Contraintes pour la table `mg_catalog_product_index_eav_decimal`
--
ALTER TABLE `mg_catalog_product_index_eav_decimal`
...
--
-- Contraintes pour la table `mg_catalog_product_index_group_price`
--
ALTER TABLE `mg_catalog_product_index_group_price`
...
--
-- Contraintes pour la table `mg_catalog_product_index_price`
--
ALTER TABLE `mg_catalog_product_index_price`
...
--
-- Contraintes pour la table `mg_catalog_product_index_tier_price`
--
ALTER TABLE `mg_catalog_product_index_tier_price`
...
--
-- Contraintes pour la table `mg_catalog_product_index_website`
--
ALTER TABLE `mg_catalog_product_index_website`
...
--
-- Contraintes pour la table `mg_catalog_product_link`
--
ALTER TABLE `mg_catalog_product_link`
...
--
-- Contraintes pour la table `mg_catalog_product_link_attribute`
--
ALTER TABLE `mg_catalog_product_link_attribute`
...
--
-- Contraintes pour la table `mg_catalog_product_link_attribute_decimal`
--
ALTER TABLE `mg_catalog_product_link_attribute_decimal`
...
--
-- Contraintes pour la table `mg_catalog_product_link_attribute_int`
--
ALTER TABLE `mg_catalog_product_link_attribute_int`
...
--
-- Contraintes pour la table `mg_catalog_product_link_attribute_varchar`
--
ALTER TABLE `mg_catalog_product_link_attribute_varchar`
...
--
-- Contraintes pour la table `mg_catalog_product_option`
--
ALTER TABLE `mg_catalog_product_option`
...
--
-- Contraintes pour la table `mg_catalog_product_option_price`
--
ALTER TABLE `mg_catalog_product_option_price`
...
--
-- Contraintes pour la table `mg_catalog_product_option_title`
--
ALTER TABLE `mg_catalog_product_option_title`
...
--
-- Contraintes pour la table `mg_catalog_product_option_type_price`
--
ALTER TABLE `mg_catalog_product_option_type_price`
...
--
-- Contraintes pour la table `mg_catalog_product_option_type_title`
--
ALTER TABLE `mg_catalog_product_option_type_title`
...
--
-- Contraintes pour la table `mg_catalog_product_option_type_value`
--
ALTER TABLE `mg_catalog_product_option_type_value`
...
--
-- Contraintes pour la table `mg_catalog_product_relation`
--
ALTER TABLE `mg_catalog_product_relation`
...
--
-- Contraintes pour la table `mg_catalog_product_super_attribute`
--
ALTER TABLE `mg_catalog_product_super_attribute`
...
--
-- Contraintes pour la table `mg_catalog_product_super_attribute_label`
--
ALTER TABLE `mg_catalog_product_super_attribute_label`
...
--
-- Contraintes pour la table `mg_catalog_product_super_attribute_pricing`
--
ALTER TABLE `mg_catalog_product_super_attribute_pricing`
...
--
-- Contraintes pour la table `mg_catalog_product_super_link`
--
ALTER TABLE `mg_catalog_product_super_link`
...
--
-- Contraintes pour la table `mg_catalog_product_website`
--
ALTER TABLE `mg_catalog_product_website`
...
--
-- Contraintes pour la table `mg_checkout_agreement_store`
--
ALTER TABLE `mg_checkout_agreement_store`
...
--
-- Contraintes pour la table `mg_cms_block_store`
--
ALTER TABLE `mg_cms_block_store`
...
--
-- Contraintes pour la table `mg_cms_page_store`
--
ALTER TABLE `mg_cms_page_store`
...
--
-- Contraintes pour la table `mg_core_email_queue_recipients`
--
ALTER TABLE `mg_core_email_queue_recipients`
...
--
-- Contraintes pour la table `mg_core_layout_link`
--
ALTER TABLE `mg_core_layout_link`
...
--
-- Contraintes pour la table `mg_core_store`
--
ALTER TABLE `mg_core_store`
...
--
-- Contraintes pour la table `mg_core_store_group`
--
ALTER TABLE `mg_core_store_group`
...
--
-- Contraintes pour la table `mg_core_translate`
--
ALTER TABLE `mg_core_translate`
...
--
-- Contraintes pour la table `mg_core_url_rewrite`
--
ALTER TABLE `mg_core_url_rewrite`
...
--
-- Contraintes pour la table `mg_core_variable_value`
--
ALTER TABLE `mg_core_variable_value`
...
--
-- Contraintes pour la table `mg_coupon_aggregated`
--
ALTER TABLE `mg_coupon_aggregated`
...
--
-- Contraintes pour la table `mg_coupon_aggregated_order`
--
ALTER TABLE `mg_coupon_aggregated_order`
...
--
-- Contraintes pour la table `mg_coupon_aggregated_updated`
--
ALTER TABLE `mg_coupon_aggregated_updated`
...
--
-- Contraintes pour la table `mg_customer_address_entity`
--
ALTER TABLE `mg_customer_address_entity`
...
--
-- Contraintes pour la table `mg_customer_address_entity_datetime`
--
ALTER TABLE `mg_customer_address_entity_datetime`
...
--
-- Contraintes pour la table `mg_customer_address_entity_decimal`
--
ALTER TABLE `mg_customer_address_entity_decimal`
...
--
-- Contraintes pour la table `mg_customer_address_entity_int`
--
ALTER TABLE `mg_customer_address_entity_int`
...
--
-- Contraintes pour la table `mg_customer_address_entity_text`
--
ALTER TABLE `mg_customer_address_entity_text`
...
--
-- Contraintes pour la table `mg_customer_address_entity_varchar`
--
ALTER TABLE `mg_customer_address_entity_varchar`
...
--
-- Contraintes pour la table `mg_customer_eav_attribute`
--
ALTER TABLE `mg_customer_eav_attribute`
...
--
-- Contraintes pour la table `mg_customer_eav_attribute_website`
--
ALTER TABLE `mg_customer_eav_attribute_website`
...
--
-- Contraintes pour la table `mg_customer_entity`
--
ALTER TABLE `mg_customer_entity`
...
--
-- Contraintes pour la table `mg_customer_entity_datetime`
--
ALTER TABLE `mg_customer_entity_datetime`
...
--
-- Contraintes pour la table `mg_customer_entity_decimal`
--
ALTER TABLE `mg_customer_entity_decimal`
...
--
-- Contraintes pour la table `mg_customer_entity_int`
--
ALTER TABLE `mg_customer_entity_int`
...
--
-- Contraintes pour la table `mg_customer_entity_text`
--
ALTER TABLE `mg_customer_entity_text`
...
--
-- Contraintes pour la table `mg_customer_entity_varchar`
--
ALTER TABLE `mg_customer_entity_varchar`
...
--
-- Contraintes pour la table `mg_customer_form_attribute`
--
ALTER TABLE `mg_customer_form_attribute`
...
--
-- Contraintes pour la table `mg_dataflow_batch`
--
ALTER TABLE `mg_dataflow_batch`
...
--
-- Contraintes pour la table `mg_dataflow_batch_export`
--
ALTER TABLE `mg_dataflow_batch_export`
...
--
-- Contraintes pour la table `mg_dataflow_batch_import`
--
ALTER TABLE `mg_dataflow_batch_import`
...
--
-- Contraintes pour la table `mg_dataflow_import_data`
--
ALTER TABLE `mg_dataflow_import_data`
...
--
-- Contraintes pour la table `mg_dataflow_profile_history`
--
ALTER TABLE `mg_dataflow_profile_history`
...
--
-- Contraintes pour la table `mg_design_change`
--
ALTER TABLE `mg_design_change`
...
--
-- Contraintes pour la table `mg_directory_country_region_name`
--
ALTER TABLE `mg_directory_country_region_name`
...
--
-- Contraintes pour la table `mg_downloadable_link`
--
ALTER TABLE `mg_downloadable_link`
...
--
-- Contraintes pour la table `mg_downloadable_link_price`
--
ALTER TABLE `mg_downloadable_link_price`
...
--
-- Contraintes pour la table `mg_downloadable_link_purchased`
--
ALTER TABLE `mg_downloadable_link_purchased`
...
--
-- Contraintes pour la table `mg_downloadable_link_purchased_item`
--
ALTER TABLE `mg_downloadable_link_purchased_item`
...
--
-- Contraintes pour la table `mg_downloadable_link_title`
--
ALTER TABLE `mg_downloadable_link_title`
...
--
-- Contraintes pour la table `mg_downloadable_sample`
--
ALTER TABLE `mg_downloadable_sample`
...
--
-- Contraintes pour la table `mg_downloadable_sample_title`
--
ALTER TABLE `mg_downloadable_sample_title`
...
--
-- Contraintes pour la table `mg_eav_attribute`
--
ALTER TABLE `mg_eav_attribute`
...
--
-- Contraintes pour la table `mg_eav_attribute_group`
--
ALTER TABLE `mg_eav_attribute_group`
...
--
-- Contraintes pour la table `mg_eav_attribute_label`
--
ALTER TABLE `mg_eav_attribute_label`
...
--
-- Contraintes pour la table `mg_eav_attribute_option`
--
ALTER TABLE `mg_eav_attribute_option`
...
--
-- Contraintes pour la table `mg_eav_attribute_option_value`
--
ALTER TABLE `mg_eav_attribute_option_value`
...
--
-- Contraintes pour la table `mg_eav_attribute_set`
--
ALTER TABLE `mg_eav_attribute_set`
...
--
-- Contraintes pour la table `mg_eav_entity`
--
ALTER TABLE `mg_eav_entity`
...
--
-- Contraintes pour la table `mg_eav_entity_attribute`
--
ALTER TABLE `mg_eav_entity_attribute`
...
--
-- Contraintes pour la table `mg_eav_entity_datetime`
--
ALTER TABLE `mg_eav_entity_datetime`
...
--
-- Contraintes pour la table `mg_eav_entity_decimal`
--
ALTER TABLE `mg_eav_entity_decimal`
...
--
-- Contraintes pour la table `mg_eav_entity_int`
--
ALTER TABLE `mg_eav_entity_int`
...
--
-- Contraintes pour la table `mg_eav_entity_store`
--
ALTER TABLE `mg_eav_entity_store`
...
--
-- Contraintes pour la table `mg_eav_entity_text`
--
ALTER TABLE `mg_eav_entity_text`
...
--
-- Contraintes pour la table `mg_eav_entity_varchar`
--
ALTER TABLE `mg_eav_entity_varchar`
...
--
-- Contraintes pour la table `mg_eav_form_element`
--
ALTER TABLE `mg_eav_form_element`
...
--
-- Contraintes pour la table `mg_eav_form_fieldset`
--
ALTER TABLE `mg_eav_form_fieldset`
...
--
-- Contraintes pour la table `mg_eav_form_fieldset_label`
--
ALTER TABLE `mg_eav_form_fieldset_label`
...
--
-- Contraintes pour la table `mg_eav_form_type`
--
ALTER TABLE `mg_eav_form_type`
...
--
-- Contraintes pour la table `mg_eav_form_type_entity`
--
ALTER TABLE `mg_eav_form_type_entity`
...
--
-- Contraintes pour la table `mg_index_process_event`
--
ALTER TABLE `mg_index_process_event`
...
--
-- Contraintes pour la table `mg_newsletter_problem`
--
ALTER TABLE `mg_newsletter_problem`
...
--
-- Contraintes pour la table `mg_newsletter_queue`
--
ALTER TABLE `mg_newsletter_queue`
...
--
-- Contraintes pour la table `mg_newsletter_queue_link`
--
ALTER TABLE `mg_newsletter_queue_link`
...
--
-- Contraintes pour la table `mg_newsletter_queue_store_link`
--
ALTER TABLE `mg_newsletter_queue_store_link`
...
--
-- Contraintes pour la table `mg_newsletter_subscriber`
--
ALTER TABLE `mg_newsletter_subscriber`
...
--
-- Contraintes pour la table `mg_oauth_token`
--
ALTER TABLE `mg_oauth_token`
...
--
-- Contraintes pour la table `mg_paypal_cert`
--
ALTER TABLE `mg_paypal_cert`
...
--
-- Contraintes pour la table `mg_paypal_settlement_report_row`
--
ALTER TABLE `mg_paypal_settlement_report_row`
...
--
-- Contraintes pour la table `mg_persistent_session`
--
ALTER TABLE `mg_persistent_session`
...
--
-- Contraintes pour la table `mg_poll`
--
ALTER TABLE `mg_poll`
...
--
-- Contraintes pour la table `mg_poll_answer`
--
ALTER TABLE `mg_poll_answer`
...
--
-- Contraintes pour la table `mg_poll_store`
--
ALTER TABLE `mg_poll_store`
...
--
-- Contraintes pour la table `mg_poll_vote`
--
ALTER TABLE `mg_poll_vote`
...
--
-- Contraintes pour la table `mg_product_alert_price`
--
ALTER TABLE `mg_product_alert_price`
...
--
-- Contraintes pour la table `mg_product_alert_stock`
--
ALTER TABLE `mg_product_alert_stock`
...
--
-- Contraintes pour la table `mg_rating`
--
ALTER TABLE `mg_rating`
...
--
-- Contraintes pour la table `mg_rating_option`
--
ALTER TABLE `mg_rating_option`
...
--
-- Contraintes pour la table `mg_rating_option_vote`
--
ALTER TABLE `mg_rating_option_vote`
...
--
-- Contraintes pour la table `mg_rating_option_vote_aggregated`
--
ALTER TABLE `mg_rating_option_vote_aggregated`
...
--
-- Contraintes pour la table `mg_rating_store`
--
ALTER TABLE `mg_rating_store`
...
--
-- Contraintes pour la table `mg_rating_title`
--
ALTER TABLE `mg_rating_title`
...
--
-- Contraintes pour la table `mg_report_compared_product_index`
--
ALTER TABLE `mg_report_compared_product_index`
...
--
-- Contraintes pour la table `mg_report_event`
--
ALTER TABLE `mg_report_event`
...
--
-- Contraintes pour la table `mg_report_viewed_product_aggregated_daily`
--
ALTER TABLE `mg_report_viewed_product_aggregated_daily`
...
--
-- Contraintes pour la table `mg_report_viewed_product_aggregated_monthly`
--
ALTER TABLE `mg_report_viewed_product_aggregated_monthly`
...
--
-- Contraintes pour la table `mg_report_viewed_product_aggregated_yearly`
--
ALTER TABLE `mg_report_viewed_product_aggregated_yearly`
...
--
-- Contraintes pour la table `mg_report_viewed_product_index`
--
ALTER TABLE `mg_report_viewed_product_index`
...
--
-- Contraintes pour la table `mg_review`
--
ALTER TABLE `mg_review`
...
--
-- Contraintes pour la table `mg_review_detail`
--
ALTER TABLE `mg_review_detail`
...
--
-- Contraintes pour la table `mg_review_entity_summary`
--
ALTER TABLE `mg_review_entity_summary`
...
--
-- Contraintes pour la table `mg_review_store`
--
ALTER TABLE `mg_review_store`
...
--
-- Contraintes pour la table `mg_salesrule_coupon`
--
ALTER TABLE `mg_salesrule_coupon`
...
--
-- Contraintes pour la table `mg_salesrule_coupon_usage`
--
ALTER TABLE `mg_salesrule_coupon_usage`
...
--
-- Contraintes pour la table `mg_salesrule_customer`
--
ALTER TABLE `mg_salesrule_customer`
...
--
-- Contraintes pour la table `mg_salesrule_customer_group`
--
ALTER TABLE `mg_salesrule_customer_group`
...
--
-- Contraintes pour la table `mg_salesrule_label`
--
ALTER TABLE `mg_salesrule_label`
...
--
-- Contraintes pour la table `mg_salesrule_product_attribute`
--
ALTER TABLE `mg_salesrule_product_attribute`
...
--
-- Contraintes pour la table `mg_salesrule_website`
--
ALTER TABLE `mg_salesrule_website`
...
--
-- Contraintes pour la table `mg_sales_bestsellers_aggregated_daily`
--
ALTER TABLE `mg_sales_bestsellers_aggregated_daily`
...
--
-- Contraintes pour la table `mg_sales_bestsellers_aggregated_monthly`
--
ALTER TABLE `mg_sales_bestsellers_aggregated_monthly`
...
--
-- Contraintes pour la table `mg_sales_bestsellers_aggregated_yearly`
--
ALTER TABLE `mg_sales_bestsellers_aggregated_yearly`
...
--
-- Contraintes pour la table `mg_sales_billing_agreement`
--
ALTER TABLE `mg_sales_billing_agreement`
...
--
-- Contraintes pour la table `mg_sales_billing_agreement_order`
--
ALTER TABLE `mg_sales_billing_agreement_order`
...
--
-- Contraintes pour la table `mg_sales_flat_creditmemo`
--
ALTER TABLE `mg_sales_flat_creditmemo`
...
--
-- Contraintes pour la table `mg_sales_flat_creditmemo_comment`
--
ALTER TABLE `mg_sales_flat_creditmemo_comment`
...
--
-- Contraintes pour la table `mg_sales_flat_creditmemo_grid`
--
ALTER TABLE `mg_sales_flat_creditmemo_grid`
...
--
-- Contraintes pour la table `mg_sales_flat_creditmemo_item`
--
ALTER TABLE `mg_sales_flat_creditmemo_item`
...
--
-- Contraintes pour la table `mg_sales_flat_invoice`
--
ALTER TABLE `mg_sales_flat_invoice`
...
--
-- Contraintes pour la table `mg_sales_flat_invoice_comment`
--
ALTER TABLE `mg_sales_flat_invoice_comment`
...
--
-- Contraintes pour la table `mg_sales_flat_invoice_grid`
--
ALTER TABLE `mg_sales_flat_invoice_grid`
...
--
-- Contraintes pour la table `mg_sales_flat_invoice_item`
--
ALTER TABLE `mg_sales_flat_invoice_item`
...
--
-- Contraintes pour la table `mg_sales_flat_order`
--
ALTER TABLE `mg_sales_flat_order`
...
--
-- Contraintes pour la table `mg_sales_flat_order_address`
--
ALTER TABLE `mg_sales_flat_order_address`
...
--
-- Contraintes pour la table `mg_sales_flat_order_grid`
--
ALTER TABLE `mg_sales_flat_order_grid`
...
--
-- Contraintes pour la table `mg_sales_flat_order_item`
--
ALTER TABLE `mg_sales_flat_order_item`
...
--
-- Contraintes pour la table `mg_sales_flat_order_payment`
--
ALTER TABLE `mg_sales_flat_order_payment`
...
--
-- Contraintes pour la table `mg_sales_flat_order_status_history`
--
ALTER TABLE `mg_sales_flat_order_status_history`
...
--
-- Contraintes pour la table `mg_sales_flat_quote`
--
ALTER TABLE `mg_sales_flat_quote`
...
--
-- Contraintes pour la table `mg_sales_flat_quote_address`
--
ALTER TABLE `mg_sales_flat_quote_address`
...
--
-- Contraintes pour la table `mg_sales_flat_quote_address_item`
--
ALTER TABLE `mg_sales_flat_quote_address_item`
...
--
-- Contraintes pour la table `mg_sales_flat_quote_item`
--
ALTER TABLE `mg_sales_flat_quote_item`
...
--
-- Contraintes pour la table `mg_sales_flat_quote_item_option`
--
ALTER TABLE `mg_sales_flat_quote_item_option`
...
--
-- Contraintes pour la table `mg_sales_flat_quote_payment`
--
ALTER TABLE `mg_sales_flat_quote_payment`
...
--
-- Contraintes pour la table `mg_sales_flat_quote_shipping_rate`
--
ALTER TABLE `mg_sales_flat_quote_shipping_rate`
...
--
-- Contraintes pour la table `mg_sales_flat_shipment`
--
ALTER TABLE `mg_sales_flat_shipment`
...
--
-- Contraintes pour la table `mg_sales_flat_shipment_comment`
--
ALTER TABLE `mg_sales_flat_shipment_comment`
...
--
-- Contraintes pour la table `mg_sales_flat_shipment_grid`
--
ALTER TABLE `mg_sales_flat_shipment_grid`
...
--
-- Contraintes pour la table `mg_sales_flat_shipment_item`
--
ALTER TABLE `mg_sales_flat_shipment_item`
...
--
-- Contraintes pour la table `mg_sales_flat_shipment_track`
--
ALTER TABLE `mg_sales_flat_shipment_track`
...
--
-- Contraintes pour la table `mg_sales_invoiced_aggregated`
--
ALTER TABLE `mg_sales_invoiced_aggregated`
...
--
-- Contraintes pour la table `mg_sales_invoiced_aggregated_order`
--
ALTER TABLE `mg_sales_invoiced_aggregated_order`
...
--
-- Contraintes pour la table `mg_sales_order_aggregated_created`
--
ALTER TABLE `mg_sales_order_aggregated_created`
...
--
-- Contraintes pour la table `mg_sales_order_aggregated_updated`
--
ALTER TABLE `mg_sales_order_aggregated_updated`
...
--
-- Contraintes pour la table `mg_sales_order_status_label`
--
ALTER TABLE `mg_sales_order_status_label`
...
--
-- Contraintes pour la table `mg_sales_order_status_state`
--
ALTER TABLE `mg_sales_order_status_state`
...
--
-- Contraintes pour la table `mg_sales_order_tax_item`
--
ALTER TABLE `mg_sales_order_tax_item`
...
--
-- Contraintes pour la table `mg_sales_payment_transaction`
--
ALTER TABLE `mg_sales_payment_transaction`
...
--
-- Contraintes pour la table `mg_sales_recurring_profile`
--
ALTER TABLE `mg_sales_recurring_profile`
...
--
-- Contraintes pour la table `mg_sales_recurring_profile_order`
--
ALTER TABLE `mg_sales_recurring_profile_order`
...
--
-- Contraintes pour la table `mg_sales_refunded_aggregated`
--
ALTER TABLE `mg_sales_refunded_aggregated`
...
--
-- Contraintes pour la table `mg_sales_refunded_aggregated_order`
--
ALTER TABLE `mg_sales_refunded_aggregated_order`
...
--
-- Contraintes pour la table `mg_sales_shipping_aggregated`
--
ALTER TABLE `mg_sales_shipping_aggregated`
...
--
-- Contraintes pour la table `mg_sales_shipping_aggregated_order`
--
ALTER TABLE `mg_sales_shipping_aggregated_order`
...
--
-- Contraintes pour la table `mg_sitemap`
--
ALTER TABLE `mg_sitemap`
...
--
-- Contraintes pour la table `mg_tag`
--
ALTER TABLE `mg_tag`
...
--
-- Contraintes pour la table `mg_tag_properties`
--
ALTER TABLE `mg_tag_properties`
...
--
-- Contraintes pour la table `mg_tag_relation`
--
ALTER TABLE `mg_tag_relation`
...
--
-- Contraintes pour la table `mg_tag_summary`
--
ALTER TABLE `mg_tag_summary`
...
--
-- Contraintes pour la table `mg_tax_calculation`
--
ALTER TABLE `mg_tax_calculation`
...
--
-- Contraintes pour la table `mg_tax_calculation_rate_title`
--
ALTER TABLE `mg_tax_calculation_rate_title`
...
--
-- Contraintes pour la table `mg_tax_order_aggregated_created`
--
ALTER TABLE `mg_tax_order_aggregated_created`
...
--
-- Contraintes pour la table `mg_tax_order_aggregated_updated`
--
ALTER TABLE `mg_tax_order_aggregated_updated`
...
--
-- Contraintes pour la table `mg_weee_discount`
--
ALTER TABLE `mg_weee_discount`
...
--
-- Contraintes pour la table `mg_weee_tax`
--
ALTER TABLE `mg_weee_tax`
...
--
-- Contraintes pour la table `mg_widget_instance_page`
--
ALTER TABLE `mg_widget_instance_page`
...
--
-- Contraintes pour la table `mg_widget_instance_page_layout`
--
ALTER TABLE `mg_widget_instance_page_layout`
...
--
-- Contraintes pour la table `mg_wishlist`
--
ALTER TABLE `mg_wishlist`
...
--
-- Contraintes pour la table `mg_wishlist_item`
--
ALTER TABLE `mg_wishlist_item`
...
--
-- Contraintes pour la table `mg_wishlist_item_option`
--
ALTER TABLE `mg_wishlist_item_option`
