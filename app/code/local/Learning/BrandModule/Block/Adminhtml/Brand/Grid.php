...
class Learning_BrandModule_Block_Adminhtml_Brand_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    protected function _prepareCollection()
    {
        ...
        $collection = Mage::getResourceModel(
            'learning_brandmodule/brand_collection'
        );
        ...
        $this->addColumn('action', array(
                ...
                'actions' => array(
                    array(
                        ...
                        'url' => array(
                            'base' => 'learning_brandmodule_admin'
                                . '/brand/edit',
                        ),
                        'field' => 'id'
                    ),
    ...
    {
        return Mage::helper('learning_brandmodule');
    }
